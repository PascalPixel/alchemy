 ...
 *
 * Uncertainty: Func_02005158 and Func_080000f8 are not identified; the
 ...
 * so Func_080000f8 is presumed to be a random-number source but that is not
...
extern void Func_02005158(s32 *slot);

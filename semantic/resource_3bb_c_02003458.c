...
/*
 * resource_3bb owner at 0x02003458, 480 bytes.  The owner opens with the
 * r5-r8 save, contains a branch-skipped literal run at 0x020035aa-0x020035c7,
 * and ends at the sole unwind return at 0x0200362c-0x02003637.  The next
 * semantic owner starts at 0x02003638, so there is no trailing pool.
 *
 ...
 * source/machine order.  The halfwords at 0x020035c4 are an unreachable BL
...
#define STATE_3BB ((u8 *)0x02001000)
#define WORKSPACE_3BB (*(u8 *volatile *)0x03001f3c)
        ...
        *(u16 *)(state + 6) = (u16)(cursor + 2);
        ...
        if (first == 0 && second == 0) {
            ...
            *(s32 *)(actor + 0x30) = 0x10000;
            ...
            Func_080770c8(0x211);
            Func_08009098(actor, (const void *)0x0200cb48);
        } else {
            s32 turn;

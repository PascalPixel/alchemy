#ifndef ALCHEMY_ABI_RESOURCE_LOAD_BY_MODE_INTO_SLOT
#define ALCHEMY_ABI_RESOURCE_LOAD_BY_MODE_INTO_SLOT
...
#define Sys_Place2 Func_0801a2ec
#define Sys_Place3 Func_0801a32c

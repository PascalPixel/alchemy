/* resource_393 0x020008c0-0x020009db: kind-selected rectangle redraw. */
#include "types.h"



extern u8 * Func_02001756(s32);
extern void Func_020017dc(s32,s32,s32,s32,s32,s32);
...
s32 Func_020008c0(s32 slot)
{
    ...
    u8 *object = Func_02001756(slot);
    s16 kind = **(s16 **)(*(u8 **)(object + 80) + 40);
    s32 *keys = (s32 *)0x02008f50, *delta;
    ...
    Func_020017dc(tileX, tileZ, width, depth, globalX, globalZ);

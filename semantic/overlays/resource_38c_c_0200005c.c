...
/*
 * Resource 38c approach guard at 0x0200005c.
 *
 * Complete owner: `push {r5, lr}` at 0x0200005c, interworking return
 ...
 * by `ldr rN,[pc,#imm]`.  Handler pool word: 0x0200805d = `Func_0200005c + 1`.
 *
 ...
 * sibling at 0x020000bc differ in exactly five halfwords: the two immediates
...
void Func_0200005c(void)
{
    ...
    if ((u32) (place + 0xffff5fff) <= 0x3ffe) {
        ...
        if (Func_080770c0(0x845) == 0) {
            Func_0808a170(0x13e3);
        } else {
            Func_0808a170(0x16f5);
        }
        Func_0808a180(16, 0);
    }

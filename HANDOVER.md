...
- Semantic-C lane: **170,328 executable bytes across 387 compiling sources**:
  158,320 main bytes and 12,008 overlay bytes. Combined with exact C,
  **308,296 / 1,338,732 executable bytes** are now expressed as C, with
  1,030,436 remaining.

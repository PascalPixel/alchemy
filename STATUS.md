...
Within the reconstruction assembly, 461,210 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,927,398 of
...
reconstruction assembly as unfinished C work. The remaining 461,210 bytes are
...
| Byte reconstruction | 7,927,398 / 8,388,608 bytes (94.50%) | Exact C, round-tripping assets, or retained structural assembly |

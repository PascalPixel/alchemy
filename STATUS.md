...
|---|---:|---:|
| Compiled C | 1,045 | 54,510 |
| Reconstruction assembly | 2,126 | 493,926 |
...
Within the reconstruction assembly, 470,578 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,918,030 of
...
reconstruction assembly as unfinished C work. The remaining 470,578 bytes are
...
| Byte reconstruction | 7,918,030 / 8,388,608 bytes (94.39%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 54,510 / 525,088 identified executable bytes (10.38%) | Active executable work represented as exact C |

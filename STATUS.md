...
|---|---:|---:|
| Compiled C | 1,022 | 51,498 |
| Reconstruction assembly | 2,149 | 496,938 |
...
Within the reconstruction assembly, 473,590 bytes remain active
...
reconstruction assembly as unfinished C work. The remaining 473,590 bytes are
...
| Byte reconstruction | 7,915,018 / 8,388,608 bytes (94.35%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 51,498 / 525,088 identified executable bytes (9.81%) | Active executable work represented as exact C |

...
s32 Func_02000040(void *arg0) {
    ...
    if (temp_r1 != NULL) {
        ...
        temp = (u16) Func_02003afa(M2C_FIELD(temp_r1, s32, 0x10) - M2C_FIELD(arg0, s32, 0x10), M2C_FIELD(temp_r1, s32, 8) - M2C_FIELD(arg0, s32, 8));
        ...
        if (var_r0 != 0) {
            ...
            if (var_r0 < (s32)0xF84AF001) {
                var_r0 = (s32)0xF84AF001;
            }

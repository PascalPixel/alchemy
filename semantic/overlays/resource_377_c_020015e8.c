...
/*
 * resource_377 owner at 0x020015e8, 80 bytes: per-frame step of a 32-frame
 ...
 *
 * TRANSPOSED from semantic/overlays/resource_371_c_02003fb4.c.  The two owners are
 * the same routine shared verbatim: over all 40 halfwords they differ in exactly
 * 4 places, all of them BL halfwords.  No pool word differs.
 *
 * What was changed: the entry symbol, and both calls, re-resolved with
 * 'bun tools/overlay_call_targets.ts resource_377 15e8' to the veneers publishing

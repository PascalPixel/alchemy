...
/*
 * resource_3ca owner at 0x02000044, 8 bytes: `ldr r0, [pc, #0] / bx lr`
 * plus the one-word literal pool at 0x02000048 holding 0x200971c.
 *
 ...
 *
 * The pool word 0x200971c is an ADDRESS, loaded and returned WITHOUT being

...
void Func_020031ac(void)
{
    ...
    o = Func_02007a70(0);
    *(u16 *)(o + 100) = (u16)(Func_02007984(Func_0200799e(), 20) + 20);
    hidden = 0;
    keep = 0;
    o = Func_02007a90(22);                          /* one argument */
    ...
    *(s32 *)(obj19 + 64) = 0;
    ...
    Func_02007eba(9, 9);
    Func_02007ebe(26, 0x970000, 0x50c0000);         /* three arguments, 151<<16 */
    Func_02007f3a(26, 0x8000, 0);                   /* 128<<8 */
    Func_02007eda(26, 5);                           /* two arguments */

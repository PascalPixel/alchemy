...
#define ObjectMotion_SetAngleToward_1(a0, a1, a2) Value3(Func_02002a7c_a, a0, a1, a2)
#define ObjectMotion_SetAngleToward_2(args...) Func_02002a86_a(args)
#define ObjectMotion_SetVariantCallback_1(args...) Func_02002a7e(args)
#define ObjectMotion_SetVariantCallback_2(args...) Func_02002a86_b(args)
...
#define ObjectMotion_SetSpeedParameters_2(a0, a1, a2) Call3(Func_02002a7c_b, a0, a1, a2)
...
#define BattleEvent_RunActionAndWait_2(args...) Func_02002b1e_a(args)
...
#define ObjectMotion_ResetAndSetPositionInMode2_3(args...) Func_02002b1e_c(args)
...
#define ACTOR_8 8
#define ACTOR_9 9
#define FieldScene_RunStepFD1WithActor181 Func_020003c0
#define FieldScene_RunSupplementalSequenceOne Func_0200049c
#define FieldScene_RunOpeningSequence Func_020005f0
#define FieldScene_RunScriptedSteps947And29E1 Func_020006bc
#define FieldScene_RunActorEighteenPromptDialogue Func_02000764
#define FieldScene_RunSupplementalSequenceTwo Func_020008ec
#define FieldScene_RunScene3abSequenceA Func_02000980
#define FieldScene_RunScene3abSequenceB Func_020009d4
#define FieldScene_RunSupplementalSequenceThree Func_02000b6c
#define FieldScene_RunScene3abSequenceC Func_02000c10
#define FieldScene_RunScene3abSequenceE Func_02000c74
...
#define FieldScene_RunScene3abSequenceG Func_02001240
 ...
 * into a pseudo that the compiler then shares with later uses in the block.
 * A value-returning call also sets r0 last of its arguments. */
static __inline__ void Call3_scene_setup(void (*f)(), s32 a0, s32 a1, s32 a2)
{
    f(a0, a1, a2);
}
 ...
 * into a pseudo that the compiler then shares with later uses in the block.
 * A value-returning call also sets r0 last of its arguments. */
static __inline__ void Call1_scene_setup(void (*f)(), s32 a0)
{
    f(a0);
}

static __inline__ s32 Value1_scene_setup(s32 (*f)(), s32 a0)
{
    return f(a0);
}

static __inline__ void Call2_scene_setup(void (*f)(), s32 a0, s32 a1)
{
    f(a0, a1);
}
...
void Func_020021e8_scene_dialogue(s32, s32, s32);
...
void Func_020022ca_scene_dialogue(void);
...
#define FieldScene_CallHelper27cc Func_02000d08
...
#define SceneState_Run83WhenFlag201Clear Func_02000d14
#define FieldScene_NoOp Func_02000f9c
#define SceneState_SetThreeCellsAt6x11AndFlag241 Func_02000fa0
#define SceneState_SetThreeCellsAt7x12 Func_0200118c
s32 Func_020026da_setup(s32);
void Func_02002854_setup(s32);
void Func_02002946_setup(s32, s32, s32, s32, s32, s32);
void Func_02002958_setup(s32, s32, s32, s32, s32, s32);
void Func_0200296a_setup(s32, s32, s32, s32, s32, s32);
void Func_020029a8_setup(s32);
void Func_02002b32_setup(s32, s32, s32, s32, s32, s32);
void Func_02002b44_setup(s32, s32, s32, s32, s32, s32);
void Func_02002b56_setup(s32, s32, s32, s32, s32, s32);
...
void FieldScene_RunStepFD1WithActor181(void)
{
    Func_02001da4();
...
void FieldScene_RunScriptedSteps947And29E1(void)
{
    Func_020020a0();
...
{
    Func_0200211c();
    Func_020021e8_scene_dialogue(17, 0x102, 60);
    Func_020021be(0x1b9c);
    Func_020021de(17, 0);
    Func_02002142();
}

void FieldScene_RunActorEighteenPromptDialogue(void)
{
...
void SceneDialogue_RunActorTwelveDialogue(void) { Func_020022b0(); Func_02002346(0x24d3); Func_02002366(12, 0); Func_020022ca_scene_dialogue(); }
...
void FieldScene_RunScene3abSequenceA(void)
{
    extern u8 Data_03001ebc[];
...
void FieldScene_CallHelper27cc(void) { Func_020027cc(); }

void SceneState_Run83WhenFlag201Clear(void)
{
    if (Func_020026da_setup(0x201) == 0)
        Func_02002854_setup(83);
}
...
{
    Func_02002946_setup(6, 11, 1, 1, 7, 11);
    Func_02002958_setup(6, 11, 1, 1, 8, 11);
    Func_0200296a_setup(6, 11, 1, 1, 9, 11);
    Func_020029a8_setup(0x241);
}
...
{
    Func_02002b32_setup(7, 12, 1, 1, 7, 11);
    Func_02002b44_setup(7, 12, 1, 1, 8, 11);
    Func_02002b56_setup(7, 12, 1, 1, 9, 11);
}
...
void FieldScene_RunLeaderMovementSequence(void)
{
    ...
    Func_02003070(0);
    Call3_scene_setup(Func_02003064, 0, 72, 0x120);
    Func_02003082(0);
    Call3_scene_setup(Func_02003076, 0, 88, 0x120);
    Func_02003094(0);
    Func_02003048();
}
...
s32 FieldScene_InitializeStoryActors(void)
{
    ...
    if (Data_02000240_t[224][0] == (s32)Data_00000068) {
        *(s32 *)((*(u8 **)Data_03001ebc + 0x1c0)) = 0x100;
        Func_02001c7c_init();
        if (Value1_scene_setup(Func_02003052_init, 0xfd1) == 0) {
            Func_02002edc_init(20);
        }
        record = Value1_scene_setup(Func_020030a2_init, 8);
        if (record != 0) {
            Func_02003044_init(record, 0);
        }
        Call1_scene_setup(Func_0200307a_init, 0x201);
    }
    if (Data_02000240_t[224][0] == (s32)Data_0000009f) {
        *(s32 *)((*(u8 **)Data_03001ebc + 0x1c0)) = 0x100;
        Data_02000240_t[289][0] = 10;
        if (Data_02000240_t[225][0] == 4) {
            if (Value1_scene_setup(Func_020030ac_init, 0x109) == 0) {
                Func_02002a10_init();
            }
        }
        if (Data_02000240_t[225][0] == 3) {
            if (Value1_scene_setup(Func_020030ca_init, 0x109) == 0) {
                Func_02002cce_init();
            }
        }
        if (Value1_scene_setup(Func_020030d8_init, 0x941) != 0) {
            if (Value1_scene_setup(Func_020030e2_init, 0x94d) == 0) {
                Call2_scene_setup(Func_02003058_init, 0x2008ac5, 0xc80);
            }
        }
        Call2_scene_setup(Func_02003062_init, 0x2009241, 0xc80);
        Call1_scene_setup(Func_02003110_init, 0x944);
        Call1_scene_setup(Func_02003116_init, 0x945);
        Call1_scene_setup(Func_0200311c_init, 0x946);
        Call1_scene_setup(Func_02003122_init, 0x947);
        Call1_scene_setup(Func_02003128_init, 0x948);
        Call1_scene_setup(Func_0200312e_init, 0x943);
        Call1_scene_setup(Func_02003134_init, 0x949);
        Call1_scene_setup(Func_0200313a_init, 0x94a);
        Call1_scene_setup(Func_02003140_init, 0x94b);
        Call1_scene_setup(Func_02003146_init, 0x94c);
    }
    return 0;
}

 ...
 *
 * Family-matched to games/tbs/SRC/BATTLE/EFFECT/MEMBER_ORBIT.C
 ...
 * games/tbs/recon/en/main/080e7404.c, 080d59b0.c, 080d82b0.c, 080dc1ec.c and
 ...
 *
 * Per games/tbs/recon/en/dossiers.json#main:080e01e4's fully-derived evidence,
 ...
 * games/tbs/asm/080072e4.s (base 0x080072e4 + 4*4 and + 4*7).  Every `bl` to
 ...
 * each such `bl` in games/tbs/asm/080e0564.s.
 */

 ...
 *
 * TRANSPOSED from games/gs1/semantic/overlays/resource_3bf_c_02005a40.c.  The two owners are
 ...
 * 'cargo run --release --manifest-path tools/overlay-call-targets/Cargo.toml -- resource_3a7 13ac'.  All four target this

...
/*
 * resource_39b owner at 0x020003a8, 384 bytes: code through the sole unwind
 ...
 *
 * The word table at 0x0200a700 has one packed signed displacement per high
...
void Func_020003a8(void)
{
    ...
    if (Func_02002908(actor, position) > 0)
        return;
    if (actor[0x62] != 0)
        return;

    Func_020028d8(leader, 8);
    Func_02002890(15);
    Func_02002abe(185);

    *(s32 *)(actor + 0x30) = 0x3333;
    *(s32 *)(actor + 0x34) = 0x3333;
    Func_0200291e(actor, position[0], position[1], position[2]);

    *(s32 *)(leader + 0x30) = 0x3333;
    *(s32 *)(leader + 0x34) = 0x3333;
    Func_0200292e(leader, position[0], position[1], position[2]);
    Func_0200293c(actor);
    Func_02002ae0();

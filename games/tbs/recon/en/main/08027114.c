 ...
 *
 * Evidence used, all from games/tbs/asm/08027114.s and its literal pools:
 ...
 *     games/tbs/SRC/BATTLE/PRESENTATION/WAIT_SYNC.C and
 *     games/tbs/SRC/SYSTEM/LINK/UPDATE_SESSION_COUNTDOWN.C.

...
|---|---:|---:|
| Compiled C | 1,104 | 62,030 |
| Reconstruction assembly | 2,069 | 486,406 |
...
Within the reconstruction assembly, 462,118 bytes remain active
C-decompilation, boundary-splitting, or function-merging work. The other 24,288
...
The stricter build-report `byte_reconstruction` milestone is 7,926,490 of
8,388,608 bytes, or 94.49%. It counts exact C, deterministic asset round trips,
and positively retained structural assembly, while treating ordinary
reconstruction assembly as unfinished C work. The remaining 462,118 bytes are
...
| Byte reconstruction | 7,926,490 / 8,388,608 bytes (94.49%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 62,030 / 525,088 identified executable bytes (11.81%) | Active executable work represented as exact C |

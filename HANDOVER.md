...
lane currently accounts for **265,632 executable bytes across 568 compiling
sources**: 252,840 main-image bytes and 12,792 overlay bytes. Combined with exact
C, **442,206 / 1,339,542 executable bytes** are expressed as C. Build that lane

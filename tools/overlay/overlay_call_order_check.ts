 ...
 * Examples:
 *
 *   bun tools/overlay/overlay_call_order_check.ts --self-test
 *   bun tools/overlay/overlay_call_order_check.ts resource_39d 0b24 1af0
 *   bun tools/overlay/overlay_call_order_check.ts resource_3bd
 *   bun tools/overlay/overlay_call_order_check.ts --all
 *
...
import { Discovery } from "../lib/discover.ts";
import { OVERLAY_BASE, classify, overlayImage, resolveOverlay, targetOffset } from "../lib/overlay_call_targets.ts";

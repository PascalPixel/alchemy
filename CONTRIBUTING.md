...
- **Unfinished scopes:** 1,659
- **Address spaces scanned:** 97 (86 still contain targets)
- **Target bytes:** 665,548 tracked-C or unresolved-assembly bytes
- **Resolved-only bytes:** 524,436 Exact C or audited permanent assembly bytes
- **Executable bytes accounted for:** 1,348,402

### Main target list

This table contains every scope of at least 1,000 bytes (195 rows). The complete
1,659-row index, including the smallest audited owners, is

#include "types.h"
#include "scene.h"
#include "abi/overlays/scene/effect/object_scale.h"
...
s32 Effect_Run12();            /* Sampled value. */
 ...
 * object + 6 is the facing angle.  What Effect_Run12 samples is not
 * established here.
 */
s32 Actor_SetFacingFromSample(u8 *object)
{
    ...
    u32 sample = (u32)(Effect_Run12() << 6) >> 16;   /* bits 10..15 */
...
void Scene_RunActor232SceneWhenFlag923Or922(void)
{
    ...
    if (Effect_Check((s32)&Value_00000923) != 0 || Effect_Check2((s32)&Value_00000922) != 0) {
        Effect_Run14();
        Effect_Apply(0xE8, 3);
        Effect_Apply2(0xE8, 0);
        Effect_Do5((s32)&Value_00000924);
        Effect_Run15();
    }
}
...
void Scene_RunScene3b0(void)
{
    ...
    Effect_Run23();
    Effect_Place2(0, 0xa40000, 0x1410000);
    Effect_Run24(0, 15);
    record = Effect_Check4(0);
    Effect_Run25(record, 0);
    Effect_Run26(1);
    Effect_Run27();
    Effect_Run28(1);
    Effect_Run29();
...
void Scene_RunScene3b0(void)
{
    ...
    *(s32 *)((*(u8 *volatile *)gWork + 0x1c0)) = 0x202;
    ...
    Effect_Run32();
    Effect_Run33(20);
    Effect_Place3(8, 0x10000, 0x8000);
    Effect_Place4(8, 164, 0x141);
    Effect_Place5(8, 0xd000, 40);
    Effect_Place6(8, 0xb000, 40);
    Effect_Place7(8, 0xd000, 40);
    Effect_Place8(8, 0x3000, 10);
    Effect_Place9(8, 164, 0x14e);
    Effect_Run34(8, 4, 40);
    Effect_Run35(8, 2);
    Effect_Do(0x1e3a);
    Effect_Run36(8, 0, 20);
...
void OvObj_InitWithRandomFields(s32 a)
{
    ...
    Effect_Apply3(a, 1);
    obj[0x55] = 0;
    *(u16 *)(obj + 0x64) = Effect_Run56() >> 15;
    *(u16 *)(obj + 0x66) = Effect_Run57() >> 15;
    x = Effect_Run58();
    x <<= 2;
    x >>= 16;
    x <<= 16;
...
void Scene_RunSevenActorEnsemble(void)
{
    ...
    Effect_Run75();
    Effect_Run76(0, 15);
    ensemble = Effect_Check5(0);
    Effect_Run77(ensemble, 0);
    Effect_Do2(33593196);
    Effect_Run78(1);
    Effect_Run79(9);
    Effect_Run80(10);
    ...
    *(s32 *)(gWork + 448) = 515;
    ...
    Effect_Run93(14);
    Effect_Run94(15);
    Effect_Place10(9, 196608, 98304);
    Effect_Place11(10, 196608, 98304);
    Effect_Place12(11, 196608, 98304);
    Effect_Place13(12, 196608, 98304);
    Effect_Place14(13, 196608, 98304);
    Effect_Place15(14, 196608, 98304);
    Effect_Place16(15, 196608, 98304);
    Effect_Run3(9, 33592400);
    Effect_Run4(10, 33592448);
    Effect_Run5(11, 33592496);
    Effect_Run6(12, 33592544);
    Effect_Run7(13, 33592592);
    Effect_Run8(14, 33592640);
    Effect_Run9(15, 33592688);
    Effect_Run95(40);
    Effect_Run96(8, 3);
    Effect_Run10(8, 258);
    Effect_Run97(120);
    Effect_Run98(8, 1);
    Effect_Place17(8, 256, 60);
    Effect_Place18(8, 65536, 32768);
    Effect_Place19(8, 164, 344);
    Effect_Run99(8, 4, 10);
    Effect_Run100(8, 6, 20);
    Effect_Do4(7908);
    Effect_Run101(8, 0, 20);
    *(s32 *)(gWork + 448) = 514;
    Effect_Run102();
    Effect_Run103();
    gCell[226] = (s32)&Value_0000006f;
    gCell[227] = 2;
    selector = Effect_Check6();
    if (selector == 11) {
        Effect_Run104(15);
    } else {
        Effect_Run105(14);

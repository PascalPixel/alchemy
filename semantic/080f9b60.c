 ...
 * in the second.  This one stores the operand as the track field at 0x0a and raises the two middle request bits.
 *
...
u8 Func_080f9ab4(struct Track_080f9b60 *track);

void Func_080f9b60(void *player, struct Track_080f9b60 *track)
{
    track->parameter_0a = Func_080f9ab4(track);
    track->status |= 12;
}

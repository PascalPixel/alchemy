 ...
 * games/THE BROKEN SEAL/src/overlays/scene/script/run_scene_3b9_conditional_scene_setup.c
 * already spells. */
 ...
 * games/THE BROKEN SEAL/recon/en/overlays/resource_3b9_c_02001cd4.c, which documents the

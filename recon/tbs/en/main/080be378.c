 ...
 * "Completion and measurement" note: assembled recon/tbs/raw/080be378.s and
 * recon/tbs/raw/080be76c.s standalone (both already 4-byte aligned at their
 ...
 * LiteralPool_080be738 (recon/tbs/raw/080be378.s, right after the head's own
 ...
 * truth: assembled recon/tbs/raw/080beb08.s standalone (already 4-byte
...
s32 Func_080be378(struct BattleCommandRequest *request, struct BattlePlan *plan)
{
    ...
    *(u32 *)(tgt + 80) = 4;
     ...
     * recon/tbs/raw/080be378.s (9 named targets, a 90-entry `.rept` block
...
L_080be888:
    {
        ...
        }
        {
             ...
             * recon/tbs/raw/080be76c.s and objdumping it shows this array
...
L_080be984:
     ...
     * recon/tbs/raw/080be76c.s (0x080be9ce-0x080bea9a) with every
     * literal-pool constant resolved from that region's own pool (see
     * recon/tbs/en/dossiers.json#main:080be378's attempt log for the
...
L_080bec90:
    ...
    *(u32 *)(tgt + 80) = *((u8 *)abilityData + 2);
     ...
     * recon/tbs/raw/080beb08.s -- treated as an alias of L_080bee00's entry
...
L_080befb4_shared:
     ...
     * recon/tbs/raw/080bef88.s against its real load address 0x080bef88 to
     * get exact instruction offsets (see recon/tbs/en/dossiers.json#main:080be378
...
L_080bf1a8:
    ...
    *(u16 *)(tgt + 72) = *(u16 *)(req + 6);
     ...
     * (dead-unit tail-call / early-return, inside recon/tbs/raw/080beb08.s)
     * and 0x080bf1d4 / 0x080bf1d6 (inside recon/tbs/raw/080bef88.s,

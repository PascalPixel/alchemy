...
/*
 * resource_3bc owner at 0x02004790, 160 bytes (0x02004790-0x02003aff):
 ...
 * 0x02004790; epilogue `add sp, #12 / pop {r3} / mov r8, r3 /
 ...
 * `games/gs1/assets/code/resource_3bc_c_02000158.c`), so it is a RAM global — the shared

/*
 * resource_3b7 owner at 0x02000154, 36 bytes (0x02000154-0x02000177).
 *
 * A minimal cutscene beat: open the scene, run one scripted text/animation
 * entry, wait, and close.  The body is 32 bytes of code (0x02000154-0x02000171)
 * followed by a two-byte alignment `nop` at 0x02000172 and one literal-pool
 * word at 0x02000174 (0x00000e34), which is the entry id loaded into r0.  The
 * pool word is data: it is past the `bx r0` return and is only ever reached by
 * the `ldr r0, [pc, #24]` at 0x0200015a.
 *
 ...
 *   0x02000156 -> veneer 0x0200191c -> Func_0808a018
 *   0x0200015c -> veneer 0x02001964 -> Func_0808a170
 *   0x02000166 -> veneer 0x0200196c -> Func_0808a178
 *   0x0200016a -> veneer 0x02001924 -> Func_0808a020
 ...
 *
 * `Func_02000178` is this owner byte-for-byte except for the pool word
 * (0x00000e35 instead of 0x00000e34); the two are proven siblings.
 *

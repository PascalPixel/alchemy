...
/*
 * resource_3af owner at 0x02000af0, 168 bytes: actor 24's interaction
 ...
 * dialogue ids -- 24/0x1e09/0x1d70/0x1d37 here against 21/0x1e08/
 * 0x1d6f/0x1d36 there. Same instruction sequence, same branch offsets,
 ...
 *
 * The three replies:
 *   flag 0x925 set   -> line 0x1e09, then hand the actor back.
 *   flag 0x922 set   -> face the actor (Func_0808a138(id, 2)), line
 *                       0x1d70, hand back, then reload the u16 at
 ...
 *
 * Complete owner: `push {r5, lr}` at 0x02000af0 through `pop {r5} /
 * pop {r0} / bx r0` at 0x02000b76-0x02000b7a; seven trailing pool words
 * (0x00000925, 0x00001e09, 0x00000922, 0x00001d70, 0x0200c4d8,
 * 0x00000103, 0x00001d37) end at 0x02000b97, and the next owner
 * prologue (the 32-byte callback 0x02000b98) begins at 0x02000b98.
 *
...
void Func_02000af0(void)
{
    ...
    if (Func_080770c0(0x925) != 0) {
        Func_0808a170(0x1e09);
        Func_0808a180(24, 0);
    } else if (Func_080770c0(0x922) != 0) {
        Func_0808a138(24, 2);
        Func_0808a170(0x1d70);
        Func_0808a180(24, 0);
        ...
        *(u16 *)(record + 100) = (u16)(draw + 60);
        ...
        Func_0808a1e8(24, 0x103, 0);
        Func_0808a130(24, 3);
        Func_0808a170(0x1d37);
        Func_0808a180(24, 0);
    }
    Func_0808a020();
}

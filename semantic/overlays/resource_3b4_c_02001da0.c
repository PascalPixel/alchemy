...
/*
 * resource_3b4 owner at 0x02001da0, 86 bytes.
 *
 * Four collision repaints through Func_080091c0 that walk the second stack
 * word's row from 49 to 52.  r5 holds the constant 55 that every call stores at
 * [sp,#4].  The epilogue is `add sp,#8 / pop {r5} / pop {r0} / bx r0`, so the
 * owner is void.
 */

void Func_080091c0();

void Func_02001da0(void)
{
    Func_080091c0(48, 55, 1, 1, 49, 55);
    Func_080091c0(48, 55, 1, 1, 50, 55);
    Func_080091c0(48, 55, 1, 1, 51, 55);
    Func_080091c0(48, 55, 1, 1, 52, 55);
}

...
/*
 * resource_37e owner at 0x0200003c, 8 bytes: `ldr r0, [pc, #0] / bx lr` plus the
...
/*
 * resource_37e owner at 0x02000044, 8 bytes: `ldr r0, [pc, #0] / bx lr` plus the
...
/*
 * resource_37e owner at 0x0200004c, 8 bytes: `ldr r0, [pc, #0] / bx lr` plus the

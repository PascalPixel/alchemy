...
/*
 * resource_3b4 owner at 0x02001a48, 40 bytes.
 *
 * Repaint one collision cell through Func_080091c0 and then mark slot 8's
 * byte at +35 with 2.  Func_080091c0 takes four register arguments and two
 * stack words; the stack pair is written at [sp,#0] and [sp,#4] before the
 * branch.  0x02001a70 and 0x02001a9c are the sibling cells.
 */

 ...
 * 0x08002098, and the `bl 0x8007318` then runs the copied bytes.  sp is
 * word-aligned, so the branch enters ARM state; 0x08002098 disassembles as
 * coherent ARM.
 *
 ...
 */
typedef void (*StackKernel_0800567c)(void *, void *, void *);
extern char Value_0000005c;
extern char Data_08002098;

void Func_0800567c(void *a, void *b, void *c)
{
    u32 words = (u32)&Value_0000005c >> 2;
    {
        u32 buffer[words];
        u32 *dma = (u32 *)0x040000d4;
        u32 source = (u32)&Data_08002098;
        ...
        ((StackKernel_0800567c)(void *)buffer)(a, b, c);
    }
}

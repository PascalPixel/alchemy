 ...
 * games/tbs/asm/080b56e0.s. Traced directly from the retained assembly;
 * see games/tbs/recon/en/dossiers.json#main:080b56e0 for the evidence log.
 *
 ...
 * already adopted in games/tbs/src/shop/sel/repair.c and
 * games/tbs/src/shop/sel/use.c (a fresh dereference per `if`,
 ...
 * Battle_ReservedNoOp2A08 (games/tbs/src/battle/runtime/
 ...
 * Func_08077098 (a plain far-call veneer, see games/tbs/asm/
 ...
 * mirroring games/tbs/src/game_flags/set.c's plain `(u8 *)0x02000040`

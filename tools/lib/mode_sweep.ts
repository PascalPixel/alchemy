...
export const MODES: readonly Mode[] = [
  ...
  { id: "sched-low-dest-first", family: "scheduler", addFlags: ["-fsched-low-dest-first"], evidence: "proven-routing" },
  { id: "sched-high-dest-first", family: "scheduler", addFlags: ["-fsched-high-dest-first"], evidence: "proven-routing" },
  { id: "sched-alias-off", family: "scheduler", addFlags: ["-fno-sched-alias"], evidence: "proven-routing" },
  { id: "sched-store-first", family: "scheduler", addFlags: ["-fsched-store-first"], evidence: "proven-routing" },

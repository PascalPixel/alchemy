...
s32 Func_02000ca0(void)
{
    ...
    *(s32 *)(workspace + 448) = 516;
    ...
    if (Data_02000240[224] == 0x61) {
        ...
        Func_0200204e(8, 2);
        Func_02002056(9, 2);
        Func_02002002(Func_0200204c(8), 0);
        Func_0200200e(Func_02002058(9), 0);
    ...
    if (Data_02000240[224] == 0x62) {
        ...
        Func_02002052(Func_0200209c(8), 0);
        Func_0200205e(Func_020020a8(10), 0);
        Func_0200206a(Func_020020b4(9), 0);

...
void Func_02003054(void)
{
    ...
    if (Func_0808a070(0, 0) != 0) {   /* 2003340 */
        Func_0808a170(0x248c);   /* 200338c */
        Func_0808a180(3, 0);   /* 2003394 */
        Func_0808a148(0, 0xc, 0);   /* 200339e */
        Func_0808a148(1, 0xc, 0);   /* 20033a8 */
        Func_0808a148(2, 0xc, 0);   /* 20033b2 */
        Func_0808a148(3, 0xc, 0);   /* 20033bc */
        Func_0808a010(0x14);   /* 20033c2 */
        Func_0808a148(0xc, 0, 0);   /* 20033cc */
        Func_0808a010(0x3c);   /* 20033d2 */
        Func_0808a148(0xc, 0xd, 0);   /* 20033dc */
        Func_0808a010(0x50);   /* 20033e2 */
        Func_0808a110(0xc, 3);   /* 20033ea */
        Func_0808a010(0x1e);   /* 20033f0 */
        Func_0808a148(0xc, 0, 0);   /* 20033fa */
        Func_0808a170(0x248d);   /* 2003402 */
        Func_0808a180(0xc, 0);   /* 200340a */
        Func_0808a010(0x3c);   /* 2003410 */
        Func_0808a148(2, 0xc, 0);   /* 200341a */
        Func_0808a148(1, 0xc, 0);   /* 2003424 */
        Func_0808a148(3, 0xc, 0);   /* 200342e */
        Func_0808a148(0, 0xc, 0);   /* 2003438 */
        Func_0808a100(2, 3);   /* 2003440 */
        Func_0808a100(1, 3);   /* 2003448 */
        Func_0808a100(3, 3);   /* 2003450 */
        Func_0808a100(0, 3);   /* 2003458 */
        Func_0808a010(0x50);   /* 200345e */
        Func_0808a148(0xc, 0xd, 0);   /* 2003468 */
        Func_0808a148(2, 0xd, 0);   /* 2003472 */
        Func_0808a148(1, 0xd, 0);   /* 200347c */
        Func_0808a148(3, 0xd, 0);   /* 2003486 */
        Func_0808a148(0, 0xd, 0);   /* 2003490 */
    } else {
        Func_0808a100(2, 3);   /* 200334c */
        Func_0808a100(1, 3);   /* 2003354 */
        Func_0808a100(3, 3);   /* 200335c */
        Func_0808a148(0xc, 0xd, 0);   /* 2003366 */
        Func_0808a010(0x3c);   /* 200336c */
    }

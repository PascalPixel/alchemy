...
use candidate_compiler::jsnum::{compare_tuple, is_strictly_better, math_max, parse_hex, to_js_number_string};
use candidate_compiler::jsstring::{is_js_space, js_split_lines, js_split_whitespace_runs, js_trim, utf16_cmp};

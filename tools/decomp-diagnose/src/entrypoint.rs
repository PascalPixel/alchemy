...
fn self_test() -> Result<(), String> {
    ...
    if first.count(crate::MismatchKind::RegisterOnly) != 2
    ...
    if second.count(crate::MismatchKind::ExtraInstruction) != 1 {
...
mod tests {
    ...
    fn the_self_test_predicates_can_fail() {
        ...
        assert_ne!(
            exact.count(crate::MismatchKind::RegisterOnly),
            2,
        ...
        assert_eq!(
            exact.count(crate::MismatchKind::ExtraInstruction),
            0,

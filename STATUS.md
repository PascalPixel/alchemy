...
|---|---:|---:|
| Compiled C | 1,085 | 59,344 |
| Reconstruction assembly | 2,088 | 489,092 |
...
Within the reconstruction assembly, 465,072 bytes remain active
C-decompilation, boundary-splitting, or function-merging work. The other 24,020
...
The stricter build-report `byte_reconstruction` milestone is 7,923,536 of
8,388,608 bytes, or 94.46%. It counts exact C, deterministic asset round trips,
and positively retained structural assembly, while treating ordinary
reconstruction assembly as unfinished C work. The remaining 465,072 bytes are
...
| Byte reconstruction | 7,923,536 / 8,388,608 bytes (94.46%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 59,344 / 525,088 identified executable bytes (11.30%) | Active executable work represented as exact C |

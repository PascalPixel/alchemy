...
//
//   bun tools/overlay/overlay_gaps.ts                  # every overlay
//   bun tools/overlay/overlay_gaps.ts resource_3a4     # one overlay
//   bun tools/overlay/overlay_gaps.ts --certified      # only overlays claimed closed
//   bun tools/overlay/overlay_gaps.ts --ranked         # owner-shaped gaps, best yield first
//   bun tools/overlay/overlay_gaps.ts --json
//   bun tools/overlay/overlay_gaps.ts --self-test
import { existsSync, readdirSync } from "node:fs";
import { dirname, join } from "node:path";
import { overlayImage } from "../lib/overlay_call_targets.ts";
import { manualRegions, exactSpans, isPrologueShape, savesLinkRegister } from "../lib/overlay_published.ts";

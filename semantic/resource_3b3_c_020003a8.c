...
extern u8 * Func_02002ed4();
extern s32 * Func_0200073e();
extern s32 * Func_0200076a();
extern s32 * Func_02000796();
extern s32 Func_02002f50();
extern void Func_02002f00();
extern void Func_02002ed8();
extern void Func_0200305e();
extern void Func_02002f46();
extern void Func_02002f56();
extern void Func_02002f64();
extern void Func_02003080();
extern void Func_02002f6c();
void Func_020003a8(void)
{
    s32 permuted_17;
    s32 permuted_9;
    s32 permuted_11;
    u8 *leader = Func_02002ed4(0);
    ...
    if (Func_02002f50(actor, position) > 0)
        return;
    if (actor[0x62] != 0)
        return;

    Func_02002f00(leader, 8);
    Func_02002ed8(15);
    Func_0200305e(185);

    *(s32 *)(actor + 0x30) = 0x3333;
    *(s32 *)(actor + 0x34) = 0x3333;
    Func_02002f46(actor, position[0], position[1], position[2]);

    *(s32 *)(leader + 0x30) = 0x3333;
    *(s32 *)(leader + 0x34) = 0x3333;
    Func_02002f56(leader, position[0], position[1], position[2]);
    Func_02002f64(actor);
    Func_02003080();

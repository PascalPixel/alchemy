...
- Semantic-C lane: **155,494 executable bytes across 374 compiling sources**:
  143,486 main bytes and 12,008 overlay bytes. Combined with exact C,
  **293,462 / 1,338,732 executable bytes** are now expressed as C, with
  1,045,270 remaining.

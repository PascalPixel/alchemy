...
|---|---:|---:|
| Compiled C | 981 | 46,778 |
| Reconstruction assembly | 2,190 | 501,658 |
...
Within the reconstruction assembly, 478,310 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,910,298 of
...
reconstruction assembly as unfinished C work. The remaining 478,310 bytes are
...
| Byte reconstruction | 7,910,298 / 8,388,608 bytes (94.30%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 46,778 / 525,088 identified executable bytes (8.91%) | Active executable work represented as exact C |

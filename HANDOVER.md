...
- Semantic-C lane: **221,864 executable bytes across 491 compiling sources**:
  209,072 main bytes and 12,792 overlay bytes. Combined with exact C,
  **369,478 / 1,339,230 executable bytes** are now expressed as C, with
  969,752 remaining.

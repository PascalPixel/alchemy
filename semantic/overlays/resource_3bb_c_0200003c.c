...
/*
 * resource_3bb owner at 0x0200003c, 8 bytes: `ldr r0, [pc, #0] / bx lr`
 * plus the one-word literal pool at 0x02000040 holding 0x200c474.
 *
 ...
 *
 * The pool word 0x200c474 is an ADDRESS, loaded and returned WITHOUT being

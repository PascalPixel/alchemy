...
extern struct Obj *Func_0200315c(s32 arg0);
...
extern s32 Func_020031d0(struct Obj *arg0, s32 *arg1);
extern void Func_020031b0(struct Obj *arg0, s32 arg1);
extern void Func_02003178(s32 arg0);
extern void Func_020032de(s32 arg0);
extern void Func_020031e6(struct Obj *arg0, s32 arg1, s32 arg2, s32 arg3);
extern void Func_020031f6(struct Obj *arg0, s32 arg1, s32 arg2, s32 arg3);
extern void Func_02003204(struct Obj *arg0);
extern void Func_02003300(void);
extern void Func_0200321c(struct Obj *arg0, s32 arg1);
...
void Func_020000c4(void) {
    ...
    w <<= 16;
    buf[2] = b->u10.w + w;
    if (Func_020031d0(b, buf) > 0) return;
    ...
    b->field30 = c;
    b->field34 = c;
    Func_020031e6(b, buf[0], buf[1], buf[2]);
    a->field30 = c;
    a->field34 = c;
    Func_020031f6(a, buf[0], buf[1], buf[2]);
    Func_02003204(b);
    Func_02003300();
    b->u08.w = buf[0];
    b->u10.w = buf[2];

 ...
 *
 * All 13 call sites were resolved with `tools/overlay_call_targets.ts`; all 13
...
void Func_0200092c(void)
{
    ...
    *(s32 *)(workspace + 448) = 32;
    ...
    if (Func_080770c0(0x879) != 0) {
        { s32 f1 = 6; s32 g1 = 6; Func_080091c0(5, 6, 1, 1,  f1, g1); }
        { s32 f2 = 7; s32 g2 = 6; Func_080091c0(5, 6, 1, 1,  f2, g2); }
        { s32 f3 = 8; s32 g3 = 6; Func_080091c0(5, 6, 1, 1,  f3, g3); }
        { s32 f4 = 6; s32 g4 = 5; Func_080091c0(0, 1, 3, 1,  f4, g4); }
    }

    if (Func_080770c0(0x815) != 0) {
        Func_0808a0f0(8, 0x780000, 0xe80000);
        { s32 f5 = 6; s32 g5 = 14; Func_080091c0(2, 10, 1, 1,  f5, g5); }
        { s32 f6 = 7; s32 g6 = 14; Func_080091c0(2, 10, 1, 1,  f6, g6); }
        { s32 f7 = 8; s32 g7 = 14; Func_080091c0(2, 10, 1, 1,  f7, g7); }
    }
}

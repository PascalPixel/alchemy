...
- **Unfinished scopes:** 1,686
- **Address spaces scanned:** 97 (87 still contain targets)
- **Target bytes:** 673,276 tracked-C or unresolved-assembly bytes
- **Resolved-only bytes:** 516,494 Exact C or audited permanent assembly bytes
- **Executable bytes accounted for:** 1,348,188

### Main target list

This table contains every scope of at least 1,000 bytes (195 rows). The complete
1,686-row index, including the smallest audited owners, is

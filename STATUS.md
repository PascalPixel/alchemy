...
|---|---:|---:|
| Compiled C | 1,050 | 55,080 |
| Reconstruction assembly | 2,121 | 493,356 |
...
Within the reconstruction assembly, 470,008 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,918,600 of
8,388,608 bytes, or 94.39%. It counts exact C, deterministic asset round trips,
and positively retained structural assembly, while treating ordinary
reconstruction assembly as unfinished C work. The remaining 470,008 bytes are
...
| Byte reconstruction | 7,918,600 / 8,388,608 bytes (94.40%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 55,080 / 525,088 identified executable bytes (10.49%) | Active executable work represented as exact C |

/*
 * resource_3b7 owner at 0x02000074, 72 bytes (0x02000074-0x020000bb).
 *
 * A branching dialogue beat.  Code runs 0x02000074-0x020000b5; 0x020000b6 is a
 * two-byte alignment `nop` and 0x020000b8 is a single literal-pool word
 * (0x00000e39), the base script-entry id loaded into r5 at 0x02000076.  The
 ...
 * `Func_020000bc` print entirely different callee addresses while resolving to
 * exactly the same five veneers.  In program order:
 *   0x0200007c -> veneer 0x02001964 -> Func_0808a170
 *   0x02000084 -> veneer 0x0200196c -> Func_0808a178
 *   0x0200008c -> veneer 0x02001934 -> Func_0808a070
 *   0x02000096 -> veneer 0x02001914 -> Func_0808a010
 *   0x0200009c -> veneer 0x02001964 -> Func_0808a170
 *   0x020000a4 -> veneer 0x02001964 -> Func_0808a170
 *   0x020000ac -> veneer 0x02001974 -> Func_0808a180
 ...
 *
 * `Func_020000bc` is this owner byte-for-byte except for the pool word
 * (0x00000e19 instead of 0x00000e39); the two are proven siblings.
 *

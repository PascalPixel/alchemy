...
/*
 * resource_3bc owner at 0x02004494, 232 bytes (0x02004494-0x0200384b).
 *
 * Prologue at 0x02004494: `push {r5, r6, r7, lr}`, then the high-register save
 ...
 * whose byte-exact source is `games/gs1/assets/code/resource_3bc_c_0200384c.c`, so
 ...
 * `games/gs1/assets/code/resource_3bc_c_02000158.c` (pool word 0x0200804d =
 ...
 * `resource_3bc_c_0200384c.c` declares the analogous word 0x0200b1c1 as

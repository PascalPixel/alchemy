...
#define Runtime_AllocateHeapBlock Func_080048f4
#define Runtime_AllocateBlock Func_080048b0
...
#define ObjectSystem_Configure Func_0800bb20
...
void ObjectSystem_Configure(s32 mode)
{
    ...
    table = Runtime_AllocateBlock(53, size);

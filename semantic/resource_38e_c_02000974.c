 ...
 *
 * What was changed:
 *  - the callback 0x0200dae1 becomes 0x0200890d.  Under the proven 0x02008000
 *    link base that is file offset 0x090c plus the Thumb bit, and that offset
 ...
 *    resource_38e 0974': 7 sites, 7 distinct veneers, publishing exactly the same
...
struct SceneEntity *Func_02001474();
void Func_0200144e();

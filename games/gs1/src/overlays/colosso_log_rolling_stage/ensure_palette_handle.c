 ...
 * stop_palette_task.c tears down -- if Data_0200dace still holds the
 ...
 * (start_palette_task.c). It makes one outgoing call, resolved with
 ...
 * -- resolved with `bun tools/overlay-show resource_3bc 38fc | bun
 * cargo run --release --manifest-path tools/overlay-call-targets/Cargo.toml -- resource_3bc 38fc 3916 --annotate`):
 *   0x200390c -> veneer -> Func_080153b8()   established, no-arg, u16 return (games/gs1/semantic/main/0809bb64.c)
 */

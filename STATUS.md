...
|---|---:|---:|
| Compiled C | 1,041 | 54,226 |
| Reconstruction assembly | 2,130 | 494,210 |
...
Within the reconstruction assembly, 470,862 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,917,746 of
...
reconstruction assembly as unfinished C work. The remaining 470,862 bytes are
...
| Byte reconstruction | 7,917,746 / 8,388,608 bytes (94.39%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 54,226 / 525,088 identified executable bytes (10.33%) | Active executable work represented as exact C |

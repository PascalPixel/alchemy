...
|---|---:|---:|
| Compiled C | 990 | 47,752 |
| Reconstruction assembly | 2,181 | 500,684 |
...
Within the reconstruction assembly, 477,336 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,911,272 of
8,388,608 bytes, or 94.31%. It counts exact C, deterministic asset round trips,
and positively retained structural assembly, while treating ordinary
reconstruction assembly as unfinished C work. The remaining 477,336 bytes are
...
| Byte reconstruction | 7,911,272 / 8,388,608 bytes (94.31%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 47,752 / 525,088 identified executable bytes (9.09%) | Active executable work represented as exact C |

...
|---|---:|---:|
| Compiled C | 1,048 | 54,756 |
| Reconstruction assembly | 2,123 | 493,680 |
...
Within the reconstruction assembly, 470,332 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,918,276 of
...
reconstruction assembly as unfinished C work. The remaining 470,332 bytes are
...
| Byte reconstruction | 7,918,276 / 8,388,608 bytes (94.39%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 54,756 / 525,088 identified executable bytes (10.43%) | Active executable work represented as exact C |

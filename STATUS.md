...
|---|---:|---:|
| Compiled C | 1,054 | 55,630 |
| Reconstruction assembly | 2,117 | 492,806 |
...
Within the reconstruction assembly, 469,458 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,919,006 of
...
reconstruction assembly as unfinished C work. The remaining 469,458 bytes are
...
| Byte reconstruction | 7,919,006 / 8,388,608 bytes (94.40%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 55,630 / 525,088 identified executable bytes (10.59%) | Active executable work represented as exact C |

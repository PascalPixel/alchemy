...
extern struct Descriptor *Data_0200de64[];

struct Effect *Func_02005c32();
struct Effect *Func_02005b58();
void Func_02005b62();
void Func_02005b7c();
void Func_02005d8e();
s32 Func_02005be8();
                   ...
                   const struct Options *options)
{
    ...
    if ((flags & 0x10000) != 0) {
        Func_02005d8e(effect, options->mode);
    }
    ...
    if ((flags & 0x40000) != 0) {
        ...
        if ((flags & 0x80000) != 0) {
            ...
            effect->rate30 = Func_02005be8(first_delta,
                                           descriptor->duration);
            ...
            effect->rate30 = Func_02005c00(first_delta,
                                           descriptor->duration);
            delta = options->target34;
            duration = descriptor->duration;
        ...
        effect->rate34 = Func_02005c0e(delta, duration);
    }

...
extern struct Descriptor *Data_0200dfb8[];

struct Effect *Func_02005eaa();
struct Effect *Func_02005df0();
void Func_02005dfa();
void Func_02005e14();
void Func_02006006();
s32 Func_02005e68();
                   ...
                   const struct Options *options)
{
    ...
    s32 first_delta;
    s32 accumulated;
    party = Func_02005eaa(0);

    if ((flags & 0x100000) != 0 && options != 0) {
        effect = Func_02005df0(options->kind, x, y, z);
    } else {
        effect = Func_02005df0(222, x, y, z);
    }
    if (effect == 0) return;
    ...
    Func_02005dfa(effect, (flags + 1) & 15);
    table_offset = (flags & 15) << 2;
    Func_02005e14(effect, Data_0200dfb8[table_offset >> 2]);
    ...
    if ((flags & 0x10000) != 0) {
        Func_02006006(effect, options->mode);
    }
    ...
    if ((flags & 0x40000) != 0) {
        ...
        if ((flags & 0x80000) != 0) {
            ...
            effect->rate30 = Func_02005e68(first_delta,
                                           descriptor->duration);
            ...
            effect->rate30 = Func_02005e80(first_delta,
                                           descriptor->duration);
            delta = options->target34;
            duration = descriptor->duration;
        ...
        effect->rate34 = Func_02005e8e(delta, duration);
    }

    if ((flags & 0x200000) != 0) {
        Func_02005f14(effect, 1);
        Func_02005f24(effect, options->callback_arg);
    }

...
- Semantic-C lane: **199,388 executable bytes across 446 compiling sources**:
  186,596 main bytes and 12,792 overlay bytes. Combined with exact C,
  **347,002 / 1,339,230 executable bytes** are now expressed as C, with
  992,228 remaining.

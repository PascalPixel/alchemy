...
#define Scene_RunStep200 Func_02000494
#define Scene_RunStep201 Func_020004a8
#define Scene_RunStep202 Func_020004c0
#define Scene_RunStep203 Func_020004d8
#define Scene_RunStep204 Func_020004f0
#define Scene_RunStep205 Func_02000504
#define Scene_RunStep206 Func_0200051c
#define Scene_RunStep207 Func_02000534
#define Scene_RunStep208 Func_0200054c
#define Scene_RunStep209 Func_02000560
#define Scene_RunStep20a Func_02000578
#define Scene_RunStep20b Func_02000590
#define Scene_RunStep20c Func_020005a8
#define Scene_RunStep20d Func_020005bc
#define Scene_RunStep20e Func_020005d4
#define Scene_RunStep20f Func_020005ec
#define Scene_RunStep210 Func_02000604
#define Scene_RunStep211 Func_02000618
#define Scene_RunStep212 Func_02000630
#define Scene_RunStep213 Func_02000648
#define Scene_RunStep214 Func_02000660
...
void Scene_RunStep200(void) { Func_020007d6(0x200, 64, 35, 21); }

void Scene_RunStep201(void) { Func_020007e8(0x201, 65, 35, 22); }

void Scene_RunStep202(void) { Func_02000800(0x202, 66, 35, 23); }

void Scene_RunStep203(void) { Func_02000818(0x203, 67, 35, 24); }

void Scene_RunStep204(void) { Func_02000832(0x204, 68, 35, 25); }

void Scene_RunStep205(void) { Func_02000844(0x205, 69, 35, 26); }

void Scene_RunStep206(void) { Func_0200085c(0x206, 70, 35, 27); }

void Scene_RunStep207(void) { Func_02000874(0x207, 71, 35, 28); }

void Scene_RunStep208(void) { Func_0200088e(0x208, 72, 35, 29); }

void Scene_RunStep209(void) { Func_020008a0(0x209, 73, 35, 31); }

void Scene_RunStep20a(void) { Func_020008b8(0x20a, 74, 35, 32); }

void Scene_RunStep20b(void) { Func_020008d0(0x20b, 79, 35, 50); }

void Scene_RunStep20c(void) { Func_020008ea(0x20c, 75, 35, 51); }

void Scene_RunStep20d(void) { Func_020008fc(0x20d, 76, 35, 52); }

void Scene_RunStep20e(void) { Func_02000914(0x20e, 77, 35, 53); }

void Scene_RunStep20f(void) { Func_0200092c(0x20f, 78, 35, 54); }

void Scene_RunStep210(void) { Func_02000946(0x210, 80, 35, 55); }

void Scene_RunStep211(void) { Func_02000958(0x211, 81, 35, 56); }

void Scene_RunStep212(void) { Func_02000970(0x212, 82, 35, 57); }

void Scene_RunStep213(void) { Func_02000988(0x213, 83, 35, 58); }

void Scene_RunStep214(void) { Func_020009a2(0x214, 84, 35, 59); }
#undef Scene_RunStep200
#undef Scene_RunStep201
#undef Scene_RunStep202
#undef Scene_RunStep203
#undef Scene_RunStep204
#undef Scene_RunStep205
#undef Scene_RunStep206
#undef Scene_RunStep207
#undef Scene_RunStep208
#undef Scene_RunStep209
#undef Scene_RunStep20a
#undef Scene_RunStep20b
#undef Scene_RunStep20c
#undef Scene_RunStep20d
#undef Scene_RunStep20e
#undef Scene_RunStep20f
#undef Scene_RunStep210
#undef Scene_RunStep211
#undef Scene_RunStep212
#undef Scene_RunStep213
#undef Scene_RunStep214
...
#define Effect_RegisterPaletteFadeCallback Func_0200184c
...
#undef Effect_RegisterPaletteFadeCallback
...
#undef SceneData_GetTablea5cc
#undef SceneData_GetTablea9d4
#undef SceneData_GetTableaa14
#undef SceneData_GetTableaa58
#undef SceneData_GetTableAae8

/* overlays/scene/actor/four_encounter/scene_primary_script.c */
#define Scene_RunFourActorEncounter Func_02000918
...
#undef Scene_RunFourActorEncounter

/* overlays/scene/actor/four_encounter/state_update.c */
#define State_ClearStoryVariantWhenIdle Func_02000674
#define State_ApplyRectsByFlag844 Func_02000f58
...
void Func_02002a20_a(s32, s32, s32, s32, s32, s32);
...
void State_ApplyRectsByFlag844(s32 flag)
{
    ...
    if (Func_02002a40(0x844) != 0) {
        s32 w1 = 10;
        Func_02002a20_a(121, 34, 3, 1, 93, w1);
        {
            s32 w2 = 30;
...
#undef State_ClearStoryVariantWhenIdle
#undef State_ApplyRectsByFlag844

 ...
 * stack VLA, the DMA `stmia` fills that VLA with 0xd4 bytes copied from
 * 0x080021c4, and the `bl 0x8007318` then runs the copied bytes.  sp is
 * word-aligned, so the branch enters ARM state; 0x080021c4 disassembles as
 * coherent ARM.
 *
 ...
 */
typedef void (*StackKernel_08005584)(void *, void *, void *, void *);
...
void Func_08005584(void *a, void *b, void *c, void *d)
{
    u32 words = (u32)&Value_000000d4 >> 2;
    {
        ...
        ((StackKernel_08005584)(void *)buffer)(a, b, c, d);
    }
}

...
|---|---:|---:|
| Compiled C | 1,220 | 71,970 |
| Reconstruction assembly | 1,954 | 476,466 |
...
Within the reconstruction assembly, 451,704 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,936,904 of
8,388,608 bytes, or 94.62%. It counts exact C, deterministic asset round trips,
and positively retained structural assembly, while treating ordinary
reconstruction assembly as unfinished C work. The remaining 451,704 bytes are
...
| Byte reconstruction | 7,936,904 / 8,388,608 bytes (94.62%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 71,970 / 523,724 identified executable bytes (13.74%) | Active executable work represented as exact C |

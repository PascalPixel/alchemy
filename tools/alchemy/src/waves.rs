...
const USAGE: &str = "usage: alchemy waves <inventory|bucket|scoreboard|draft <prepare|score --shard I/N|collect>> [--output PATH] [--family-index FILE]";
        ...
        .fold(
            ...
            |(covered_owners, covered_bytes, uncovered_owners, uncovered_bytes), residual| {
                if matches!(
                    ...
                    diff::triage::TopologyStatus::Uncovered
                ) {
                    (
                        covered_owners,
                        covered_bytes,

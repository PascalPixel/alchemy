 ...
 * that family -- see games/tbs/recon/en/main/080ea0d8.c (the immediate
 ...
 * trampoline bundle at games/tbs/asm/080072e4.s (0x080072e4 + 4*N), so every
 ...
 *     bytes by the exact games/tbs/src/effects/position source, so the

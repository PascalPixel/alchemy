 ...
 * (bun tools/overlay_driver.ts resource_3c0), so the loader enters
...
s32 Func_02000e8c(void)
{
    ...
    *(s32 *)(Data_03001ebc + 448) = 513;
    if (Func_080770e0(0x210) != 0) {
        *(s8 *)((u8 *)0x02000240 + 498) = 2;
        Func_080000d0(0x02008401, 3200);
    }
    if (*(s16 *)((u8 *)0x02000240 + 448) == 164
        || *(s16 *)((u8 *)0x02000240 + 448) == 165) {
        *(u16 *)0x02009a00 = *(u16 *)0x0500019e;
        Func_02000d24();
    }
    if (*(s16 *)((u8 *)0x02000240 + 448) == 164) {
        Func_02000f50();
    } else if (*(s16 *)((u8 *)0x02000240 + 448) == 165) {
        Func_02001094();
    } else {
        Func_080f9010(0x120);
    }
    if (*(s16 *)((u8 *)0x02000240 + 450) == 0) {

...
/*
 * resource_3bc owner at 0x02004628, 360 bytes (0x02004628-0x02003a5f):
 ...
 *   0x0200cfc0  even -> in-image DATA at file offset 0x4154, the direction
 *                table indexed below;
 ...
 * word from Data_0200cfc0: the high half is the x step and the low half,
 ...
 *    (`games/gs1/assets/code/resource_3bc_c_020038b0.c`) and takes a single argument;

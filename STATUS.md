...
|---|---:|---:|
| Compiled C | 1,047 | 54,668 |
| Reconstruction assembly | 2,124 | 493,768 |
...
Within the reconstruction assembly, 470,420 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,918,188 of
...
reconstruction assembly as unfinished C work. The remaining 470,420 bytes are
...
| Byte reconstruction | 7,918,188 / 8,388,608 bytes (94.39%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 54,668 / 525,088 identified executable bytes (10.41%) | Active executable work represented as exact C |

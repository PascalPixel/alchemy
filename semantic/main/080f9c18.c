 ...
 * in the second.  This one stores the operand biased by -64 as the signed track field at 0x0c and raises the two middle request bits.
 *
...
u8 Func_080f9ab4(struct Track_080f9c18 *track);

void Func_080f9c18(void *player, struct Track_080f9c18 *track)
{
    track->parameter_0c = (s8)(Func_080f9ab4(track) - 64);
    track->status |= 12;
}

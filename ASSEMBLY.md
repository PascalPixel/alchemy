...
The current boundary, after the eighth exact-C checkpoint and full IWRAM reconstruction, is:
...
| Likely ordinary compiler output | 1,396 | 460,504 | Convert to exact C |

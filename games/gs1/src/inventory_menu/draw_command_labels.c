...
void InventoryMenu_DrawCommandLabels(void *command_states, s32 window)
{
    ...
    Func_08015080(message, window, 0, 0x18);
    Func_080150b8(0xf);
    if (FIELD(command_states, s8 *, 1) == disabled)
        Func_080150b8(0xe);

    Func_08015080(message + 1, window, ITEM_TEXT_X, 0x18);
    Func_080150b8(0xf);
    if (FIELD(command_states, s8 *, 3) == disabled)
        Func_080150b8(0xe);

    Func_08015080(message + 2, window, 0, 0x20);
    Func_080150b8(0xf);
    if (FIELD(command_states, s8 *, 5) == disabled)
        Func_080150b8(0xe);

    Func_08015080(message + 3, window, 0x50, 0x20);
    Func_080150b8(0xf);
    if (FIELD(command_states, s8 *, 2) == disabled)
        Func_080150b8(0xe);

    Func_08015080(message + 4, window, 0x50, 0x18);
    Func_080150b8(0xf);
    if (FIELD(command_states, s8 *, 4) == disabled)
        Func_080150b8(0xe);

    Func_08015080(message + 5, window, ITEM_TEXT_X, 0x20);
    Func_080150b8(0xf);
}

...
extern struct Obj *Func_020060b8(s32 arg0);
...
extern s32 Func_020060e4(struct Obj *arg0, s32 *arg1);
extern void Func_020060ac(struct Obj *arg0, s32 arg1);
extern void Func_0200604c(s32 arg0);
extern void Func_02006312(s32 arg0);
extern void Func_020060f2(struct Obj *arg0, s32 arg1, s32 arg2, s32 arg3);
extern void Func_02006102(struct Obj *arg0, s32 arg1, s32 arg2, s32 arg3);
extern void Func_02006110(struct Obj *arg0);
extern void Func_02006334(void);
extern void Func_02006118(struct Obj *arg0, s32 arg1);
...
void Func_020000c4(void) {
    ...
    w <<= 16;
    buf[2] = b->u10.w + w;
    if (Func_020060e4(b, buf) > 0) return;
    ...
    b->field30 = c;
    b->field34 = c;
    Func_020060f2(b, buf[0], buf[1], buf[2]);
    a->field30 = c;
    a->field34 = c;
    Func_02006102(a, buf[0], buf[1], buf[2]);
    Func_02006110(b);
    Func_02006334();
    b->u08.w = buf[0];
    b->u10.w = buf[2];

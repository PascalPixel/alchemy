...
/*
 * Evidence summary (see games/tbs/recon/en/dossiers.json#main:0808e23c for the full
 * account):
 *
 ...
 *   (games/tbs/src/battle/party/). This owner primes the same table via an
 ...
 * registered in source-paths.json. The retained games/tbs/asm/0808e23c.s

...
s32 Func_02000940(void)
{
    ...
    *(s32 *)(record + 28) = 0x18000;
    ...
    if (Func_080770c0(0x87a) != 0) {
        { s32 f1 = 2; s32 g1 = 2; Func_08009180(97, 2, 80, 5,  f1, g1); }
        { s32 f2 = 3; s32 g2 = 1; Func_08009180(42, 53, 42, 54,  f2, g2); }
        Func_08009128();
        Func_080000c0(1);
        return 0;
    }
    ...
    if (Func_080770c0(0x834) != 0) {
        Func_0808a2c0();
        Func_0808a2c8();
        { s32 f3 = 18; s32 g3 = 41; Func_080091c0(21, 38, 1, 1,  f3, g3); }
        ...
        { s32 f4 = 2; s32 g4 = 2; Func_08009180(92, 2, 80, 5,  f4, g4); }
        { s32 f5 = 3; s32 g5 = 1; Func_08009180(42, 53, 42, 54,  f5, g5); }
        Func_08009128();
        Func_080000c0(1);
    }

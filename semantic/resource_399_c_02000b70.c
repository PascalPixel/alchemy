    ...
    *(s32 *)(*Data_03001ebc + 448) = 0x209;
    ...
    if (step == 1) {
        ...
        if (Func_080770c0(0x881) != 0) {
            { s32 f1 = 10; s32 g1 = 8; Func_080091c0(10, 7, 1, 1,  f1, g1); }
            { s32 f2 = 3; s32 g2 = 3; Func_08009180(3, 125, 9, 69,  f2, g2); }
            Func_08009128();
            Func_080000c0(1);
            Func_0808a098(8, 2);
        ...
        { s32 f3 = 10; s32 g3 = 8; Func_080091c0(10, 7, 1, 1,  f3, g3); }
        { s32 f4 = 3; s32 g4 = 3; Func_08009180(3, 125, 9, 69,  f4, g4); }
        Func_08009128();
        Func_080000c0(1);
    ...
    if (step == 4) {
        if (Func_080770c0(0x881) != 0) {
            ...
            record[89] |= 4;
            { s32 f5 = 3; s32 g5 = 3; Func_08009180(6, 125, 22, 88,  f5, g5); }
...
emit_pose:
    { s32 f6 = 3; s32 g6 = 3; Func_08009180(pose_sel, 125, pose_a, pose_b,  f6, g6); }
    return 0;

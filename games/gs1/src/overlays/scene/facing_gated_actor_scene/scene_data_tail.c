 ...
 *
 * Zero call sites (`cargo run --release --manifest-path tools/overlay-call-targets/Cargo.toml -- resource_378 0070`
 ...
 * games/gs1/asm/overlays/resource_378_c_02000030.c, which reads +8 and +0x10 of a record

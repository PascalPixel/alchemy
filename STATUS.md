...
|---|---:|---:|
| Compiled C | 1,025 | 51,946 |
| Reconstruction assembly | 2,146 | 496,490 |
...
Within the reconstruction assembly, 473,142 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,915,466 of
...
reconstruction assembly as unfinished C work. The remaining 473,142 bytes are
...
| Byte reconstruction | 7,915,466 / 8,388,608 bytes (94.36%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 51,946 / 525,088 identified executable bytes (9.89%) | Active executable work represented as exact C |

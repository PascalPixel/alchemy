 ...
 * veneer at image offset 4 (bun tools/overlay-driver resource_39c),
 ...
 * displacement + 2) with cargo run --release --manifest-path tools/overlay-call-targets/Cargo.toml --, never read off

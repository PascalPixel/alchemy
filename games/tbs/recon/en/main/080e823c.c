 ...
 * same family as the already drafted owner 0x080d41a4 (games/tbs/recon/en/main/
 ...
 * `_call_via_rN` trampoline block at games/tbs/asm/080072e4.s, so a `bl` there
 * is an indirect call through the DrawRectangleFn value carried in r4. That
 * finding is recorded in games/tbs/recon/en/dossiers.json#main:080dc1ec and is

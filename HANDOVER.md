...
- Semantic-C lane: **145,114 executable bytes across 370 compiling sources**:
  132,978 main bytes and 12,136 overlay bytes. Combined with exact C,
  **282,908 / 1,338,620 executable bytes** are now expressed as C, with
  1,055,712 remaining.

 ...
 * games/tbs/SRC/BATTLE/EFFECT/MEMBER_ORBIT.C (main:080ce85c) and the
 * measured drafts games/tbs/recon/en/main/080da6cc.c and
 * games/tbs/recon/en/main/080db264.c; the work-block layout (64 twenty-eight
 ...
 * slot of the _call_via_rN trampoline at games/tbs/asm/080072e4.s) are taken
 * from those owners.  The blitter pair comes from the exact
 * games/tbs/src/battle/effects/work/fetch_rectangle_blitters.c.
 *

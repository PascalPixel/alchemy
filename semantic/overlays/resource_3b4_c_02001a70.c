...
/*
 * resource_3b4 owner at 0x02001a70, 42 bytes.
 *
 * Sibling of 0x02001a48: the same collision repaint plus slot-8 marker, with a
 * different cell.  Func_080091c0 is (r0, r1, r2, r3, [sp,#0], [sp,#4]).
 */

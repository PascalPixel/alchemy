...
{
    Event_Begin();
    Actor_SetDestinationOffset(0, 0, 0);
    Actor_EnableActionCallback(0, 1);
    Actor_SetAnimation(0, 1);
    Actor_FaceActor(12, 0, 0);
    Audio_PlayCue(113);
...
void FieldScene_RunScene3bf_0200252c(void)
{
    ...
    Actor_SetSpeed(2, 0xb333, 0x5999);
    Actor_WalkTo(2, 0x1c8, 192);
    Actor_SetSpeed(3, 0xb333, 0x5999);
    Actor_WalkTo(3, 0x1b8, 184);
    Actor_SetSpeed(1, 0xb333, 0x5999);
    Actor_WalkTo(1, 0x1c0, 240);
    Actor_WaitForMove(2);
    Actor_FaceActor(2, 12, 0);
    Actor_WaitForMove(1);
    Actor_WaitForMove(3);
    Actor_FaceActor(1, 12, 0);
    Actor_FaceActor(3, 12, 0);
    Event_Wait(15);
}
...
void FieldScene_RunScene3bf_02002718(void)
{
    ...
    Actor_WalkTo(2, 0x1f8, 216);
    Actor_SetSpeed(3, 0x10000, 0x8000);
    Actor_WalkTo(3, 0x1b8, 232);
    Actor_SetSpeed(1, 0x10000, 0x8000);
    Actor_WalkTo(1, 0x1e0, 224);
    Actor_WaitForMove(1);
...
void PlayStoryScene(void)
{
    ...
    if (GameFlag_IsSet(2370) != 0) {
        ...
        Actor_ShowEmote(2, 258, 0);
        Actor_ShowEmote(1, 258, 0);
        Actor_ShowEmote(3, 258, 0);
...
void FieldScene_RunMainScriptSequence(void)
{
    ...
    Actor_SetPosition(0, 0x1c80000, 0xb80000);
    Actor_FaceDirection(0, 0x4000, 0);
    Actor_SetPosition(1, 0x1b80000, 0xc00000);
    Actor_FaceDirection(1, 0x4000, 0);
    Actor_SetPosition(3, 0x1e80000, 0xb80000);
    Actor_FaceDirection(3, 0x4000, 0);
    Actor_SetPosition(2, 0x1d80000, 0xb80000);
    ...
    Event_ShowMessage(1, 0);
    Actor_ShowEmote(0, 0x101, 1);
    Actor_ShowEmote(2, 0x101, 1);
    Actor_ShowEmote(3, 0x101, 1);
    Event_Wait(60);
    Actor_FaceActor(12, 13, 0);
    Event_Wait(60);
    ...
    Actor_WalkTo(1, 0x1a0, 216);
    Actor_WaitForMove(1);
    Actor_WalkTo(1, 0x1a0, 248);
    Actor_WaitForMove(1);
    Actor_WalkTo(1, 0x1b8, 248);
    Actor_WaitForMove(1);
    Actor_FaceDirection(1, 0xc000, 0);
    Actor_WalkTo(0, 0x1b8, 216);
    Actor_WaitForMove(0);
    Actor_FaceDirection(0, 0, 0);
    Actor_WalkTo(3, 0x1e8, 248);
    Actor_WaitForMove(3);
    Actor_WalkTo(3, 0x1c8, 248);
    Actor_WaitForMove(3);
    Actor_FaceDirection(3, 0xc000, 0);
    Actor_WalkTo(2, 0x1c8, 216);
    Actor_WaitForMove(2);
    ...
    Actor_SetDestinationOffset(0, -24, 0);
    Actor_SetSpeed(1, 0x1999, 0xccc);
    Actor_SetDestinationOffset(1, -24, 0);
    Actor_SetSpeed(3, 0x1999, 0xccc);
    Actor_SetDestinationOffset(3, -24, 0);
    Actor_SetSpeed(2, 0x1999, 0xccc);
    Actor_SetDestinationOffset(2, -24, 0);
    ...
    Actor_SetAnimation(3, 3);
    Event_Wait(100);
    Actor_SetSpeed(0, 0xb333, 0x5999);
    Actor_SetSpeed(1, 0xb333, 0x5999);
    Actor_SetSpeed(2, 0xb333, 0x5999);
    Actor_SetSpeed(3, 0xb333, 0x5999);
    Actor_WalkTo(0, 0x1c8, 184);
    Actor_WaitForMove(0);
    Actor_SetAnimation(0, 1);
    Actor_FaceDirection(0, 0x4000, 0);
    Actor_WalkTo(1, 0x1d0, 0x100);
    Actor_WaitForMove(1);
    Actor_WalkTo(1, 0x1e0, 248);
    Actor_WaitForMove(1);
    Actor_WalkTo(1, 0x1b8, 192);
    Actor_WaitForMove(1);
    Actor_SetAnimation(1, 1);
    Actor_FaceDirection(1, 0x4000, 0);
    Actor_WalkTo(3, 0x1e8, 248);
    Actor_WaitForMove(3);
    Actor_WalkTo(3, 0x1e8, 184);
    Actor_WalkTo(2, 0x1d8, 184);
    Actor_WaitForMove(2);
    Actor_SetAnimation(2, 1);
    Actor_FaceDirection(2, 0x4000, 0);
    Actor_WaitForMove(3);
    ...
    Event_ShowMessage(12, 0);
    Actor_ShowEmote(1, 0x107, 110);
    Actor_WalkTo(1, 0x1c8, 212);
    Actor_WaitForMove(1);
    Actor_SetAnimation(1, 1);
    ...
    Actor_FaceActor(1, 14, 0);
    Actor_FaceActor(3, 14, 0);
    Actor_FaceActor(2, 14, 0);
    ...
    Actor_WalkTo(0, 0x1c8, 248);
    Actor_WaitForMove(12);
    Actor_WalkTo(12, 0x1c8, 248);
    Actor_WaitForMove(0);
    Actor_WalkTo(0, 0x1c8, 0x168);
    Actor_WaitForMove(12);
    Actor_WalkTo(12, 0x1c8, 0x168);
    Actor_WaitForMove(0);
    Actor_WalkTo(0, 0x160, 0x168);
    Actor_WaitForMove(12);

...
extern u8 * Func_0200368e(s32);
extern void Func_020036e4(s32,s32,s32,s32,s32,s32);
...
s32 Func_020008c0(s32 slot)
{
    ...
    Func_020036e4(tileX, tileZ, width, depth, globalX, globalZ);

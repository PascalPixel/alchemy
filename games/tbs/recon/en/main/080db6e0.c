 ...
 * that name is kept in games/tbs/source-paths.json, but the working symbol
 ...
 *
 * Structural template: games/tbs/SRC/BATTLE/EFFECT/MEMBER_ORBIT.C
 ...
 * the mode from the caller's object at offset 24).  games/tbs/recon/en/
...
/* Ten halfword cell offsets indexed by a clamped depth bucket 0..9; the
   same symbol games/tbs/recon/en/main/080e7404.c already declares and

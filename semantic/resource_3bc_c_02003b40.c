 ...
 * cover it -- resolved with `bun tools/overlay-show resource_3bc 3b40 |
 * cargo run --release --manifest-path tools/overlay-call-targets/Cargo.toml -- resource_3bc 3b40 3b7e --annotate`):

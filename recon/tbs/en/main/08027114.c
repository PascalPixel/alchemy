 ...
 *
 * Evidence used, all from recon/tbs/raw/08027114.s and its literal pools:
 ...
 *     games/THE BROKEN SEAL/SRC/BATTLE/PRESENTATION/WAIT_SYNC.C and
 *     games/THE BROKEN SEAL/SRC/SYSTEM/LINK/UPDATE_SESSION_COUNTDOWN.C.

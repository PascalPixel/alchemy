...
s32 RunTwoPaneSelectionMenu(s32 pane) {
    ...
    if ((pane) == 0) {
        ...
        sp44 = 0;
        if ((pane) < (s32) FIELD(sp4C, u8 *, 0x219)) {
            var_r1 = sp1C;
            var_r2 = temp_r9 + 0xA0;
            do {
                var_r2 += 1;
    ...
    if ((pane) == 1) {
        ...
        Func_080ab1f4(FIELD(sp4C, void **, 0x30), temp_r6_2, Func_080022f4(temp_r6, 0xA) + 2, 6, (pane), 0xE);
        ...
        if (sp3C == -1) {
            ...
            if ((Func_08077210(temp_r6_4, temp_r5_5, temp_r7_2) != 0) || (Func_08077208(temp_r6_4, temp_r5_5, temp_r7_2) != 0)) {
                if (Func_08077210(temp_r6_4, temp_r5_5, temp_r7_2) != 0) {
                    Func_080ad608((pane), (s32) temp_r5_5, 1);
                } else {
                    Func_080ad608((pane), (s32) temp_r5_5, 2);
                }
                Func_080ad5b4((pane), ((sp18 - sp38) * 8) + 0x30, 0x36, 0);
            } else {
                Func_080ad608((pane), (s32) temp_r5_5, 1);
                Func_080ad5b4((pane), ((sp18 - sp38) * 8) + 0x30, 0x36, 1);
            }
            if (((u32) temp_r7 >> 1) != 0) {
                Func_080ad5f4((pane), 0);
            }
        } else {
            if (sp24 != 0) {
                if (sp20 == 0) {
                ...
                if ((Func_08077210(temp_r6_5, temp_r5_6, temp_r7_3) != 0) || (Func_08077208(temp_r6_5, temp_r5_6, temp_r7_3) != 0)) {
                    if (Func_08077210(temp_r6_5, temp_r5_6, temp_r7_3) != 0) {
                        Func_080ad608((pane), (s32) temp_r5_6, 1);
                    } else {
                        Func_080ad608((pane), (s32) temp_r5_6, 2);
                    }
                    Func_080ad5b4((pane), ((sp18 - sp38) * 8) + 0x30, 0x3E, 0);
                } else {
                    Func_08015080(0xB9E, (void *) FIELD(sp4C, s32 *, 0x10C), 0, 0x10);
                    Func_080ad608((pane), (s32) temp_r5_6, 1);
                    Func_080ad5b4((pane), ((sp18 - sp38) * 8) + 0x30, 0x3E, 1);
                }
                ...
                temp_r6_6 = 0x1F & sp28;
                var_r4 = 0xB9A;
                if ((Func_08077210(temp_r5_7, ((u32) (0xE0 & sp28) >> 5), temp_r6_6) != 0) || (var_r4 = sp8, (Func_08077208(temp_r5_7, ((u32) (0xE0 & sp28) >> 5), temp_r6_6) != 0))) {
                    sp8 = var_r4;
                    if (Func_08077210(temp_r5_7, ((u32) (0xE0 & sp28) >> 5), temp_r6_6) != 0) {
                        Func_08015080(var_r4 + 3, (void *) FIELD(sp4C, s32 *, 0x10C), 0, 0x10);
                        Func_080ad608(0, (s32) ((u32) (0xE0 & sp28) >> 5), 1);
                    } else {
                        Func_08015080(var_r4 + 2, (void *) FIELD(sp4C, s32 *, 0x10C), 0, 0x10);
                        Func_080ad608(0, (s32) ((u32) (0xE0 & sp28) >> 5), 2);
                    }
                    Func_080ad5b4((pane), ((sp18 - sp38) * 8) + 0x30, 0x3E, 0);
                } else {
                                    ...
                                    if (var_r8 != 0) {
                                        if (sp20 != 0) {
                                            if ((temp_r7_6 >> 0xF) == 0) {
                                                ...
                                                spC = temp_r3_6;
                                                Func_080771b0(((u32) (temp_r7_6 & 0xF00) >> 8), temp_r6_11, temp_r3_6);
                                                Func_080771c0(((u32) (temp_r7_6 & 0xF00) >> 8), temp_r6_11, temp_r3_6);
                                                Func_08077010(((u32) (temp_r7_6 & 0xF00) >> 8));
                                            }
                                        } else if ((temp_r7_6 >> 0xF) != 0) {
                                            temp_r5_14 = (u32) (temp_r7_6 & 0xF00) >> 8;
                                            temp_r6_12 = (u32) (temp_r7_6 & 0xE0) >> 5;
                                            spC = (0x1F & temp_r7_6);
                                            Func_080771b8(temp_r5_14, temp_r6_12, (0x1F & temp_r7_6));
                                            Func_080771c8(temp_r5_14, temp_r6_12, (0x1F & temp_r7_6));
...
block_236:
    ...
    FIELD(sp4C, s8 *, (pane) + 0x1C) = (s8)sp38;
    if (sp3C != -1) {
        temp_r2_5 = FIELD(
            temp_r9,
            u16 *,

...
/*
 * Resource 3cb sound-cue step at 0x020011bc (108 bytes, 0x020011bc-0x02001227).
 *
 * Complete owner: its own `push {r5, lr}` prologue at 0x020011bc and the
 * matching interworking return `pop {r5} / pop {r1} / bx r1` at 0x0200121a.
 ...
 * Func_08015018 call.  The eight bytes at 0x02001220-0x02001227 are this
 * owner's literal pool (the two cue ids 0x292a and 0x292b, loaded by the two
 * `ldr r0, [pc, ...]` sites); they are data, not the `cmp r1, #42` /
 * `cmp r1, #43` pairs the disassembler prints.
 *
 ...
 *
 * Near-identical sibling: Func_02001228 is byte-identical to this owner apart
 * from its two pool words (0x292c/0x292d).
 */

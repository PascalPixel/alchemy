...
- Semantic-C lane: **186,426 executable bytes across 425 compiling sources**:
  174,418 main bytes and 12,008 overlay bytes. Combined with exact C,
  **330,548 / 1,338,908 executable bytes** are now expressed as C, with
  1,008,360 remaining.

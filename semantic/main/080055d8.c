 ...
 * stack VLA, the DMA `stmia` fills that VLA with 0xd0 bytes copied from
 * 0x080020f4, and the `bl 0x8007318` then runs the copied bytes.  sp is
 * word-aligned, so the branch enters ARM state; 0x080020f4 disassembles as
 * coherent ARM.
 *
 ...
 */
typedef void (*StackKernel_080055d8)(void *, void *, void *, void *);
extern char Value_000000d0;
extern char Data_080020f4;

void Func_080055d8(void *a, void *b, void *c, void *d)
{
    u32 words = (u32)&Value_000000d0 >> 2;
    {
        u32 buffer[words];
        u32 *dma = (u32 *)0x040000d4;
        u32 source = (u32)&Data_080020f4;
        ...
        ((StackKernel_080055d8)(void *)buffer)(a, b, c, d);
    }
}

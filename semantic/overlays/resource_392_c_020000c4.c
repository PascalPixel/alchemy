...
/*
 * resource_392 owner at 0x020000c4, 384 bytes: "push the object in front of
 ...
 *  - the direction table pool word 0x0200e190 becomes 0x02008ec8 here
 *    (file offset 0x0ec8 under the proven 0x02008000 link base);
 *  - every call was re-resolved with 'bun tools/overlay_call_targets.ts
 *    resource_392 00c4', which reports the same 13 sites in the same order:
...
#define PUSH_DIRECTION_STEPS ((const s32 *)0x02008ec8)

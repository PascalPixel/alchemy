/*
 * resource_3b4 @ 0x02000608, complete 696-byte owner through the seven-word
 * pool at 0x020008a4-0x020008bf.  The reviewed control-flow skeleton is shared
 * with resource_373/resource_3bf, but this overlay's tables were independently

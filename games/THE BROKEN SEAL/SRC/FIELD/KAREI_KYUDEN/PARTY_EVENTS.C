...
void RunEventScript01(void)
{
    ...
    *(s32 *)(work + 0x1c0) = 0x201;
    ...
    Actor_SetPosition(0, 0x3580000, 0x1e60000);
    Actor_SetPosition(1, 0x3500000, 0x1f60000);
    Actor_SetPosition(2, 0x3680000, 0x1e60000);
    Actor_SetPosition(3, 0x3700000, 0x1f60000);
    ...
    Actor_RunRepeatedMotion(11, 2);
    Event_ShowMessageAndWait(11, 0, 10);
    Actor_FaceDirection(2, 0x2000, 10);
    ...
    Actor_WalkToAndWait(2, 0x364, 0x1d8);
    Event_ShowMessageAndWait(0x2002, 0, 10);
    Actor_SetAnimationAndWait(8, 4);
    Event_ShowMessageAndWait(8, 0, 10);
...
void Scene_RunPartySequence(void)
{
    ...
    Map_Redraw();
    Task_Wait(1);
    Actor_SetPosition(0, 0x3600000, 0x2760000);
    ...
    *(s32 *)(*(u8 **)Data_03001ebc + 0x1c8) = 40;
    ...
    Actor_WalkToAndWait(0, 0x360, 0x1f2);
    ...
    Actor_WalkTo(0, 0x358, 0x1e6);
    Actor_WalkTo(1, 0x350, 0x1f6);
    Actor_WalkTo(2, 0x368, 0x1e6);
    Actor_WalkToAndWait(3, 0x370, 0x1f6);

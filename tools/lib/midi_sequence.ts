...
//
// 使い方:  bun tools/lib/midi_sequence.ts convert-all      # 旧 JSON から .mid+サイドカー生成
//          bun tools/lib/midi_sequence.ts validate-all      # 追跡中の .mid+サイドカーを検証
//          bun tools/lib/midi_sequence.ts --self-test

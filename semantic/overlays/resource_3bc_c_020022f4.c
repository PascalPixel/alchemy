...
/*
 * resource_3bc owner at 0x020022f4, 58 bytes: a sibling of
 ...
 * cover it -- resolved with `bun tools/overlay_show.ts resource_3bc 22f4 |
 * bun tools/overlay_call_targets.ts resource_3bc 22f4 232e --annotate`):

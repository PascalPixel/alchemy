...
![Treemap of the English Golden Sun ROM: the left card divides all 8,388,608 cartridge bytes into main-image code, compressed code overlays and asset data; the right card divides the audited executable bytes into the main image and its decoded overlays. Tiles are shaded blue for byte-exact C, teal for reviewed semantic C, grey for regions still held as assembly and pink for non-code asset data.](assets/readme/gs1-en-coverage.svg?v=10b62c94)

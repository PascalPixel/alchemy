//! Build the audited sound records outside ordinary MIDI sources.
//!
...
//! emission is shared by this crate's sequence builder.

use crate::{build_reserve_sequence, Result};
use std::path::Path;

const ORPHAN_STREAM_ADDRESS: u32 = 0x0818_19b0;
const ALIGNMENT_ADDRESS: u32 = 0x0818_4698;
const ALIGNMENT_END: u32 = 0x0818_5000;
...
mod tests {
    ...
    #[test]
    fn reserve_stream_and_tail_are_stable() {
        ...
        assert_eq!(ALIGNMENT_END - ALIGNMENT_ADDRESS, 0x968);
    }
}

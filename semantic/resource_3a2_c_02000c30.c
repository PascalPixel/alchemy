 ...
 * consistent: `cargo run --release --manifest-path tools/overlay-call-targets/Cargo.toml -- resource_3a2` reports the
 ...
 *
 * Call sites resolved with `cargo run --release --manifest-path tools/overlay-call-targets/Cargo.toml -- resource_3a2 0c30`

 ...
 * UI-text-work cells used by games/THE BROKEN SEAL/src/menu/sel/select_quantity.c and
 * games/THE BROKEN SEAL/src/ui/text/work/prepare_message_work.c: reused per-mode scratch

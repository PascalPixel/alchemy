...
/*
 * resource_393 owner at 0x0200034c, 296 bytes: code through the value-returning
 ...
 * located at 0x02008f50, 0x02008f68 and 0x02008f10 in this overlay.
 *
...
{
    const s32 *types = (const s32 *)0x02008f50;
    const s32 (*rectangles)[4] = (const s32 (*)[4])0x02008f68;
    const s32 *steps = (const s32 *)0x02008f10;
    u8 **slots = (u8 **)(RESOURCE_393_SCENE + 0x34);

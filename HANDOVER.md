...
- Semantic-C lane: **174,710 executable bytes across 393 compiling sources**:
  162,702 main bytes and 12,008 overlay bytes. Combined with exact C,
  **315,782 / 1,338,820 executable bytes** are now expressed as C, with
  1,023,038 remaining.

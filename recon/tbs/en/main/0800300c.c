 ...
 *     straight from the literal pool in recon/tbs/raw/0800300c.s.
 *   - The first DMA (source 0x08000770 -> dest 0x03000000, control
 *     0x84000500 = enabled|32-bit|0x500 words = 5120 bytes) matches the
 *     5120-byte IWRAM runtime payload maintained as
 *     games/THE BROKEN SEAL/SRC/SYSTEM/IWRAM/RUNTIME.S.
 ...
 *     recon/tbs/raw/executable_gaps/index.json (14 handler pointers,

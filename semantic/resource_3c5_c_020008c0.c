...
extern u8 * Func_02003722(s32);
extern void Func_02003770(s32,s32,s32,s32,s32,s32);
...
s32 Func_020008c0(s32 slot)
{
    ...
    Func_02003770(tileX, tileZ, width, depth, globalX, globalZ);

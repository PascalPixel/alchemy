...
The current boundary, after the thirteenth exact-C checkpoint and full IWRAM reconstruction, is:
...
| Likely ordinary compiler output | 1,360 | 458,038 | Convert to exact C |

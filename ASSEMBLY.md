...
The current boundary, after the fourteenth exact-C checkpoint and full IWRAM reconstruction, is:
...
| Likely ordinary compiler output | 1,358 | 457,804 | Convert to exact C |

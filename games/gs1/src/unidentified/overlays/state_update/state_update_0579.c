...
s32 Func_02000eea(struct PlacementResult_02000a68 *result);
void Func_02001096(struct PlacementResult_02000a68 result);
...
void Func_02000a68(void)
{
    ...
    if (Func_02000eea(&result)) {
        Func_02001096(result);

...
extern const u8 Data_02009782[];
extern struct Actor_02000b40 *Func_0808a080(s32 actor);
...
void Func_02000b40(void)
{
    struct Actor_02000b40 *actor;

    actor = Func_0808a080(0);
    Func_080f9010(158);
    Func_08009178(Data_02009782, 54, 13);
    Func_080091c0(33, 20, 1, 3, 23, 12);
    actor->control_flags &= (u8)~1;
    actor->presentation[9] |= 12;
    Func_02000a80(376, 224, 8);
}

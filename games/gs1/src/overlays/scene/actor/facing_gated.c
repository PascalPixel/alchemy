...
void Scene_RunScriptedSceneSequence(void)
{
    ...
    if (GameFlag_IsSet(0x201) != 0) {
        Object_LinkPair(0, 8, 0);
        Motion_SetAngleToward(1, 0, 0);
        Motion_SetAngleToward(0xb, 0, 0);
        Motion_SetAngleToward(0xc, 0, 0);
        Motion_SetAngleToward(9, 0, 0);
        Motion_SetAngleToward(0xa, 0, 0);
        Motion_CamBounds(0xc00000, -1, 0xa00000, 1);
    ...
    BattleFx_ApplyColorToTargetBuffer(0x10002, 0);
    ...
    BattleFx_StartBufferInterpolation(0x3c);
    Actor_unk94_4(0x64);
    Object_SetModeById(0, 1);
    Object_SetModeById(1, 1);
    Actor_unk94_4(0x1e);
    Motion_SetAngleToward(0, 0xc, 0);
    Motion_SetAngleToward(1, 0xc, 0);
    Actor_unk94_4(0x14);
    Motion_EnableActCb(8, 1);
    Motion_EnableActCb(0xc, 1);
    ...
    Actor_unk94_4(0x1e);
    Motion_SetVarCbAndRefresh(0xc, 2);
    Event_SetValue1d8(0x1138);
    BattleEv_RunWait(0xc, 0);
    Actor_unk94_4(0xa);
    Object_SetModeById(0, 3);
    Motion_SetModeAndWaitAnimation(1, 3);
    Actor_unk94_4(0x1e);
    Motion_SetModeAndWaitAnimation(0xc, 3);
    Actor_unk94_4(0x14);
    Motion_SetVarCbAndRefresh(0xb, 2);
    Actor_unk94_4(0x14);
    Motion_SetAngleToward(0, 0xb, 0);
    Motion_SetAngleToward(1, 0xb, 0);
    Actor_unk94_4(0x14);
    Battle_RunEvWait(0xb, 0);
    /* Each arm advances once, on its own side of the object-state call. */
    if (Actor_unk29(0, 0) == 0) {
        Actor_unk94_4(0x14);
        Motion_SetModeAndWaitAnimation(0xb, 3);
        Actor_unk94_4(0x14);
        BattleEv_RunWait(0xb, 0);
        SKIP_BEATS++;
    } else {
        Actor_unk94_4(0x14);
        Motion_SetModeAndWaitAnimation(0xb, 4);
        Actor_unk94_4(0x14);
        SKIP_BEATS++;
        BattleEv_RunWait(0xb, 0);
    }
    Actor_unk94_4(0x14);
    Motion_SetVarCbAndRefresh(9, 1);
    Actor_unk94_4(0x14);
    Motion_SetAngleToward(0, 9, 0);
    Motion_SetAngleToward(1, 9, 0);
    Motion_SetAngleToward(0xb, 9, 0);
    Actor_unk94_4(0x14);
    Battle_RunEvWait(9, 0);
    if (Actor_unk29(0, 0) == 0) {
        Actor_unk94_4(0x14);
        Motion_SetModeAndWaitAnimation(9, 3);
        Actor_unk94_4(0x14);
        BattleEv_RunWait(9, 0);
        SKIP_BEATS++;
    } else {
        Actor_unk94_4(0x14);
    ...
    Object_SetModeById(0xb, 3);
    Object_SetModeById(0xc, 3);
    Object_SetModeById(9, 3);
    Motion_SetModeAndWaitAnimation(0xa, 3);
    Actor_unk94_4(0x1e);
    Actor_Far3(0xc, 0x101, 0);
    Actor_unk94_4(0x3c);
    Motion_SetAngleToward(0xc, 8, 0);
    Actor_unk94_4(0x14);
    Actor_unk103_4(0xc, 0xe0, 0x78);
    Actor_unk94_4(0xa);
    BattleEv_RunWait(0xc, 0);
    Actor_unk94_4(0x14);
    Motion_SetAngleToward(0, 8, 0);
    Motion_SetAngleToward(1, 8, 0);
    Motion_SetAngleToward(0xb, 8, 0);
    Motion_SetAngleToward(9, 8, 0);
    Motion_SetAngleToward(0xa, 8, 0);
    Actor_unk94_4(0xa);
    Motion_SetVarCbAndRefresh(0xb, 1);
    Actor_unk94_4(0xa);
    BattleEv_RunWait(0xb, 0);
    Actor_unk94_4(0x1e);
    Motion_SetVarCbAndRefresh(8, 3);
    Actor_Far3(8, 0x100, 0);
    Actor_unk94_4(0x3c);
    Motion_SetAngleToward(8, 0xc, 0);
    Actor_unk94_4(0x14);
    Motion_SetModeAndWaitAnimation(8, 3);
    Actor_unk94_4(0xa);
    BattleEv_RunWait(8, 0);
    Actor_unk94_4(0x14);
    ...
    Motion_SetVarCb(0, 1);
    Motion_SetVarCb(1, 1);
    Motion_SetVarCb(0xb, 1);
    Motion_SetVarCb(9, 1);
    Motion_SetVarCbAndRefresh(0xa, 1);
    Actor_unk94_4(0xa);
    ...
    ObjectGroup_ConfigureChildValue(8, 0x100);
    Actor_unk106_4();
    Audio_PlayCue(0xc4);
    ...
    Actor_unk94_4(0x60);
    Actor_unk94_4(0x20);
    ObjectGroup_ConfigureChildValue(8, 0);
    Actor_unk94_4(0x1e);
    State_ResetObject14Word108();
    Object_SetModeById(8, 1);
    Motion_SetVarCbAndRefresh(8, 2);
    Actor_unk94_4(0x14);
    BattleEv_RunWait(8, 0);
    Actor_unk94_4(0x14);
    ...
    Motion_SetVarCbAndRefresh(0xa, 1);
    Actor_unk94_4(0x14);
    BattleEv_RunWait(0xa, 0);
    Actor_unk94_4(0x14);
    Object_LinkPair(0, 1, 0);
    Actor_unk94_4(0x3c);
    Motion_SetModeAndWaitAnimation(8, 4);
    Actor_unk94_4(0x14);
    Motion_SetAngleToward(0, 8, 0);
    ...
    Object_SetModeById(0, 3);
    Object_SetModeById(1, 3);
    Object_LinkPair(9, 0xa, 0);
    Actor_unk94_4(0x14);
    Object_SetModeById(9, 3);
    Object_SetModeById(0xa, 3);
    Motion_WaitForAnimationChange(0xa);
    Actor_unk94_4(0x1e);
    Object_LinkPair(0, 0xb, 0);
    Object_LinkPair(1, 0xc, 0);
    Actor_unk94_4(0x14);
    Object_SetModeById(0, 3);
    Object_SetModeById(0xb, 3);
    Object_SetModeById(1, 3);
    Object_SetModeById(0xc, 3);
    Motion_WaitForAnimationChange(0xc);
    Actor_unk94_4(0x3c);
    Motion_SetVarCbAndRefresh(8, 2);
    Object_SetModeById(8, 0);
    ObjectGroup_ConfigureChildValue(8, 0x100);
    ...
    Motion_SetVarCb(1, 1);
    Motion_SetVarCb(0xb, 1);
    Motion_SetVarCb(0xc, 1);
    Motion_SetVarCb(9, 1);
    Motion_SetVarCb(0xa, 1);
    for (i = 0; i < 6; i++) {
        Actor_unk108_4(8, 0x1200);
        Actor_unk94_4(8);
    }
    ...
    Motion_WaitForAnimationChange(0xa);
    Actor_unk94_4(0x14);
    Motion_SetVarCbAndRefresh(0xc, 1);
    Actor_unk94_4(0x14);
    BattleEv_RunWait(0xc, 0);
    Actor_unk94_4(0x14);
    Motion_SetAngleToward(8, 0xc, 0);
    ...
    Actor_Far4(0xa, 0x102);
    Actor_unk94_4(0x3c);
    Motion_SetModeAndWaitAnimation(0xc, 4);
    Actor_unk94_4(0x14);
    BattleEv_RunWait(0xc, 0);
    Actor_unk94_4(0x14);
    Motion_SetVarCbAndRefresh(8, 1);
    ...
    Actor_unk94_4(0x1e);
dialogue:
    Event_SetValue1d8(0x1162);
    Motion_SetVarCbAndRefresh(8, 1);
    Actor_unk94_4(0x14);
    Battle_RunEvWait(8, 0);
    if (Actor_unk29(0, 0) == 0) {
        Scene_RunActorUpdateSequence();
        BattleFx_ApplyColorToTargetBuffer(0, 0);
        BattleFx_StartBufferInterpolation(0x78);
        Actor_unk94_4(0x78);
        Audio_PlayCue(0x56);

...
/*
 * resource_3ab owner at 0x0200013c, 472 bytes: the overlay's general
 * "spawn and fully configure" routine -- the same spawn-then-owner-record
 * shape resource_3ab_c_02000048.c/02005158.c/02005388.c already document,
 ...
 * 0x02009be0 and `idx = flags & 0xf` -- the low nibble of the `flags`
 ...
 * clear-two-bits-then-copy idiom resource_3ab_c_02000048.c's adopted
 * Func_02005a2e pair and resource_3ab_c_02005158.c already use on this
...
extern struct Descriptor *Data_02009be0[];

struct Effect *Func_02001b5e();
struct Effect *Func_02001afc();
void Func_02001b06();
void Func_02001b20();
void Func_02001c82();
s32 Func_02001b94();
                   ...
                   const struct Options *options)
{
    ...
    s32 first_delta;
    s32 accumulated;
    party = Func_02001b5e(0);

    if ((flags & 0x100000) != 0 && options != 0) {
        effect = Func_02001afc(options->kind, x, y, z);
    } else {
    ...
    Func_02001b06(effect, (flags + 1) & 15);
    ...
    if ((flags & 0x10000) != 0) {
        Func_02001c82(effect, options->mode);
    }
    ...
    if ((flags & 0x40000) != 0) {
        ...
        if ((flags & 0x80000) != 0) {
            ...
            effect->rate30 = Func_02001bac(first_delta,
                                           descriptor->duration);
            delta = options->target34;
            duration = descriptor->duration;
        ...
        effect->rate34 = Func_02001bba(delta, duration);
    }

    if ((flags & 0x200000) != 0) {
        Func_02001c20(effect, 1);
        Func_02001c30(effect, options->callback_arg);
    }

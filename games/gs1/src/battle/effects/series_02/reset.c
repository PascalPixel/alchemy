...
extern BattleEffect02Context *Data_03001f30;
extern s32 Data_02000240[];

#define ResetBattleEffect02 Func_080984c0
void ResetBattleEffect02(void)
{
    BattleEffect02Context **globalSlot = &Data_03001f30;
    BattleEffect02Context *context = *globalSlot;
    BattleEffect02Scene *scene = *(BattleEffect02Scene **)((u8 *)globalSlot - 0x64);
    BattleEffect02State *state = *(BattleEffect02State **)((u8 *)globalSlot - 0x74);
    s16 clearedValue;
    s32 resourceSize;
    void *resource;

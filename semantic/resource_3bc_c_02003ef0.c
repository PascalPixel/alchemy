...
/*
 * resource_3bc owner at 0x02003ef0, 480 bytes.  The owner opens with the
 * r5-r8 save, contains a branch-skipped literal run at 0x02004042-0x0200405f,
 * and ends at the sole unwind return at 0x020040c4-0x020040cf.  The next
 * semantic owner starts at 0x020040d0, so there is no trailing pool.
 *
 ...
 * source/machine order.  The halfwords at 0x0200405c are an unreachable BL
...
#define STATE_3BC ((u8 *)0x02001000)
#define WORKSPACE_3BC (*(u8 *volatile *)0x03001f3c)

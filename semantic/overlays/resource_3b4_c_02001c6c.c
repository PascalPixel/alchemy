...
/*
 * resource_3b4 owner at 0x02001c6c, 50 bytes.
 *
 * Two collision repaints through Func_080091c0.  r5 holds the constant 55 that
 * both calls store at [sp,#4]; it is callee-saved by the `push {r5, lr}`
 * prologue and the epilogue is `add sp,#8 / pop {r5} / pop {r0} / bx r0`, so
 * the owner is void.
 */
...
{
    Func_080091c0(38, 56, 1, 1, 38, 55);
    Func_080091c0(42, 56, 1, 1, 42, 55);
}

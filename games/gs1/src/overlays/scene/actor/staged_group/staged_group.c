...
#define Dialogue_RunActorTwentyThreeByLeaderHeading Func_020003d8
#define Actor_SetActorZeroByte35Bit0 Func_020015e0
struct Obj {
    u8 filler00[6];
    u16 f06;
};
...
#undef Dialogue_RunActorTwentyThreeByLeaderHeading
#undef Actor_SetActorZeroByte35Bit0

/* overlays/scene/actor/staged_group/actor_search.c */
#define Actor_FindAtTileXZ Func_02003184
...
#define Effect_UpdateRandomAction Func_02000040
#define Effect_SetSlotVariantAndDescriptor Func_02001ea4
...
#undef SampleEffectAction
#undef SampleEffectOffset
#undef SampleEffectTimer
#undef RunEffectAction3
#undef RunEffectAction4
#undef Effect_UpdateRandomAction
#undef Effect_SetSlotVariantAndDescriptor

/* overlays/scene/actor/staged_group/facing_target_scene.c */
#define State_BranchOnSlotZeroFacing Func_02000394
#define Scene_RunActorTwentyFourAngleDialogue Func_02000420
struct Obj {
    u8 filler00[6];
    u16 f06;
};
...
#undef State_BranchOnSlotZeroFacing
#undef Scene_RunActorTwentyFourAngleDialogue
...
#define Effect_UpdateLobeOrbitEffect26 Func_0200390c
#define Effect_UpdateOrbitingEffect Func_020039d4
...
#undef Effect_UpdateLobeOrbitEffect26
#undef Effect_UpdateOrbitingEffect
#undef InitializeOrbitingRenderEffect

/* overlays/scene/actor/staged_group/overlay_object.c */
#define OvObj_AdvanceXWhenCounterExpires Func_020000ac
struct Object {
    u8 filler00[6];
    u16 x;
    u8 filler08[94];
...
#undef OvObj_AdvanceXWhenCounterExpires
...
#define Scene_RunStagedGroupSequence Func_02000590
...
#undef Scene_RunStagedGroupSequence
#undef Func_02003c74
#undef Func_02003c2c
#undef Func_02003ce4
#undef Func_02003cfc
...
#undef SceneData_GetTablec6b8
#undef SceneData_SelectTableByWord224B
#undef SceneData_SelectTableBySelector224

/* overlays/scene/actor/staged_group/scene_dialogue.c */
#define Dialogue_RunActorNineteenDialogue Func_020002c8
#define Dialogue_RunActorTenDialogue Func_02000374
#define Dialogue_RunActor181Line916 Func_02001610
extern u8 Data_0200b90d[];

void Func_02003ec0(void);
void Func_02003f8e(s32);
s32 Func_02003fb6_a(s32, s32);
...
#undef Dialogue_RunActorTenDialogue
#undef Dialogue_RunActor181Line916

/* overlays/scene/actor/staged_group/scene_motion.c */
#define Effect_UpdateMotionWithDamping Func_020036f8
struct Obj {
    u8 filler00[8];
    s32 f08;
    s32 f0c;
...
#define Scene_DispatchBySceneId Func_0200164c
#define Scene_RunMiddleSequence Func_02001930
#define Scene_RunTwoActorCutsceneSequence Func_02002008
#define Scene_RunLateSequence Func_020031b8
#define Scene_RunSupplementalSequenceOne Func_02003768
            ...
            if (*(s16 *)(rec7 + 10) <= 245) {
                if ((*(volatile s32 *)0x03001e40 & 1) == 0) {
                    if (Value1(Func_020073a4, 0x202) == 0) {
                        Call1_02003768(Func_02007540_a, -1);
                        Func_0200755e(230);
...
#undef BattleEventRuntime_ProcessAction_2
#undef Battle_WaitMode0_15
#undef Motion_SetVarCbObj_12
#undef Battle_RunThenWaitIfModeZero_20
...
#undef Scene_RunSecondaryGroupSequence

/* overlays/scene/actor/staged_group/scene_setup.c */
#define Scene_RunStepWithValue29df Func_020001e4
#define Scene_RunStepWithValueFd6 Func_0200020c
#define Scene_RunSlotZeroFacingSequence Func_020002e8
#define RunSceneArrivalSetup Func_02000504
#define Scene_DrawTilesAndRaiseActor11 Func_02003970
struct Obj {
    u8 filler00[6];
    u16 f06;
};
...
#undef Scene_RunStepWithValue29df
#undef Scene_RunStepWithValueFd6
#undef Scene_RunSlotZeroFacingSequence
#undef RunSceneArrivalSetup
#undef Scene_DrawTilesAndRaiseActor11

/* overlays/scene/actor/staged_group/scene_state_interaction.c */
#define State_LinkRecordZeroWhenFlag200Clear Func_020015b4
extern u8 Data_03001ebc[];
...
void State_LinkRecordZeroWhenFlag200Clear(void)
{
    ...
    if (Value1(Func_02005190, 0x200) == 0) {
        ...
        rec = Value1(Func_020051e6, 0);
        *(volatile s32 *)((s32)work + 24) = rec;
        Call1(Func_020051b0, 0x200);
    }
}
#undef State_LinkRecordZeroWhenFlag200Clear

/* overlays/scene/actor/staged_group/state_update.c */
#define NULL ((void *)0)
#define FIELD_AT_OFFSET(base, type, offset)     (*(type)((u8 *)(base) + (offset)))
#define State_ApplyValues12And2And3 Func_02000030
#define State_ClearWord24WhenFlag200 Func_0200158c
#define State_ClearRecordZeroBit0At35 Func_020015f8
#define State_CheckFlags941And940 Func_020017e8
#define State_ApplyFlagGatedActorEightSetup Func_02001858
#define State_SetWork448AndRunFlag915Step Func_020018a4
#define State_SetValues27Through34 Func_02001e6c
...
#undef State_ApplyValues12And2And3
#undef State_ClearWord24WhenFlag200
#undef State_ClearRecordZeroBit0At35
#undef State_CheckFlags941And940
#undef State_ApplyFlagGatedActorEightSetup
#undef State_SetWork448AndRunFlag915Step
#undef State_SetValues27Through34

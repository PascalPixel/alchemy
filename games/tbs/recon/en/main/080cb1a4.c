 ...
 * (template-main-080ce85c, games/tbs/SRC/BATTLE/EFFECT/MEMBER_ORBIT.C),
 * but the real callee set and constants match the 0x03001eec "battle work"
 * subsystem documented there and in games/tbs/src/battle/effects/puff_arc/
 * run.c and games/tbs/recon/en/main/080e01e4.c: same Func_080cd594(mode) /
 ...
 * games/tbs/src/battle/motion/set_approach_motion.c uses, but inlined here

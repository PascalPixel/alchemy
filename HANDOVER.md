...
- Semantic-C lane: **218,330 executable bytes across 479 compiling sources**:
  205,538 main bytes and 12,792 overlay bytes. Combined with exact C,
  **365,944 / 1,339,230 executable bytes** are now expressed as C, with
  973,286 remaining.

...
- Semantic-C lane: **99,508 executable bytes across 310 compiling sources**:
  87,268 main bytes and 12,240 overlay bytes. Combined with exact C,
  **236,496 / 1,338,618 executable bytes** are now expressed as C, with
  1,102,122 remaining.

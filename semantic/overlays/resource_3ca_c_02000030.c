...
/*
 * resource_3ca owner at 0x02000030, 8 bytes: `ldr r0, [pc, #0] / bx lr`
 * plus the one-word literal pool at 0x02000034 holding 0x20096c8.
 *
 ...
 *
 * The pool word 0x20096c8 is an ADDRESS, loaded and returned WITHOUT being

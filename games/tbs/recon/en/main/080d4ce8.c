 ...
 * explains.  See games/tbs/recon/en/dossiers.json#main:080d5094 for the full
 * boundary evidence.
 *
 * Literal-pool constants for the Fragment_080d5094 half were resolved by
 * assembling games/tbs/asm/080d5094.s standalone with arm-none-eabi-as at
 ...
 * (games/tbs/SRC/BATTLE/EFFECT/MEMBER_ORBIT.C) and by Func_080d9fc8
 * (games/tbs/SRC/BATTLE/EFFECT/PUFF_ARC.C) for the Func_080e0524
...
extern void *Data_03001e50[]; /* heap-allocation cache: Data_03001e50[kind] holds kind's
                                  block address (see games/tbs/recon/en/main/080cc5d8.c and
...
/* 1024-entry, 28-byte particle table.  See file header: resolved via
   arm-none-eabi-as + objdump against games/tbs/asm/080d5094.s. */
...
/* work + 0x7080: four fixed anchor records, same 28-byte stride as the
   global particle table (matches games/tbs/src/battle/effects/puff_arc's
        ...
        if (frame <= 63) {
            if (Data_080ee29a[efx->layers] != 0) {
                ...
                /* Real value read straight off the asm immediates at
                   games/tbs/asm/080d4ce8.s lines 245-259: movs r2,#221;
                   ...
                   objdump'ing out/tbs-en/asm/080d4ce8.o

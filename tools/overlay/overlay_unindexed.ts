...
//
//   bun tools/overlay/overlay_unindexed.ts                    # every overlay, ranked
//   bun tools/overlay/overlay_unindexed.ts resource_3b1       # one overlay, with call counts
//   bun tools/overlay/overlay_unindexed.ts --json
//   bun tools/overlay/overlay_unindexed.ts --self-test
import { readFileSync, readdirSync } from "node:fs";
import { dirname, join } from "node:path";
import { overlayImage, targetOffset } from "../lib/overlay_call_targets.ts";

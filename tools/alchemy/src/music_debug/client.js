// Optional music debugger; playback remains an approximation.
...
function musicPlayer() {
  ...
  const card = h("section", { className: "music-player", "aria-label": "Music", "aria-busy": "true" },
    h("header", { className: "music-titlebar" }, h("span", {}, "Music debugger · approximate playback"), count),
    list,
...
document.title = "Alchemy music debugger — playback is approximate";
root.replaceChildren(h("main", {className:"cards"}, musicPlayer()));

...
//
//   bun tools/lib/exact_reading_list.ts                  # every overlay, ranked
//   bun tools/lib/exact_reading_list.ts resource_373     # one overlay
//   bun tools/lib/exact_reading_list.ts --json
//   bun tools/lib/exact_reading_list.ts --blocked        # only the rows held back
//   bun tools/lib/exact_reading_list.ts --self-test
//
...
import { isConvertibleRow } from "../lib/semantic_regions_sync.ts";

 ...
 * games/tbs/SRC/BATTLE/EFFECT/MEMBER_ORBIT.C (Func_080ce85c, exact) and
 * the measured drafts games/tbs/recon/en/main/080dfe2c.c and 080d4ce8.c: the
 ...
 * disassembly (games/tbs/asm/080d4604.s), not carried over from a template.
 *

...
import { assembleOverlay } from "../lib/overlay_disasm.ts";
...
function main(id: string): void {
  ...
  checked([process.execPath, "tools/lib/overlay_published.ts", id]);
  checked([process.execPath, "tools/overlay/overlay_gaps.ts", id]);
  checked([process.execPath, "tools/overlay/overlay_certify.ts", id]);
  checked([process.execPath, "tools/overlay/overlay_driver.ts", id]);

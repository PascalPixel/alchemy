...
s32 BattleUnit_TickCounter132(s32 value)
{
    ...
    if (state->counter_132 != 0) {
        ...
        if (state->state_133 < 0) {
            if (BattleUnit_RollCounterEarlyEnd(value, state->counter_132, 30) != 0) {
                state->state_133 = zero;
...
s32 BattleUnit_TickCounter134(s32 value)
{
    ...
    if (state->counter_134 != 0) {
        ...
        if (state->state_135 < 0 &&
            BattleUnit_RollCounterEarlyEnd(value, state->counter_134, 20) != 0) {
            state->state_135 = 0;
            state->counter_134 = 0;
            return 1;
        }
...
s32 BattleUnit_TickCounter136(s32 value)
{
    ...
    if (state->counter_136 != 0) {
        ...
        if (state->state_137 < 0 &&
            BattleUnit_RollCounterEarlyEnd(value, state->counter_136, 20) != 0) {
            state->state_137 = 0;
            state->counter_136 = 0;
            return 1;
        }
...
s32 BattleUnit_TickCounter138(s32 value)
{
    ...
    if (state->counter_138 != 0) {
        ...
        if (state->counter_138 == 0)
            return 1;
        if (BattleUnit_RollCounterEarlyEnd(value, state->counter_138, 30) != 0) {
            state->counter_138 = 0;
            return 1;
        }
    }
...
s32 BattleUnit_TickCounter139(s32 value)
{
    ...
    if (state->counter_139 != 0) {
        ...
        if (state->counter_139 == 0)
            return 1;
        if (BattleUnit_RollCounterEarlyEnd(value, state->counter_139, 60) != 0) {
            state->counter_139 = 0;
            return 1;
        }
    }
...
s32 BattleUnit_TickCounter13a(s32 value)
{
    ...
    if (state->counter_13a != 0) {
        ...
        if (state->counter_13a == 0)
            return 1;
        if (BattleUnit_RollCounterEarlyEnd(value, state->counter_13a, 70) != 0) {
            state->counter_13a = 0;
            return 1;
        }
    }
...
s32 BattleUnit_TickCounter13b(s32 value)
{
    ...
    if (state->counter_13b != 0) {
        ...
        if (state->counter_13b == 0)
            return 1;
        if (BattleUnit_RollCounterEarlyEnd(value, state->counter_13b, 40) != 0) {
            state->counter_13b = 0;
            return 1;
        }
    }
...
s32 BattleUnit_TickCounter13c(s32 value)
{
    ...
    if (state->counter_13c != 0) {
        ...
        if (state->counter_13c == 0)
            return 1;
        if (BattleUnit_RollCounterEarlyEnd(value, state->counter_13c, 50) != 0) {
            state->counter_13c = 0;
            return 1;
        }
    }
...
s32 Battle_AdvanceCounterAndCheckChance(s32 id)
{
    ...
    if (t != 0) {
        ...
        if (t3 != 0) {
            if ((u32)t3 <= 7U &&
                BattleUnit_RollCounterEarlyEnd(id, FIELD_AT_OFFSET(obj, u8 *, 0x13D), 0x1E) != 0) {

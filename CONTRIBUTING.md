...
- **Unfinished scopes:** 1,683
- **Address spaces scanned:** 97 (87 still contain targets)
- **Target bytes:** 673,150 tracked-C or unresolved-assembly bytes
- **Resolved-only bytes:** 516,620 Exact C or audited permanent assembly bytes
- **Executable bytes accounted for:** 1,348,188

### Main target list

This table contains every scope of at least 1,000 bytes (195 rows). The complete
1,683-row index, including the smallest audited owners, is

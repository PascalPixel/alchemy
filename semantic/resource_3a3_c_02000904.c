...
void Func_02000904(void)
{
    ...
    if (Func_080770c0(0x242) != 0) {
        { s32 f1 = 32; s32 g1 = 32; Func_08009180(64, 32, 0, 32,  f1, g1); }
        hidden = 20;
        { s32 f2 = 0; s32 g2 = 0; Func_080091c0(64, 32, 32, 32,  f2, g2); }
        goto joined_actors;
    } else if (Func_080770c0(0x241) != 0) {
        { s32 f3 = 32; s32 g3 = 32; Func_08009180(64, 0, 0, 32,  f3, g3); }
        { s32 f4 = 0; s32 g4 = 0; Func_080091c0(64, 0, 32, 32,  f4, g4); }
        Func_0808a088(17);
        goto joined_actors;
    } else if (Func_080770c0(0x240) != 0) {
        hidden = 20;
        /* `movs r0,#144 / lsls r0,#2` = 576 = 0x240. */
        { s32 f5 = 32; s32 g5 = 32; Func_08009180(0, 64, 0, 32,  f5, g5); }
        { s32 f6 = 0; s32 g6 = 0; Func_080091c0(0, 64, 32, 32,  f6, g6); }
        hidden = 17;
        Func_0808a088(16);
        goto joined_actors;
    }
...
unjoined_actors:
    { s32 f7 = 0; s32 g7 = 0; Func_080091c0(0, 32, 32, 32,  f7, g7); }
    Func_0808a088(15);
    Func_0808a088(16);
    Func_0808a088(17);
...
actors_ready:
    ...
    { s32 f8 = 20; s32 g8 = 41; Func_080091c0(0, 33, 4, 3,  f8, g8); }

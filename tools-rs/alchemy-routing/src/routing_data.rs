// Routing tables, mirrored from `tools/lib/alchemy_gcc.ts`.
//
// NOT generated: no tool writes this file, and the "@generated -- do not edit by
// hand" banner it used to carry was a false claim. It is hand-maintained, and it
// must stay element-wise identical to the TypeScript for as long as both exist.
// That is enforced by `crate::drift`, which parses the tables back out of the
// TypeScript and compares them: edit one side without the other and the check
// fails. Delete this note, the mirror obligation, and `drift` together when
// `alchemy_gcc.ts` goes away.
//

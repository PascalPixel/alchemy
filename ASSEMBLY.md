...
The current boundary, after the eleventh exact-C checkpoint and full IWRAM reconstruction, is:
...
| Likely ordinary compiler output | 1,374 | 459,218 | Convert to exact C |

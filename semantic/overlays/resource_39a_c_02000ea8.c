/*
 * Resource 39a overlay routine at 0x02000ea8.
 *
 * Complete owner: `push {lr}` at 0x02000ea8 and `pop {r0} / bx r0` at
 * 0x02000eba, so the owner returns nothing.
 *

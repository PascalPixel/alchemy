 ...
 * that family -- see games/tbs/recon/en/main/080e2538.c, 080e7404.c,
 ...
 * the `_call_via_rN` trampoline bundle at games/tbs/asm/080072e4.s
 ...
 * reading already adopted in games/tbs/recon/en/main/080e2538.c,
...
/* DMA3 as three consecutive words; the reference merges the writes into one
   ...
   games/tbs/recon/en/main/08004838.c).  Three ordinary stores is the closest
   ordinary C reaches. */
struct DmaChannel {
    const void *src;
    void *dst;
...
/* _call_via_r3 thunk, games/tbs/asm/080072e4.s */

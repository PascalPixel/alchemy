...
- Semantic-C lane: **178,022 executable bytes across 401 compiling sources**:
  166,014 main bytes and 12,008 overlay bytes. Combined with exact C,
  **319,622 / 1,338,892 executable bytes** are now expressed as C, with
  1,019,270 remaining.

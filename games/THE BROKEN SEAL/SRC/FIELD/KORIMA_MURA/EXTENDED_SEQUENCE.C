...
void FieldScene_RunExtendedActorSequence(void)
{
    ...
    *(s32 *)flag_addr = GameFlag_IsSet(3);
    ...
    Actor_EnableActionCallback(ACTOR_GERALD, (s32)Data_0200abd4);
    Actor_EnableActionCallback(ACTOR_IVAN, (s32)Data_0200ac08);
    if (*(s32 *)flag_addr != 0) {
        ...
        Actor_EnableActionCallback(ACTOR_MIA, (s32)Data_0200ac3c);
    }
    Func_02002a74(2);
    ...
    if (Data_0200b69c != 0) {
        ...
        Actor_EnableActionCallback(ACTOR_MIA, (s32)Data_0200acfc);
        record = Func_02002a54(3);
        Actor_SetSpriteFlags((s32)record, 0);

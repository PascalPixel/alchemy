...
- Semantic-C lane: **192,700 executable bytes across 437 compiling sources**:
  180,692 main bytes and 12,008 overlay bytes. Combined with exact C,
  **338,210 / 1,339,126 executable bytes** are now expressed as C, with
  1,000,916 remaining.

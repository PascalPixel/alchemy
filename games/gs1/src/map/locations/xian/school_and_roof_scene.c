...
void Scene_RunSecondEnsembleBeat(void)
{
    ...
    Map_unk4_2(60);
    Map_unk5_2(0x183b);
    BattlePres_RunActionThenWaitIfModeZero(13, 0, 20);
    Map_Place(0, 13, 0);
    Map_Run(15, 1);
    Map_unk4_2(20);
    BattlePres_RunActionThenWaitIfModeZero(15, 0, 20);
    Map_Place(0, 15, 0);
    Map_Run(16, 2);
    Map_unk4_2(20);
    Map_Place(0, 16, 0);
    ...
    BattlePres_RunActionThenWaitIfModeZero(18, 0, 20);
    Map_Place(9, 17, 0);
    Map_Place(10, 17, 0);
    Map_Place(11, 17, 0);
    Map_Place(12, 17, 0);
    ...
    BattlePres_RunActionThenWaitIfModeZero(17, 0, 20);
    ...
    Map_unk5_4(16, 3);
    Map_unk4_2(20);
    BattlePres_RunActionThenWaitIfModeZero(16, 0, 20);
...
joinBeat:
    BattlePres_RunActionThenWaitIfModeZero(id, 0, 20);
    Map_unk3_2(0x898);
    goto finish;

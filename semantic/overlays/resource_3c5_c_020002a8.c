...
/*
 * resource_3c5 owner at 0x020002a8, 164 bytes: probe the square ahead of an
 ...
 *
 * What was changed:
 *  - the packed direction table 0x0200e190 becomes 0x0200afd4 (file offset
 *    0x2fd4 under the proven 0x02008000 link base).  Corroborated: this
 *    overlay's 0x020000c4 and 0x02000474 owners load the same address for the
 *    same table.
 *  - the passable-kind list 0x0200e1d0 becomes 0x0200b014 (offset 0x3014),
 ...
 *    resource_3c5 02a8': two sites, 0x0200006c (this overlay's own tile-occupant
...
#define PROBE_PASSABLE_KINDS ((const s32 *)0x0200b014)

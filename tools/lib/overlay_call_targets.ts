...
//
// Every disassembler — including `tools/overlay/overlay_show.ts` — adds the branch's own
...
//
//   bun tools/lib/overlay_call_targets.ts resource_39f            # whole overlay
//   bun tools/lib/overlay_call_targets.ts resource_39f 1078       # one owner
//   bun tools/lib/overlay_call_targets.ts resource_39f --json
//   bun tools/overlay/overlay_show.ts resource_39f 1078 -n 180 | \
//     bun tools/lib/overlay_call_targets.ts resource_39f --annotate   # fix the bl names
//   bun tools/lib/overlay_call_targets.ts --self-test

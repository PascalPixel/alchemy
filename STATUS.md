...
|---|---:|---:|
| Compiled C | 1,042 | 54,310 |
| Reconstruction assembly | 2,129 | 494,126 |
...
Within the reconstruction assembly, 470,778 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,917,830 of
...
reconstruction assembly as unfinished C work. The remaining 470,778 bytes are
...
| Byte reconstruction | 7,917,830 / 8,388,608 bytes (94.39%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 54,310 / 525,088 identified executable bytes (10.34%) | Active executable work represented as exact C |

...
lane currently accounts for **280,600 executable bytes across 583 compiling
sources**: 267,808 main-image bytes and 12,792 overlay bytes. Combined with exact
C, **457,174 / 1,339,542 executable bytes** are expressed as C. Build that lane

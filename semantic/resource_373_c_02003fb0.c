 ...
 * resolved with `bun tools/overlay_call_targets.ts resource_373 3fb0` - 52
...
void Func_02003fb0(void)
{
    ...
    { s32 f1 = 20; s32 g1 = 50; Func_080091c0(0x31, 0x35, 8, 4,  f1, g1); }
    { s32 f2 = 2; s32 g2 = 1; Func_08009180(2, 0x66, 0x54, 0x29,  f2, g2); }
    { s32 f3 = 1; s32 g3 = 1; Func_08009180(1, 0x66, 0x53, 0x29,  f3, g3); }
    { s32 f4 = 1; s32 g4 = 1; Func_08009180(0, 0x67, 0x52, 0x2a,  f4, g4); }
    ...
    *actor = (u8)(*actor | 1);
    ...
    /* ---- beat 2: actor 24 ---- */
    { s32 f5 = 2; s32 g5 = 1; Func_08009180(7, 0x66, 0x54, 0x29,  f5, g5); }
    Func_0808a098(0, 1);
    *(s32 *)(camera + 24) = 0x10000;
    *(s32 *)(camera + 28) = 0x10000;
    Func_0808a100(0, 1);
    ...
    *actor = (u8)(*actor | 1);
    ...
    /* ---- beat 3: actor 25 ---- */
    { s32 f6 = 1; s32 g6 = 1; Func_08009180(6, 0x66, 0x53, 0x29,  f6, g6); }
    Func_0808a098(0, 1);
    *(s32 *)(camera + 24) = 0x10000;
    *(s32 *)(camera + 28) = 0x10000;
    Func_0808a100(0, 1);
    ...
    *actor = (u8)(*actor | 1);
    ...
    { s32 f7 = 1; s32 g7 = 1; Func_08009180(5, 0x67, 0x52, 0x2a,  f7, g7); }
    Func_0808a098(0, 1);
    *(s32 *)(camera + 24) = 0x10000;
    *(s32 *)(camera + 28) = 0x10000;
    ...
    *(*(u8 **)(actor + 0x50) + 0x26) = 0;
    ...
    { s32 f8 = 1; s32 g8 = 1; Func_08009180(1, 0x66, 0x53, 0x29,  f8, g8); }
    ...
    *(s32 *)(actor + 28) = 0x8000;
    ...
    Func_0808a128(1, 2, 5);
    Func_080091e0(Func_0808a080(1), 0);
    { s32 f9 = 2; s32 g9 = 1; Func_08009180(2, 0x66, 0x54, 0x29,  f9, g9); }
    Func_080f9010(0x8f);
    Func_080091f0(0, 0x40000, 0x10000);
    Func_0808a138(1, 3);
    Func_080091f0(-1, -1, 0xe666);
    ...
    *actor = (u8)(*actor | 1);
    ...
    Func_0808a218();
    Func_0808a010(100);
    { s32 f10 = 20; s32 g10 = 50; Func_080091c0(0x31, 0x2e, 8, 4,  f10, g10); }
    Func_080770c8(0x202);
    Func_080770d0(0x12f);

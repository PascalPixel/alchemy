...
/*
 * resource_3b2 owner at 0x0200034c, 296 bytes: code through the value-returning
 ...
 * located at 0x0200b19c, 0x0200b1b4 and 0x0200b15c in this overlay.
 *
...
#define RESOURCE_3B2_SCENE (*(u8 *volatile *)0x03001ebc)

u8 *Func_0808a080();

u8 *Func_0200034c(s32 *direction_out, s32 *movement_out, s32 *rectangle_out)
{
    const s32 *types = (const s32 *)0x0200b19c;
    const s32 (*rectangles)[4] = (const s32 (*)[4])0x0200b1b4;
    const s32 *steps = (const s32 *)0x0200b15c;
    u8 **slots = (u8 **)(RESOURCE_3B2_SCENE + 0x34);

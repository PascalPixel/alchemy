...
/*
 * resource_391 owner at 0x0200034c, 296 bytes: code through the value-returning
 ...
 * located at 0x0200ada8, 0x0200adc0 and 0x0200ad68 in this overlay.
 *
...
{
    const s32 *types = (const s32 *)0x0200ada8;
    const s32 (*rectangles)[4] = (const s32 (*)[4])0x0200adc0;
    const s32 *steps = (const s32 *)0x0200ad68;
    u8 **slots = (u8 **)(RESOURCE_391_SCENE + 0x34);

 ...
 * stack VLA, the DMA `stmia` fills that VLA with 0x84 bytes copied from
 * 0x08001fb8, and the `bl 0x8007318` then runs the copied bytes.  sp is
 * word-aligned, so the branch enters ARM state; 0x08001fb8 disassembles as
 * coherent ARM.
 *
 ...
 */
typedef void (*StackKernel_0800543c)(void *, void *, void *, void *);
extern char Value_00000084;
extern char Data_08001fb8;

void Func_0800543c(void *a, void *b, void *c, void *d)
{
    u32 words = (u32)&Value_00000084 >> 2;
    {
        u32 buffer[words];
        u32 *dma = (u32 *)0x040000d4;
        u32 source = (u32)&Data_08001fb8;
        ...
        ((StackKernel_0800543c)(void *)buffer)(a, b, c, d);
    }
}

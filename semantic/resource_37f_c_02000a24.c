...
void Func_02000a24(void)
{
    ...
    *(s32 *)(workspace + 448) = 516;
    ...
    case 1:
        ...
        { s32 f1 = 1; s32 g1 = 1; Func_08009180(1, 109, 4, 81,  f1, g1); }
        { s32 f2 = 1; s32 g2 = 1; Func_08009180(0, 70, 30, 42,  f2, g2); }
        { s32 f3 = 3; s32 g3 = 2; Func_08009180(0, 29, 3, 1,  f3, g3); }
        { s32 f4 = 3; s32 g4 = 1; Func_080091c0(0, 29, 3, 2,  f4, g4); }
        Func_08009128();
        return;
    ...
    case 15:
        ...
        { s32 f5 = 1; s32 g5 = 1; Func_08009180(0, 71, 100, 71,  f5, g5); }
        { s32 f6 = 1; s32 g6 = 2; Func_08009180(122, 20, 120, 30,  f6, g6); }
        { s32 f7 = 120; s32 g7 = 30; Func_080091c0(122, 20, 1, 2,  f7, g7); }
        Func_08009128();
        return;

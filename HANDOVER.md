...
- Semantic-C lane: **171,164 executable bytes across 388 compiling sources**:
  159,156 main bytes and 12,008 overlay bytes. Combined with exact C,
  **309,132 / 1,338,732 executable bytes** are now expressed as C, with
  1,029,600 remaining.

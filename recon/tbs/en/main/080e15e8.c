/* Draft, not exact (2026-09-24): candidate=3900 reference=3920,
   binary similarity 52.9%. First reconstruction of
   BattleFx_InitializeMode12, semantics read from the listing. Phase one
   (170 frames, A or B skips it) draws three dotted beams between six
   projected points, a ring of dots and a falling column; phase two (192
   frames) bursts sparks, flashes and smoke and pans the camera. Stack
   layout and loop shapes are not matched yet. */
#include "TYPES.H"

 ...
 *
 * Note `Func_02005a94` is reached twice with different argument counts: once
...
void Func_02001348(void)
{
    ...
    if (Func_02005a3a(0x833) == 0) {
        ...
        Func_02005ab8(40);
        Func_02005c7e(0x121);
        Func_02005a94(-1, -1, 0xe666);             /* three arguments here */
        Func_02005aa0();
        Func_02005c8c();
        Func_02005aca(0x833);
    }
    ...
    if (Func_02005ad2(0x837) != 0 && Func_02005adc(0x841) == 0 &&
        ...
        if (rec[4] > 0x0479ffff) {                 /* signed word at +16 */
            Func_02002ea4(0x1bd, 0x494);
            Func_02005bc6(0, 0x1bf, 0x4cb);
        } else {
            Func_02002e8e(0x19c, 0x460);           /* 206<<1, 140<<3 */
            Func_02005bb2(0, 0x19e, 0x42c);        /* 207<<1 */
        }
        Func_02005b36(0x30c);
    }

...
- **Unfinished scopes:** 1,827
- **Address spaces scanned:** 97 (87 still contain targets)
- **Target bytes:** 862,856 semantic-C or unresolved-assembly bytes
- **Resolved-only bytes:** 480,944 Exact C or audited permanent assembly bytes
- **Executable bytes accounted for:** 1,347,122

### Main target list

This table contains every scope of at least 1,000 bytes (193 rows). The complete
1,827-row index, including the smallest audited owners, is
...
| 7 | 5,604 | 5,604 | `resource_373:0x02003fb0` |
| 8 | 5,604 | 5,604 | `resource_3bf:0x02003054` |
| 9 | 5,240 | 5,240 | `resource_373:0x020015dc` |
| 10 | 5,136 | 5,136 | `resource_381:0x02001410` |
| 11 | 5,000 | 5,000 | `resource_39e:0x02002ad0` |
| 12 | 4,888 | 4,888 | `main:0x080ab5e4` |
| 13 | 4,840 | 4,840 | `resource_39d:0x02001af0` |
| 14 | 4,708 | 4,708 | `resource_3c9:0x02002360` |
| 15 | 4,268 | 4,268 | `resource_3aa:0x02000360` |
| 16 | 4,224 | 4,224 | `main:0x08027114` |
| 17 | 4,080 | 4,080 | `resource_378:0x0200088c` |
| 18 | 4,064 | 4,064 | `resource_3a8:0x02000590` |
| 19 | 4,044 | 4,044 | `resource_39d:0x02000b24` |
| 20 | 3,804 | 3,804 | `main:0x080f6440` |
| 21 | 3,796 | 3,796 | `resource_383:0x020036f8` |
| 22 | 3,790 | 3,790 | `resource_38d:0x020008c0` |
| 23 | 3,656 | 3,656 | `main:0x080dea70` |
| 24 | 3,604 | 3,604 | `resource_3c9:0x020012c8` |
| 25 | 3,548 | 3,548 | `resource_381:0x02000054` |
| 26 | 3,400 | 3,400 | `resource_378:0x0200187c` |
| 27 | 3,320 | 3,320 | `main:0x08023178` |
...
| 38 | 2,628 | 2,628 | `resource_379:0x02000074` |
...
| 46 | 2,356 | 2,356 | `main:0x080d2464` |
| 47 | 2,354 | 2,354 | `resource_371:0x02000c28` |
| 48 | 2,352 | 2,352 | `resource_370:0x020003cc` |
| 49 | 2,316 | 2,316 | `main:0x0808f52c` |
| 50 | 2,300 | 2,300 | `main:0x08021e6c` |
| 51 | 2,268 | 2,268 | `main:0x080d91dc` |
| 52 | 2,264 | 2,264 | `resource_3c5:0x02001238` |
| 53 | 2,250 | 2,250 | `resource_3c6:0x020007c4` |
| 54 | 2,236 | 2,236 | `resource_39e:0x02001494` |
| 55 | 2,212 | 2,212 | `resource_3bf:0x020027b0` |
| 56 | 2,204 | 2,204 | `resource_3b1:0x02001f3c` |
| 57 | 2,168 | 2,168 | `resource_3bd:0x02002c44` |
| 58 | 2,138 | 2,138 | `main:0x08026080` |
| 59 | 2,124 | 2,124 | `main:0x08024934` |
| 60 | 2,124 | 2,124 | `resource_3b7:0x02000e5c` |
| 61 | 2,092 | 2,092 | `resource_3b8:0x020017e8` |
| 62 | 2,072 | 2,072 | `resource_3b1:0x020027d8` |
| 63 | 2,068 | 2,068 | `resource_3c2:0x02000240` |
| 64 | 2,060 | 2,060 | `resource_38d:0x020019b0` |
| 65 | 2,036 | 2,036 | `resource_375:0x02000170` |
| 66 | 2,032 | 2,032 | `resource_3b8:0x02000ff8` |
...
| 73 | 1,828 | 1,828 | `resource_383:0x02002fd4` |
| 74 | 1,816 | 1,816 | `main:0x080e99c0` |
| 75 | 1,816 | 1,712 | `main:0x08090a5c` |
| 76 | 1,804 | 1,804 | `resource_3b9:0x02001cd4` |
| 77 | 1,796 | 1,796 | `resource_3ca:0x02000430` |
| 78 | 1,796 | 1,664 | `main:0x080f3078` |
| 79 | 1,768 | 1,768 | `main:0x080d52c8` |
| 80 | 1,728 | 1,728 | `resource_375:0x02000be0` |
| 81 | 1,728 | 1,728 | `resource_3ae:0x02000e40` |
| 82 | 1,724 | 1,724 | `main:0x080e89ec` |
| 83 | 1,724 | 1,724 | `resource_3b9:0x02000710` |
| 84 | 1,720 | 1,720 | `main:0x080e2974` |
| 85 | 1,720 | 1,720 | `resource_3a8:0x02002008` |
| 86 | 1,704 | 1,704 | `resource_39e:0x02001dbc` |
| 87 | 1,692 | 1,692 | `resource_3c9:0x0200423c` |
| 88 | 1,688 | 1,688 | `main:0x080b63c8` |
| 89 | 1,680 | 1,680 | `main:0x080a6ccc` |
| 90 | 1,680 | 1,680 | `resource_37f:0x02000f8c` |
| 91 | 1,672 | 1,672 | `resource_387:0x0200067c` |
| 92 | 1,660 | 1,660 | `main:0x080de2f8` |
| 93 | 1,656 | 1,656 | `resource_37b:0x02000614` |
| 94 | 1,648 | 1,648 | `main:0x080ed408` |
| 95 | 1,640 | 1,640 | `main:0x0800aa0c` |
| 96 | 1,636 | 1,636 | `main:0x0800cacc` |
| 97 | 1,632 | 1,632 | `resource_3a2:0x020001ec` |
| 98 | 1,616 | 1,616 | `resource_39c:0x02002f68` |
| 99 | 1,608 | 1,608 | `resource_383:0x02001348` |
| 100 | 1,600 | 1,600 | `resource_396:0x02000918` |
| 101 | 1,592 | 1,592 | `main:0x080168f4` |
| 102 | 1,588 | 1,588 | `main:0x08022b44` |
| 103 | 1,576 | 1,576 | `main:0x080d2d98` |
| 104 | 1,574 | 1,574 | `resource_3ce:0x0200029c` |
| 105 | 1,556 | 1,556 | `main:0x080cf8e0` |
| 106 | 1,540 | 1,540 | `main:0x080e3aa0` |
| 107 | 1,512 | 1,512 | `main:0x080e4e0c` |
| 108 | 1,504 | 1,504 | `main:0x08012518` |
| 109 | 1,488 | 1,488 | `resource_371:0x02001ca4` |
| 110 | 1,468 | 1,468 | `main:0x080dbc30` |
| 111 | 1,468 | 1,468 | `resource_399:0x02000f90` |
| 112 | 1,452 | 1,452 | `resource_3c6:0x02000218` |
| 113 | 1,440 | 1,440 | `resource_3aa:0x02001494` |
| 114 | 1,432 | 1,432 | `resource_3bc:0x02001474` |
| 115 | 1,412 | 1,412 | `resource_372:0x02001b18` |
| 116 | 1,408 | 1,408 | `main:0x08020244` |
| 117 | 1,400 | 1,400 | `resource_380:0x0200178c` |
| 118 | 1,400 | 1,400 | `resource_380:0x02001d04` |
| 119 | 1,388 | 1,388 | `resource_37a:0x02000488` |
| 120 | 1,380 | 1,380 | `resource_383:0x02000de4` |
| 121 | 1,376 | 1,376 | `main:0x0801a98c` |
| 122 | 1,360 | 1,360 | `main:0x080c91dc` |
| 123 | 1,340 | 1,340 | `resource_399:0x020019e8` |
| 124 | 1,340 | 1,340 | `resource_3a8:0x02001930` |
| 125 | 1,336 | 1,336 | `main:0x080a9f10` |
| 126 | 1,324 | 1,324 | `main:0x080bf678` |
| 127 | 1,308 | 1,308 | `main:0x080aa768` |
| 128 | 1,308 | 1,308 | `resource_39c:0x020028b0` |
| 129 | 1,280 | 1,280 | `resource_3b8:0x02000af8` |
| 130 | 1,272 | 1,272 | `main:0x080b0aac` |
| 131 | 1,264 | 1,264 | `main:0x08099da4` |
| 132 | 1,264 | 1,264 | `resource_3ba:0x020021b8` |
| 133 | 1,264 | 1,264 | `resource_3bb:0x02002450` |
| 134 | 1,264 | 1,264 | `resource_3bc:0x02002ee8` |
| 135 | 1,252 | 1,178 | `main:0x0800f2f8` |
| 136 | 1,248 | 1,248 | `main:0x080d9ae8` |
| 137 | 1,240 | 1,240 | `resource_3a4:0x02000ec0` |
| 138 | 1,236 | 1,236 | `resource_3a4:0x02001838` |
| 139 | 1,228 | 1,228 | `main:0x080b6f44` |
| 140 | 1,226 | 1,226 | `main:0x080f4f04` |
| 141 | 1,224 | 1,224 | `resource_374:0x02000bbc` |
| 142 | 1,220 | 1,220 | `resource_37b:0x02000150` |
| 143 | 1,220 | 1,220 | `resource_380:0x02000f8c` |
| 144 | 1,210 | 1,210 | `resource_39c:0x02003d20` |
| 145 | 1,204 | 1,204 | `main:0x080ce034` |
| 146 | 1,192 | 1,192 | `main:0x080da6cc` |
| 147 | 1,192 | 1,192 | `resource_37a:0x02002108` |
| 148 | 1,174 | 1,174 | `resource_3bc:0x02000da4` |
| 149 | 1,172 | 1,172 | `resource_377:0x02000578` |
| 150 | 1,168 | 1,168 | `main:0x080a4924` |
| 151 | 1,156 | 1,156 | `resource_372:0x020028a4` |
| 152 | 1,156 | 1,156 | `resource_3b8:0x02000674` |
| 153 | 1,152 | 1,152 | `main:0x080191cc` |
| 154 | 1,152 | 1,152 | `main:0x0801d4cc` |
| 155 | 1,152 | 1,152 | `main:0x080f26ec` |
| 156 | 1,148 | 1,148 | `resource_371:0x02002cb4` |
| 157 | 1,144 | 1,144 | `main:0x080f2028` |
| 158 | 1,128 | 1,128 | `main:0x080d0000` |
| 159 | 1,124 | 1,124 | `resource_3b1:0x020038ac` |
| 160 | 1,120 | 1,120 | `resource_37a:0x02001ca8` |
| 161 | 1,116 | 1,116 | `main:0x080c02a4` |
| 162 | 1,116 | 1,116 | `resource_37b:0x0200105c` |
| 163 | 1,116 | 1,116 | `resource_3b1:0x020057ec` |
| 164 | 1,116 | 1,116 | `resource_3ba:0x02000db8` |
| 165 | 1,108 | 1,108 | `resource_3a8:0x020032a4` |
| 166 | 1,104 | 1,104 | `main:0x080beb08` |
| 167 | 1,098 | 1,098 | `main:0x080fae58` |
| 168 | 1,096 | 1,096 | `main:0x080d41a4` |
| 169 | 1,076 | 1,076 | `main:0x080030f8` |
| 170 | 1,074 | 1,074 | `main:0x080f4318` |
| 171 | 1,066 | 1,066 | `main:0x080e5e28` |
| 172 | 1,064 | 1,064 | `resource_377:0x02000a0c` |
| 173 | 1,060 | 1,060 | `resource_3cb:0x020012e0` |
| 174 | 1,056 | 1,056 | `main:0x080ae2f4` |
| 175 | 1,056 | 1,056 | `resource_399:0x02000b70` |
| 176 | 1,054 | 1,028 | `main:0x080d77b4` |
| 177 | 1,052 | 978 | `main:0x0808bec0` |
| 178 | 1,044 | 1,044 | `main:0x0808d9a4` |
| 179 | 1,044 | 1,044 | `main:0x080bfba4` |
| 180 | 1,044 | 1,044 | `main:0x080cb7f8` |
| 181 | 1,040 | 1,040 | `main:0x080ceb54` |
| 182 | 1,040 | 1,040 | `main:0x080e90a8` |
| 183 | 1,036 | 1,036 | `resource_3c8:0x02003068` |
| 184 | 1,032 | 1,032 | `resource_3b1:0x02001b34` |
| 185 | 1,028 | 1,028 | `main:0x0801de5c` |
| 186 | 1,024 | 1,024 | `resource_370:0x02000de4` |
| 187 | 1,024 | 1,024 | `resource_3af:0x02000ca0` |
| 188 | 1,024 | 1,024 | `resource_3b1:0x02005d10` |
| 189 | 1,018 | 1,018 | `resource_3c5:0x020028a0` |
| 190 | 1,012 | 1,012 | `main:0x080be378` |
| 191 | 1,006 | 1,006 | `resource_394:0x020003f0` |
| 192 | 1,006 | 1,006 | `resource_3bb:0x02000bd4` |
| 193 | 1,000 | 1,000 | `resource_3a4:0x02003028` |

...
extern struct Obj *Func_02002614(s32 arg0);
...
extern s32 Func_02002680(struct Obj *arg0, s32 *arg1);
extern void Func_02002660(struct Obj *arg0, s32 arg1);
extern void Func_02002628(s32 arg0);
extern void Func_020027c6(s32 arg0);
extern void Func_02002696(struct Obj *arg0, s32 arg1, s32 arg2, s32 arg3);
extern void Func_020026a6(struct Obj *arg0, s32 arg1, s32 arg2, s32 arg3);
extern void Func_020026b4(struct Obj *arg0);
extern void Func_020027e8(void);
extern void Func_020026cc(struct Obj *arg0, s32 arg1);
...
void Func_020000c4(void) {
    ...
    w <<= 16;
    buf[2] = b->u10.w + w;
    if (Func_02002680(b, buf) > 0) return;
    ...
    b->field30 = c;
    b->field34 = c;
    Func_02002696(b, buf[0], buf[1], buf[2]);
    a->field30 = c;
    a->field34 = c;
    Func_020026a6(a, buf[0], buf[1], buf[2]);
    Func_020026b4(b);
    Func_020027e8();
    b->u08.w = buf[0];
    b->u10.w = buf[2];

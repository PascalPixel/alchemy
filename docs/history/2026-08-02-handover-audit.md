> Historical archive: audit checkpoint 2026-08-02. Preserved for evidence; use [STATUS.md](../../STATUS.md) for the current project state.
...
- `docs/history/2026-07-28-path-to-completion.md` — historical delivery/compiler cohorts.
- `docs/history/2026-07-30-discovery-queue.md` — historical main-image/code-overlay queue audit.
- `docs/history/2026-07-26-compiler-queue.md` — historical compiler experiments and stop rules.

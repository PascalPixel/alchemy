...
#define OvObj_PrepareSceneObject        Func_02000048
...
#define Dialogue_RunActor13FlaggedLine      Func_02000cc4
...
#define Effect_SetEffectRecordMode Func_02000030
#define OvObj_CreateConfiguredObject Func_020000a0
#define Effect_SpawnConfiguredEffect Func_0200013c
#define Actor_UpdateProximityToLeader Func_02000314
#define ActorDraw_UpdateEntityFromLeader Func_020003ac
...
#define OvObj_GetObject2Byte280 Func_02000450
#define OvObj_RunObject2WhenFlagged Func_02000464
#define State_SetFlags947And29dc Func_020005c8
#define SceneData_SelectTableA414ByFlag855 Func_020005f0
#define Dialogue_RunActor9LineAndAdvance Func_02000614
#define ActorDraw_RunActorThirteenSceneSetup Func_02000674
#define ActorDraw_RunActorSeventeenSceneSetup Func_020006d0
#define ActorDraw_RunActorEighteenSceneSetup Func_02000724
#define Dialogue_RunActor11Line Func_02000778
#define Dialogue_RunActor16Line Func_02000798
#define Dialogue_RunActor19Line Func_020007b8
#define ActorDraw_RunActorFourteenDialogue Func_020007ec
#define ActorDraw_RunActorFifteenDialogue Func_0200085c
#define Scene_RunActor21Sequence Func_020008cc
#define Actor_RunActorStep Func_0200090c
#define Actor_RunActorCommandWithFlag91 Func_02000938
#define ActorDraw_RunActorEightSceneSetup Func_0200097c
#define Dialogue_RunActor11SecondLine Func_020009d0
#define Dialogue_RunActor12LineAndAdvance Func_020009f0
#define Dialogue_RunActor13Line Func_02000a2c
#define ActorDraw_RunActorFourteenDialogueAndAdvanceStory Func_02000a4c
#define ActorDraw_RunActorFifteenFollowupDialogue Func_02000acc
#define ActorDraw_RunActorSixteenSceneSetup Func_02000b3c
#define ActorDraw_RunActorEighteenFollowupSceneSetup Func_02000b98
#define ActorDraw_RunActorNineteenDialogueAndSetSceneState Func_02000bec
#define Dialogue_RunActor20Line Func_02000c54
#define Dialogue_RunActor11FlaggedLine Func_02000c8c
#define ActorDraw_RunActorFourteenFlaggedDialogue Func_02000cfc
#define ActorDraw_RunActorFifteenScriptBranch Func_02000d78
#define ActorDraw_RunActorSixteenScriptBranch Func_02000dd4
#define ActorDraw_RunActorNineteenScriptBranch Func_02000e0c
#define Dialogue_RunActor21Line Func_02000e84
#define State_Apply200ThenPlace55_26 Func_02000ea4
#define State_Apply200ThenPlace23_23 Func_02000ecc
#define Actor_PlaceActor0AndSetSceneDelay Func_02000ef4
#define Scene_SetupScene5At408_320 Func_02000f3c
#define Scene_SetupScene6At312_304 Func_02000f64
#define Scene_SetupScene7At216_288 Func_02000f8c
#define ActorDraw_SetupActorZeroForSceneEightAt376_224 Func_02000fb4
#define ActorDraw_SetupActorZeroForSceneNineAt296_176 Func_02001010
#define Scene_SetupScene10At120_144 Func_0200106c
#define ActorDraw_SetupActorZeroForSceneTwelveAt72_160 Func_0200113c
#define Scene_SetupScene13At152_264 Func_02001198
#define ActorDraw_MoveActorToPositionAndWait Func_020011b0
#define Scene_RunActor23SequenceOnceByFlag867 Func_02001238
#define Scene_RunActor19MotionSequence Func_020012c0
#define Actor_GetPositionDistance Func_02001638
#define Actor_ApplyActorZeroThenWait Func_02001724
#define Actor_ApplyActorCueThenWait Func_0200173c
#define Effect_UpdateMotionWithDamping Func_02001754
...
void Dialogue_RunActor11Line(void) { Func_02002134(); Func_020021d2(0x1227); Func_02001094(11); Func_0200214c(); }

void Dialogue_RunActor16Line(void) { Func_02002154(); Func_020021f2(0x122e); Func_020010b4(16); Func_0200216c(); }
...
void Dialogue_RunActor11SecondLine(void) { Func_0200238c_a(); Func_0200242a(0x1335); Func_020012ec(11); Func_020023a4(); }
...
void Dialogue_RunActor13Line(void) { Func_020023e8(); Func_02002486(0x1338); Func_02001348(13); Func_02002400(); }

void ActorDraw_RunActorFourteenDialogueAndAdvanceStory(void)
{
    extern u8 *Data_03001ebc;
    void Func_020023c8_a(s32);
...
{
    int Func_0200261e_a(int);

    Func_02002648();
    if (Func_0200261e_a(0x855) == 0) Func_020026f0(0x1239); else Func_020026f8(0x1346);
...
{
    void Func_020027ec_a(int);

    u8 *actor = Func_020027f2(19); actor[91] = 1; Func_020027d6();
    if (Func_020027ac(0x855) == 0) {
        Func_0200287e(0x1241); Func_02002856(19, 0); Func_020027ec_a(2);
...
void Dialogue_RunActor21Line(void) { Func_02002840_a(); Func_020028de(0x12c1); Func_020017cc(21); Func_02002858(); }
...
void Scene_SetupScene13At152_264(void) { Func_02002c66(123); Func_0200209e(152, 264, 13); }
...
void ActorDraw_MoveActorToPositionAndWait(int actor, int x, int z, int field40)
{
    ...
    *(s32 *)(record + 68) = 0; *(s32 *)(record + 40) = field40; Func_02002b40(record, 0);
    ...
    for (frames = 60; frames != 0; --frames) { Func_02002b24_a(1); if (*(s16 *)(record + 42) == 0) break; }
...
void Scene_RunActor23SequenceOnceByFlag867(void)
{
    ...
    if (Value1(Func_02002bd6, 0x867) == 0) {
        ...
        Func_02002c42(20);
        Call3(Func_02002ca6_a, 23, 0x198, 104);
...
#undef OvObj_PrepareSceneObject
...
#undef Dialogue_RunActor13FlaggedLine
...
#undef BeginSceneStep
#undef SceneFlagIsClear
#undef PlaySceneCueA
#undef PlaySceneCueB
#undef SetSceneActor
#undef EndSceneStep
#undef EffectMotion_GetHorizontalDecay
#undef EffectMotion_GetVerticalDecay
#undef Effect_SetEffectRecordMode
#undef OvObj_CreateConfiguredObject
#undef Effect_SpawnConfiguredEffect
#undef Actor_UpdateProximityToLeader
#undef ActorDraw_UpdateEntityFromLeader
#undef SceneData_GetScriptTable
#undef SceneData_ReturnZero
#undef SceneData_GetMessageTable
#undef SceneData_SelectActorTableByFlag855
#undef OvObj_GetObject2Byte280
#undef OvObj_RunObject2WhenFlagged
#undef State_SetFlags947And29dc
#undef SceneData_SelectTableA414ByFlag855
#undef Dialogue_RunActor9LineAndAdvance
#undef ActorDraw_RunActorThirteenSceneSetup
#undef ActorDraw_RunActorSeventeenSceneSetup
#undef ActorDraw_RunActorEighteenSceneSetup
#undef Dialogue_RunActor11Line
#undef Dialogue_RunActor16Line
#undef Dialogue_RunActor19Line
#undef ActorDraw_RunActorFourteenDialogue
#undef ActorDraw_RunActorFifteenDialogue
#undef Scene_RunActor21Sequence
#undef Actor_RunActorStep
#undef Actor_RunActorCommandWithFlag91
#undef ActorDraw_RunActorEightSceneSetup
#undef Dialogue_RunActor11SecondLine
#undef Dialogue_RunActor12LineAndAdvance
#undef Dialogue_RunActor13Line
#undef ActorDraw_RunActorFourteenDialogueAndAdvanceStory
#undef ActorDraw_RunActorFifteenFollowupDialogue
#undef ActorDraw_RunActorSixteenSceneSetup
#undef ActorDraw_RunActorEighteenFollowupSceneSetup
#undef ActorDraw_RunActorNineteenDialogueAndSetSceneState
#undef Dialogue_RunActor20Line
#undef Dialogue_RunActor11FlaggedLine
#undef ActorDraw_RunActorFourteenFlaggedDialogue
#undef ActorDraw_RunActorFifteenScriptBranch
#undef ActorDraw_RunActorSixteenScriptBranch
#undef ActorDraw_RunActorNineteenScriptBranch
#undef Dialogue_RunActor21Line
#undef State_Apply200ThenPlace55_26
#undef State_Apply200ThenPlace23_23
#undef Actor_PlaceActor0AndSetSceneDelay
#undef Scene_SetupScene5At408_320
#undef Scene_SetupScene6At312_304
#undef Scene_SetupScene7At216_288
#undef ActorDraw_SetupActorZeroForSceneEightAt376_224
#undef ActorDraw_SetupActorZeroForSceneNineAt296_176
#undef Scene_SetupScene10At120_144
#undef ActorDraw_SetupActorZeroForSceneTwelveAt72_160
#undef Scene_SetupScene13At152_264
#undef ActorDraw_MoveActorToPositionAndWait
#undef Scene_RunActor23SequenceOnceByFlag867
#undef Scene_RunActor19MotionSequence
#undef Actor_GetPositionDistance
#undef Actor_ApplyActorZeroThenWait
#undef Actor_ApplyActorCueThenWait
#undef Effect_UpdateMotionWithDamping
...
void Func_02001fba();
void Func_02001fca();
void Func_02001fd0_a();
void Func_02002030_a();
void Func_02002044();
void Func_02002050();
...
void FieldScene_RunScene382_020004a0(void)
{
    ...
    if (*(s16 *)(((s32)p5 + 0x16c)) == 20) {
        Call3(Func_02001f10_a, 2, 0x190, 0x1c0);
    } else {
    ...
    Func_02001f50(2);
    Func_02002030_a((*(s16 *)(((s32)p5 + 0x16c)) - 19));
    Func_02002044();
    Func_02002050();
    Func_02001f5c();
    L_0200059e:;
}
#undef FieldScene_RunScene382_020004a0

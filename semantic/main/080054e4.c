 ...
 * stack VLA, the DMA `stmia` fills that VLA with 0x50 bytes copied from
 * 0x08001ea8, and the `bl 0x8007318` then runs the copied bytes.  sp is
 * word-aligned, so the branch enters ARM state; 0x08001ea8 disassembles as
 * coherent ARM.
 *
 ...
 */
typedef void (*StackKernel_080054e4)(void *, void *, void *);
extern char Value_00000050;
extern char Data_08001ea8;

void Func_080054e4(void *a, void *b, void *c)
{
    u32 words = (u32)&Value_00000050 >> 2;
    {
        u32 buffer[words];
        u32 *dma = (u32 *)0x040000d4;
        u32 source = (u32)&Data_08001ea8;
        ...
        ((StackKernel_080054e4)(void *)buffer)(a, b, c);
    }
}

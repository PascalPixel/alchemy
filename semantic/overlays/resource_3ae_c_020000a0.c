...
void *Func_020000a0(void)
{
    s32 room = Data_02000240[224];

    if (room == 0x6b) {
        if (Func_080770c0(0x93e) != 0) {
            return Data_02009ba4;
        }
        return Data_02009acc;
    }

    if (room == 0x70) {
        /* movs r0,#149 / lsls r0,r0,#4 == 0x950 */
        if (Func_080770c0(0x950) != 0) {
            return Data_020099c4;
        }
        return Data_020098ec;
    }

    if (room == 0x6c) {
        if (Func_080770c0(0x950) != 0) {
            return Data_02009dcc;
        }
        if (Func_080770c0(0x93e) != 0) {
            return Data_02009d24;
        }
        return Data_02009c7c;
    }

    return Data_020098d4;
}

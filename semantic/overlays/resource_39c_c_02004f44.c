 ...
 *
 * Func_0200aa7a's fourth argument is the address of `Data_03001f30` itself
 ...
 * that call site.
 *
 * Uncertainty: Func_0200abba and Func_0200abbc are called with no register
 ...
 * five callees are identified beyond their call shape; the two shifted
 * constants passed to Func_0200aa7a (0x3480000, 0x2580000) are recorded as

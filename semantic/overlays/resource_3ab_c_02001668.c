...
s32 Func_02001668(void)
{
    ...
    if (*(s16 *)((u8 *)0x02000240 + 448) == 159) {
        *(s32 *)(Data_03001ebc + 448) = 256;
        *(u16 *)((u8 *)0x02000240 + 578) = 10;
        if (*(s16 *)((u8 *)0x02000240 + 450) == 4 && Func_080770c0(0x109) == 0) {
            Func_0200131c();
        }
        if (*(s16 *)((u8 *)0x02000240 + 450) == 3 && Func_080770c0(0x109) == 0) {
            Func_020015bc();
        }

...
#define RunSequenceRecordEditor Func_08027114
...
/*
 * Build and edit the sequence of 16-byte output records described by the
 * identifier list.
 *
 ...
 */
s32 RunSequenceRecordEditor(
    void *output_records, u16 *identifiers, s32 result) {
    u8 *state;
    u16 selection[2];
    s32 sp4;
    u16 *sp8;
...
interaction_loop:
    ...
    M2C_FIELD((selection), u16, 0) = sp40;
    M2C_FIELD((selection), s16, 2) = 0xFF;
    Func_080b50e0((selection), 1);
    Func_0802281c((selection));
    Func_080030f8(1U);

...
void Func_020024cc(void)
{
    ...
    Func_02002a1a(2, x, z, 1, 1, 255);

    x = *(s32 *)(obj + 8) >> 20;
    if (x == 16) {
        s32 fallback = Func_02004fee(0x204);

...
#define GameFlag_IsSet_1_0200101c(args...) Func_02003456_a(args)
...
{
    if (GameFlag_IsSet_1_0200101c(GATE_CODE) == 0) {
...
void FieldScene_CueActorTwoWhenCell13_7(void)
{
    s32 rec1;
    s32 rec2;
    s32 a;

    rec1 = Value1(Func_02003ade, 0);
    a = *(s32 *)(rec1 + 8) >> 20;
    rec2 = Value1(Func_02003ae8, 0);
    if ((*(s32 *)(rec2 + 16) >> 20) == 7) {
        if ((u32)(a - 13) <= 1) {
            Call4(Func_02003ac0, 2, 0xd00000, 0x700000, 255);
        }
    }
}

...
void FieldScene_RunActorTransferSequence(void)
{
    ...
    Actor_WalkToAndWait(0, 0x16fc, 0x628);
    ...
    Actor_WalkToAndWait(1, 0x1704, 0x640);
    ...
    Actor_FaceDirection(0, 0x2000, 0);
    Actor_FaceDirection(1, 0xa000, 60);
    Actor_FaceDirection(0, 0x6000, 0);
    ...
    *(s32 *)(record + 40) = (scale << 11);
    ...
    Func_020057be();
    Actor_SetPosition(0, 0x170c0000, 0x6280000);
    Actor_SetPosition(1, 0x17140000, 0x6400000);
    ...
    Camera_WaitForMove();
    Actor_FaceDirection(0, 0x2000, 0);
    Actor_FaceDirection(1, 0xa000, 80);
    ...
    Actor_WalkToAndWait(0, 0x16d8, 0x628);
    Event_CloseScreen();
    Event_WaitForScreen();
    GameFlag_Set(0x85a);
    Event_RequestExit(3);
...
void FieldScene_RunScene371_02002274(void)
{
    ...
    Audio_PlayCue(0x121);
    Event_Wait(20);
    Actor_SetPosition(0, 0x15d80000, 0x8780000);
    Task_Wait(1);
    Actor_Jump(0, 6, 0);
    Actor_SetSpeed(0, 0x20000, 0x10000);
    Actor_WalkToAndWait(0, 0x15c8, 0x878);
    ...
    Actor_SetSpeed(0, 0xcccc, 0x6666);
    Actor_WalkToAndWait(0, 0x15d8, 0x858);
    Event_CloseScreen();
    Event_WaitForScreen();
...
void FieldScene_RunScene371_02002858(void)
{
    ...
    Actor_WalkToAndWait(0, 0x1778, 0xd48);
    Event_End();
}
...
void FieldScene_RunActorPresentationSequence(void)
{
    ...
    *(s32 *)((u8 *)Data_03001ebc + 0x1c8) = 16;
    ...
    Actor_ShowEmote(5, 0x105, 40);
    Event_ShowMessageAndWait(5, 0, 20);
    Event_ShowMessageAndWait(8, 0, 10);
    Actor_ShowEmote(5, 0x102, 20);
    ...
    Event_ShowMessageAndWait(8, 0, 20);
    Actor_ShowEmote(5, 0x105, 40);
    Event_ShowMessageAndWait(5, 0, 120);
    ...
    Actor_FaceDirection(5, 0xb000, 40);
    Actor_SetSpeed(8, 0x9999, 0x4ccc);
    Actor_SetSpeed(5, 0x9999, 0x4ccc);
    ...
    Actor_SetSpeed(5, 0x19999, 0xcccc);
    Actor_WalkTo(8, 0x1e7c, 0xdb8);
    Actor_WalkToAndWait(5, 0x1e6c, 0xdd8);
    Actor_SetAnimation(8, 1);
    Func_02007484();
    Event_Wait(80);
    Actor_RunRepeatedMotion(8, 1);

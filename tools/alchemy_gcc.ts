...
const AGBCC_SOURCES = new Set([
  "08006a00", "08006ba8", "08006c24", "08006c68", "08006cdc", "08006dec", "08007028", "08006f84", "08007098", "0800711c", "080071a8", "08007220",
  "080f9a50",
  "080fada0", "080fadf0",
...
const AGBCC_OPTIMIZE_O1_SOURCES = new Set([
  "08006a00", "08006ba8", "08006c68", "08006cdc", "08007028", "08006f84", "08007098", "0800711c", "080071a8", "08007220", "080fa514",
]);
...
function selfTest(): void {
  const expected = [
    "08006a00", "08006ba8", "08006c24", "08006c68", "08006cdc", "08006dec", "08006f84", "08007028", "08007098", "0800711c", "080071a8", "08007220",
    "080f9a50",
    "080fa1fc", "080fa2a0", "080fa324", "080fa350", "080fa39c", "080fa3f0",
    "080fa424", "080fa458", "080fa490", "080fa514", "080fa55c", "080fa6a0", "080fa83c", "080fa8d4", "080fa928", "080fa9a4",
  ...
  for (const stem of expected) {
    ...
    const expectedFlags = [
      ...AGBCC_CFLAGS,
      ...(["08006a00", "08006ba8", "08006c68", "08006cdc", "08006f84", "08007028", "08007098", "0800711c", "080071a8", "08007220"].includes(stem) ? ["-O1"] : []),

...
|---|---:|---:|
| Compiled C | 1,037 | 53,766 |
| Reconstruction assembly | 2,134 | 494,670 |
...
Within the reconstruction assembly, 471,322 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,917,286 of
...
reconstruction assembly as unfinished C work. The remaining 471,322 bytes are
...
| Byte reconstruction | 7,917,286 / 8,388,608 bytes (94.38%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 53,766 / 525,088 identified executable bytes (10.24%) | Active executable work represented as exact C |

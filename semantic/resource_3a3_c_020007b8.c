...
void Func_020007b8(void)
{
    ...
    *(u32 *)(record + 108) = 0x020086f1;        /* Func_020006f0 + Thumb bit */
    ...
    Func_020016b6(18, 0x13333, 0x9999);
    Func_020016ca(18, 28, 460);                 /* `movs r2,#230 / lsls #1` */
    Func_020016d6(18, 24, 448);                 /* `movs r2,#224 / lsls #1` */

    Func_020017bc(229);
    Func_020016d2(18);

    Func_02001690(0, 0x10000, 0x10000);         /* `movs #128 / lsls #9` */
    Func_020016b6(4);

    Func_020016a4(-1, -1, 0xe666);
    Func_020016ca(40);

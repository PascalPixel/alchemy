...
|---|---:|---:|
| Compiled C | 1,038 | 53,970 |
| Reconstruction assembly | 2,133 | 494,466 |
...
Within the reconstruction assembly, 471,118 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,917,490 of
...
reconstruction assembly as unfinished C work. The remaining 471,118 bytes are
...
| Byte reconstruction | 7,917,490 / 8,388,608 bytes (94.38%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 53,970 / 525,088 identified executable bytes (10.28%) | Active executable work represented as exact C |

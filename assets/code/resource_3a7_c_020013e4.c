 ...
 *
 * TRANSPOSED from semantic/overlays/resource_3bf_c_02005a78.c.  The two owners are
 ...
 * 'bun tools/overlay_call_targets.ts resource_3a7 13e4'.  All four target this
...
SoftDouble Func_020013e4(u32 a0, u32 a1, u32 b0, u32 b1)
{
    struct {
        SoftDouble packedB;
        SoftDouble packedA;
    ...
    Func_02002b6c(&frame.packedA, &frame.recordA);
    {
        SoftFloatRecord *recordB = &frame.recordB;

        Func_02002b76(&frame.packedB, recordB);
     ...
     */
        ...
        return Func_020029c0(Func_02002570(&frame.recordA, recordB, &frame.result));
    }
}

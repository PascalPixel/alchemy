...
- Semantic-C lane: **197,968 executable bytes across 444 compiling sources**:
  185,176 main bytes and 12,792 overlay bytes. Combined with exact C,
  **345,582 / 1,339,230 executable bytes** are now expressed as C, with
  993,648 remaining.

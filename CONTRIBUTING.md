...
- **Unfinished scopes:** 1,954
- **Address spaces scanned:** 97 (87 still contain targets)
- **Target bytes:** 808,222 tracked-C or unresolved-assembly bytes
- **Resolved-only bytes:** 351,010 Exact C or audited permanent assembly bytes
- **Executable bytes accounted for:** 1,347,122

### Main target list

This table contains every scope of at least 1,000 bytes (260 rows). The complete
1,954-row index, including the smallest audited owners, is
[`games/gs1/metrics/gs1-en-core-targets.json`](games/gs1/metrics/gs1-en-core-targets.json).

| Rank | Scope | Target | Namespace / owner |
|---:|---:|---:|---|
| 1 | 19,708 | 7,952 | `main:0x080e7404` |
...
| 32 | 3,850 | 2,604 | `main:0x08077320` |
...
| 37 | 3,584 | 2,138 | `main:0x08026080` |
| 38 | 3,492 | 1,740 | `main:0x080e3a14` |
| 39 | 3,472 | 1,184 | `main:0x08010424` |
...
| 52 | 3,058 | 3,058 | `resource_3c5:0x0200186c` |
| 53 | 3,056 | 2,084 | `main:0x0800ebec` |
| 54 | 3,046 | 3,046 | `resource_395:0x02000470` |
| 55 | 3,046 | 3,046 | `resource_39d:0x02001adc` |
| 56 | 2,946 | 2,426 | `main:0x080167e0` |
| 57 | 2,918 | 824 | `main:0x080b6148` |
| 58 | 2,908 | 2,908 | `resource_381:0x020003cc` |
| 59 | 2,854 | 2,854 | `resource_374:0x0200155c` |
| 60 | 2,778 | 904 | `main:0x08020bd8` |
| 61 | 2,772 | 2,576 | `main:0x0808f52c` |
| 62 | 2,734 | 2,734 | `resource_3a8:0x020026a8` |
| 63 | 2,706 | 1,588 | `main:0x080a345c` |
| 64 | 2,698 | 2,256 | `main:0x080a8914` |
| 65 | 2,678 | 1,652 | `main:0x08095160` |
| 66 | 2,672 | 2,672 | `resource_3a8:0x02000aac` |
| 67 | 2,658 | 1,388 | `main:0x080c1fa8` |
| 68 | 2,650 | 2,376 | `main:0x080999f0` |
| 69 | 2,630 | 1,346 | `main:0x080a7a34` |
| 70 | 2,596 | 200 | `main:0x080c0000` |
| 71 | 2,574 | 2,574 | `resource_39e:0x02002ec8` |
| 72 | 2,568 | 748 | `main:0x08012518` |
| 73 | 2,530 | 1,312 | `main:0x080b8574` |
| 74 | 2,508 | 460 | `main:0x08020000` |
| 75 | 2,476 | 2,476 | `resource_3af:0x0200252c` |
| 76 | 2,440 | 2,368 | `main:0x080bf678` |
| 77 | 2,430 | 2,244 | `main:0x080a6a00` |
| 78 | 2,426 | 2,426 | `resource_3b8:0x0200338c` |
| 79 | 2,418 | 2,418 | `resource_38d:0x02000894` |
| 80 | 2,382 | 2,382 | `resource_383:0x02003c6c` |
| 81 | 2,360 | 1,328 | `main:0x080dd9c0` |
| 82 | 2,310 | 2,310 | `resource_3b8:0x02002a84` |
| 83 | 2,298 | 2,298 | `resource_380:0x02000a98` |
| 84 | 2,294 | 2,294 | `resource_3c9:0x02002360` |
| 85 | 2,294 | 1,912 | `main:0x0808e0b0` |
| 86 | 2,236 | 2,236 | `resource_39e:0x02001494` |
| 87 | 2,230 | 2,230 | `resource_3bd:0x02001d4c` |
| 88 | 2,222 | 2,222 | `resource_3bc:0x02001a08` |
| 89 | 2,218 | 2,218 | `resource_3c9:0x02003e8c` |
| 90 | 2,218 | 1,028 | `main:0x08079008` |
| 91 | 2,206 | 2,206 | `resource_377:0x0200063c` |
| 92 | 2,194 | 2,194 | `resource_376:0x02000640` |
| 93 | 2,190 | 2,190 | `resource_396:0x0200069c` |
| 94 | 2,182 | 1,696 | `main:0x0808d828` |
| 95 | 2,180 | 2,180 | `resource_3bd:0x02002c38` |
| 96 | 2,172 | 1,336 | `main:0x0808a5f8` |
| 97 | 2,170 | 2,170 | `resource_3ca:0x02000430` |
| 98 | 2,166 | 2,166 | `resource_38f:0x020011ec` |
| 99 | 2,166 | 2,166 | `resource_3c9:0x02002c58` |
| 100 | 2,158 | 2,158 | `resource_373:0x02001a14` |
| 101 | 2,118 | 2,118 | `resource_371:0x020028e8` |
| 102 | 2,070 | 2,070 | `resource_3b1:0x02001b34` |
| 103 | 2,070 | 2,070 | `resource_3bd:0x020013f8` |
| 104 | 2,068 | 2,068 | `resource_3c2:0x02000240` |
| 105 | 2,056 | 1,048 | `main:0x080f0254` |
| 106 | 2,046 | 124 | `main:0x0800300c` |
| 107 | 2,026 | 242 | `main:0x0800a97c` |
| 108 | 2,018 | 2,018 | `resource_3a5:0x020004e4` |
| 109 | 2,014 | 2,014 | `resource_3c9:0x02000a6c` |
| 110 | 2,006 | 2,006 | `resource_3a4:0x02001830` |
| 111 | 2,002 | 2,002 | `resource_38d:0x020019b0` |
| 112 | 2,002 | 2,002 | `resource_3af:0x02003a0c` |
| 113 | 1,978 | 1,978 | `resource_3ad:0x02000808` |
| 114 | 1,928 | 904 | `main:0x08097b54` |
| 115 | 1,906 | 1,906 | `resource_378:0x0200290c` |
| 116 | 1,902 | 1,292 | `main:0x080983a0` |
| 117 | 1,866 | 1,722 | `main:0x080b9b30` |
| 118 | 1,854 | 1,854 | `resource_3c8:0x020026f8` |
| 119 | 1,822 | 1,822 | `resource_38f:0x02001e6c` |
| 120 | 1,810 | 1,810 | `resource_383:0x02002fd4` |
| 121 | 1,810 | 500 | `main:0x08006088` |
| 122 | 1,808 | 1,808 | `resource_3b1:0x02005c9c` |
| 123 | 1,800 | 992 | `main:0x0809b0dc` |
| 124 | 1,782 | 1,660 | `main:0x080de2f8` |
| 125 | 1,778 | 1,778 | `resource_3b9:0x02001cd4` |
| 126 | 1,770 | 1,770 | `resource_3b1:0x020028c8` |
| 127 | 1,736 | 1,736 | `resource_3bf:0x0200298c` |
| 128 | 1,734 | 1,734 | `resource_383:0x02001e80` |
| 129 | 1,722 | 1,722 | `resource_3b8:0x02002014` |
| 130 | 1,718 | 708 | `main:0x080ba2c0` |
| 131 | 1,704 | 1,704 | `resource_3a2:0x02000924` |
| 132 | 1,702 | 1,702 | `resource_381:0x02002150` |
| 133 | 1,702 | 1,702 | `resource_3b7:0x020001d8` |
| 134 | 1,698 | 1,698 | `resource_3ae:0x02000ba0` |
| 135 | 1,692 | 400 | `main:0x0808b824` |
| 136 | 1,682 | 1,682 | `resource_39c:0x02004888` |
| 137 | 1,638 | 1,638 | `resource_373:0x02004084` |
| 138 | 1,636 | 1,636 | `main:0x0800cacc` |
| 139 | 1,634 | 1,056 | `main:0x080ae2f4` |
| 140 | 1,632 | 1,632 | `resource_39c:0x02002f58` |
| 141 | 1,632 | 1,632 | `resource_3a2:0x020001ec` |
| 142 | 1,626 | 1,626 | `resource_375:0x020000dc` |
| 143 | 1,586 | 1,586 | `resource_3c5:0x02001238` |
| 144 | 1,562 | 1,170 | `main:0x080a63e4` |
| 145 | 1,560 | 832 | `main:0x08098cd8` |
| 146 | 1,550 | 1,550 | `resource_379:0x02000484` |
| 147 | 1,514 | 1,514 | `resource_3a4:0x02000d24` |
| 148 | 1,506 | 1,264 | `main:0x080b5534` |
| 149 | 1,480 | 1,480 | `resource_399:0x02000f84` |
| 150 | 1,478 | 1,478 | `resource_3aa:0x02001450` |
| 151 | 1,462 | 1,462 | `resource_373:0x020039e8` |
| 152 | 1,458 | 1,458 | `resource_3c8:0x020047ac` |
| 153 | 1,448 | 1,448 | `resource_3b0:0x02000af8` |
| 154 | 1,448 | 1,448 | `resource_3b1:0x020050dc` |
| 155 | 1,426 | 912 | `main:0x0809a8c4` |
| 156 | 1,410 | 1,410 | `resource_383:0x020036e8` |
| 157 | 1,410 | 1,138 | `main:0x08090000` |
| 158 | 1,410 | 908 | `main:0x080c1a24` |
| 159 | 1,408 | 1,408 | `resource_39e:0x020038d8` |
| 160 | 1,402 | 1,402 | `resource_3b1:0x0200234c` |
| 161 | 1,398 | 1,398 | `resource_372:0x02001b18` |
| 162 | 1,392 | 842 | `main:0x080d4ce8` |
| 163 | 1,382 | 1,382 | `resource_3c9:0x02003924` |
| 164 | 1,378 | 1,378 | `resource_380:0x02001780` |
| 165 | 1,366 | 1,366 | `resource_37a:0x02000488` |
| 166 | 1,366 | 1,366 | `resource_3aa:0x0200077c` |
| 167 | 1,354 | 676 | `main:0x08017364` |
| 168 | 1,346 | 324 | `main:0x080b04dc` |
| 169 | 1,326 | 1,326 | `resource_391:0x02002004` |
| 170 | 1,318 | 1,024 | `main:0x08092b94` |
| 171 | 1,310 | 1,310 | `resource_373:0x020034c8` |
| 172 | 1,310 | 656 | `main:0x080994d0` |
| 173 | 1,308 | 1,308 | `resource_37a:0x02002094` |
| 174 | 1,306 | 1,306 | `resource_3a8:0x02000590` |
| 175 | 1,290 | 1,290 | `resource_3af:0x02000c94` |
| 176 | 1,270 | 1,270 | `resource_371:0x02001064` |
| 177 | 1,270 | 1,270 | `resource_3b1:0x020037d8` |
| 178 | 1,262 | 1,262 | `resource_38d:0x020012a0` |
| 179 | 1,258 | 1,258 | `resource_387:0x0200067c` |
| 180 | 1,238 | 1,238 | `resource_373:0x02004b24` |
| 181 | 1,234 | 1,234 | `resource_39d:0x02001608` |
| 182 | 1,234 | 1,234 | `resource_3af:0x02001db0` |
| 183 | 1,230 | 1,230 | `resource_371:0x02001f6c` |
| 184 | 1,230 | 1,230 | `resource_374:0x02000b8c` |
| 185 | 1,230 | 226 | `main:0x080a7380` |
| 186 | 1,222 | 1,222 | `resource_37a:0x0200155c` |
| 187 | 1,222 | 930 | `main:0x080ba978` |
| 188 | 1,218 | 1,218 | `resource_37b:0x02000554` |
| 189 | 1,218 | 996 | `main:0x0801c46c` |
| 190 | 1,210 | 1,210 | `resource_391:0x02001740` |
| 191 | 1,208 | 1,208 | `resource_3b8:0x02000b40` |
| 192 | 1,198 | 1,198 | `resource_3b1:0x020057ec` |
| 193 | 1,196 | 678 | `main:0x08004d2c` |
| 194 | 1,194 | 964 | `main:0x080a1090` |
| 195 | 1,190 | 1,190 | `resource_3bd:0x02002604` |
| 196 | 1,182 | 1,182 | `resource_3c9:0x02004738` |
| 197 | 1,180 | 1,180 | `resource_37b:0x0200101c` |
| 198 | 1,176 | 1,176 | `resource_37b:0x02000a18` |
| 199 | 1,176 | 1,176 | `resource_380:0x020043bc` |
| 200 | 1,174 | 1,174 | `resource_3bc:0x020040bc` |
| 201 | 1,170 | 1,170 | `resource_370:0x020003cc` |
| 202 | 1,170 | 1,170 | `resource_3b3:0x0200174c` |
| 203 | 1,162 | 392 | `main:0x08094730` |
| 204 | 1,160 | 908 | `main:0x080a847c` |
| 205 | 1,158 | 344 | `main:0x0808ec50` |
| 206 | 1,154 | 1,154 | `resource_37f:0x02001604` |
| 207 | 1,150 | 1,150 | `resource_375:0x020014f4` |
| 208 | 1,142 | 1,142 | `resource_373:0x02004ffc` |
| 209 | 1,136 | 908 | `main:0x080d0ee0` |
| 210 | 1,130 | 460 | `main:0x080b0070` |
| 211 | 1,126 | 1,126 | `resource_37f:0x02000f6c` |
| 212 | 1,126 | 456 | `main:0x080798b4` |
| 213 | 1,114 | 1,114 | `resource_3c7:0x02000880` |
| 214 | 1,110 | 1,110 | `resource_372:0x02003394` |
| 215 | 1,106 | 1,106 | `resource_39e:0x02001dbc` |
| 216 | 1,102 | 1,102 | `resource_3bb:0x020010dc` |
| 217 | 1,102 | 1,102 | `resource_3c9:0x02004fec` |
| 218 | 1,102 | 124 | `main:0x08003c80` |
| 219 | 1,098 | 1,098 | `main:0x080a5b94` |
| 220 | 1,096 | 1,096 | `resource_3b9:0x020011c4` |
| 221 | 1,094 | 1,094 | `resource_371:0x02000c1c` |
| 222 | 1,094 | 1,094 | `resource_3bc:0x02001474` |
| 223 | 1,094 | 378 | `main:0x0800b684` |
| 224 | 1,090 | 1,090 | `resource_372:0x020037ec` |
| 225 | 1,090 | 1,090 | `resource_39e:0x0200064c` |
| 226 | 1,082 | 148 | `main:0x080216b4` |
| 227 | 1,078 | 1,078 | `resource_373:0x020015dc` |
| 228 | 1,078 | 1,078 | `resource_373:0x020046ec` |
| 229 | 1,078 | 1,078 | `resource_399:0x020019bc` |
| 230 | 1,078 | 568 | `main:0x08078aa0` |
| 231 | 1,074 | 1,074 | `resource_3ba:0x02000db8` |
| 232 | 1,068 | 896 | `main:0x080bd424` |
| 233 | 1,066 | 780 | `main:0x08091814` |
| 234 | 1,060 | 456 | `main:0x08010000` |
| 235 | 1,054 | 1,054 | `resource_39d:0x020011e8` |
| 236 | 1,052 | 1,052 | `resource_3b1:0x02004254` |
| 237 | 1,052 | 978 | `main:0x0808bec0` |
| 238 | 1,050 | 1,050 | `resource_372:0x020028a4` |
| 239 | 1,050 | 1,050 | `resource_3aa:0x02000360` |
| 240 | 1,050 | 1,050 | `resource_3aa:0x02000cd4` |
| 241 | 1,046 | 1,046 | `resource_380:0x020027f8` |
| 242 | 1,046 | 1,046 | `resource_381:0x02001b34` |
| 243 | 1,042 | 1,042 | `resource_377:0x02000f90` |
| 244 | 1,042 | 1,042 | `resource_3a5:0x02001490` |
| 245 | 1,042 | 1,042 | `resource_3c9:0x02004bd8` |
| 246 | 1,038 | 1,038 | `resource_379:0x02000074` |
| 247 | 1,036 | 956 | `main:0x08029504` |
| 248 | 1,034 | 1,034 | `resource_39d:0x02000ddc` |
| 249 | 1,034 | 652 | `main:0x080b9724` |
| 250 | 1,030 | 1,030 | `resource_38f:0x02001a64` |
| 251 | 1,030 | 1,030 | `resource_391:0x02001bfc` |
| 252 | 1,026 | 1,026 | `resource_37b:0x02000150` |
| 253 | 1,024 | 856 | `main:0x080a5fe0` |
| 254 | 1,022 | 1,022 | `resource_3b8:0x020006dc` |
| 255 | 1,022 | 1,022 | `resource_3b8:0x02000ff8` |
| 256 | 1,022 | 464 | `main:0x08016018` |
| 257 | 1,020 | 1,020 | `resource_3b9:0x02000db0` |
| 258 | 1,014 | 1,014 | `resource_39e:0x02002ad0` |
| 259 | 1,010 | 1,010 | `resource_37a:0x02001ca0` |
| 260 | 1,006 | 1,006 | `resource_394:0x020003f0` |

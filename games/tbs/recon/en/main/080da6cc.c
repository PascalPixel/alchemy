 ...
 * closest structural template is games/tbs/src/battle/effects/member_orbit/
 ...
 * trampoline at games/tbs/asm/080072e4.s -- see games/tbs/recon/en/main/
 * 080dc1ec.json's score.note for the full derivation), and most callee
 * signatures come from that template and from games/tbs/src/battle/

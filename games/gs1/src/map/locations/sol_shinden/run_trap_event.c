...
#define RunStatueTrapEvent Func_02001a58

void RunStatueTrapEvent(void)
{
    ...
    Func_020045c0(16, 2);
    target_position = Func_0200458e(0);
    if (target_position != 0) {
        Func_020045b0(16, target_position->unkA, target_position->unk12);
    }
    Func_020045ce(16);

...
//!
//! The routine returns `Err(message)` on the first failure and records every
//! primitive call it makes into a [`Trace`] so diagnostic harnesses have a
//! corpus derived from the body rather than hand-listed beside it.

...
|---|---:|---:|
| Compiled C | 1,100 | 61,464 |
| Reconstruction assembly | 2,073 | 486,972 |
...
Within the reconstruction assembly, 462,684 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,925,924 of
8,388,608 bytes, or 94.48%. It counts exact C, deterministic asset round trips,
and positively retained structural assembly, while treating ordinary
reconstruction assembly as unfinished C work. The remaining 462,684 bytes are
...
| Byte reconstruction | 7,925,924 / 8,388,608 bytes (94.48%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 61,464 / 525,088 identified executable bytes (11.71%) | Active executable work represented as exact C |

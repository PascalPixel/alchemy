...
The current boundary, after the fourth exact-C checkpoint and full IWRAM reconstruction, is:
...
| Likely ordinary compiler output | 1,432 | 462,776 | Convert to exact C |

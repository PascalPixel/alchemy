...
/*
 * resource_3a0 owner at 0x0200013c, 472 bytes: the overlay's general
 * "spawn and fully configure" routine -- the same spawn-then-owner-record
 * shape resource_3a0_c_02000048.c/02005158.c/02005388.c already document,
 ...
 * 0x020095a4 and `idx = flags & 0xf` -- the low nibble of the `flags`
 ...
 * clear-two-bits-then-copy idiom resource_3a0_c_02000048.c's adopted
 * Func_02005a2e pair and resource_3a0_c_02005158.c already use on this

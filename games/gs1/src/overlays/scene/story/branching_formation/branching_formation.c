...
#undef GetStagedActorEffect
#undef CanStartStagedActorEffect
#undef BeginStagedActorEffect
#undef SetStagedActorEffectMode
#undef SelectStagedActorEffectSlot
#undef StartStagedActorEffectSound
#undef SetStagedActorMotionMode
#undef PrepareStagedActorEffect
#undef TestStagedActorEffectCell
#undef StartStagedActorEffectMove
#undef SetStagedActorEffectTransition
#undef WaitStagedActorEffect
#undef AdvanceStagedActorEffect
#undef WaitSceneFrames
#undef RestoreStagedActorEffect
#undef FinishStagedActorEffect_02000b1c
#undef SceneTransition_Phase
#undef StagedActor_PushActorAhead
#undef Actor_ResetMotionWhenAheadBlocked
#undef FindStagedActorProbePosition
#undef OvObj_ClearPendingAndRestoreMode
#undef Actor_UpdateRandomCounterMode
#undef SceneData_GetTableb06c
#undef SceneData_ReturnZero
#undef SceneData_GetTableb0cc
#undef SceneData_GetTableb0e4
#undef Scene_RunTile10x20Transition
#undef StagedActor_RunStepEffect
#undef Actor_PassSubjectOffsetPosition
#undef SceneData_GetTableB294
#undef FieldScene_RunScene391_02000c68
#undef Scene_RunSplitPairSteps
#undef Actor_SetPairZeroAndValue
#undef Effect_AdvanceAngleAndFinishWhenParked
#undef Effect_SpawnObject26EveryEightFrames
#undef OvObj_SelectValueByFrameBit1
#undef Actor_CheckRegionTrigger
#undef Actor_AlternateSlots13To16Field0c
...
#undef Scene_RunBranchingFormationPresentation

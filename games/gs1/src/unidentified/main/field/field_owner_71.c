...
void Func_08096d84(void *arg0) {
    ...
    *(volatile u16 *)((u8 *)arg0 + 0x64) = temp_r3;
    temp_r0 = (s16)temp_r3;
    if (temp_r0 > 0x1F) {
        Object_SetCallback((s32)arg0, Data_0809f0b0);
        return;
    }
    ...
    M2C_FIELD(arg0, s32 *, 0x10) =
        M2C_FIELD(temp_r6, s32 *, 0x10) - ((0x10000 - temp_r0) * 5) + 0x100000;
}

 ...
 * that name is kept in games/THE BROKEN SEAL/source-paths.json, but the working symbol
 ...
 * the mode from the caller's object at offset 24).  games/THE BROKEN SEAL/recon/en/
...
/* Ten halfword cell offsets indexed by a clamped depth bucket 0..9; the
   same symbol games/THE BROKEN SEAL/recon/en/main/080e7404.c already declares and

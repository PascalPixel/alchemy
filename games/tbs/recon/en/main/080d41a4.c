 ...
 * (family of games/tbs/SRC/BATTLE/EFFECT/MEMBER_ORBIT.C, owner
 ...
 * games/tbs/recon/en/dossiers.json#main:080dc1ec: a `bl` into
 * games/tbs/asm/080072e4.s's r4 veneer is an indirect call through a
 ...
 * trampoline, modeled per games/tbs/src/unidentified/main/battle/

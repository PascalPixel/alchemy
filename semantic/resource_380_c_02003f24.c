...
s32 Func_02003f24(void)
{
    ...
    Func_080770c8(324);
    for (id = 15; id <= 24; id++) {
        Func_0808a080(id)[89] = 0;
        Func_0808a1e0(id, 1);
    }
    Func_0200478c(15, 16);

    if (Func_080770c0(0x83b) != 0) {
        Func_0808a0f0(9, 0x1c80000, 0x1680000);
        Func_0808a0f0(5, 0x1b80000, 0x15a0000);
    }

    if (Func_080770c0(0x83c) != 0) {
        Func_08009180(0, 40, 43, 66, 3, 3);
        Func_08009180(83, 40, 96, 29, 3, 4);
        Func_080091c0(0, 0, 1, 1, 41, 29);
        Func_08009180(87, 42, 41, 31, 1, 2);
        Func_08009180(83, 40, 74, 29, 3, 4);
        Func_080091c0(0, 0, 1, 1, 19, 29);
        Func_08009180(87, 42, 19, 31, 1, 2);
        Func_08009180(83, 40, 96, 10, 3, 4);
        Func_080091c0(0, 0, 1, 1, 41, 10);
        Func_08009180(87, 42, 41, 12, 1, 2);
    }

    if (Func_080770c0(0x83d) != 0) {
        Func_08009180(0, 40, 43, 46, 3, 3);
        Func_08009180(83, 40, 84, 4, 3, 4);
        Func_080091c0(0, 0, 1, 1, 29, 4);
        Func_08009180(87, 42, 29, 6, 1, 2);
        Func_08009180(83, 40, 76, 21, 3, 4);
        Func_080091c0(0, 0, 1, 1, 21, 21);
        Func_08009180(87, 42, 21, 23, 1, 2);
        Func_08009180(83, 40, 76, 29, 3, 4);
        Func_080091c0(0, 0, 1, 1, 21, 29);
        Func_08009180(87, 42, 21, 31, 1, 2);
    }

    if (Func_080770c0(0x83e) != 0) {
        Func_08009180(0, 40, 13, 66, 3, 3);
        Func_08009180(83, 40, 65, 31, 3, 4);
        Func_080091c0(0, 0, 1, 1, 10, 31);
        Func_08009180(87, 42, 10, 33, 1, 2);
        Func_08009180(83, 40, 79, 9, 3, 4);
        Func_080091c0(0, 0, 1, 1, 24, 9);
        Func_08009180(87, 42, 24, 11, 1, 2);
        Func_08009180(83, 40, 91, 10, 3, 4);

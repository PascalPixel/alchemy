...
|---|---:|---:|
| Compiled C | 1,106 | 62,342 |
| Reconstruction assembly | 2,067 | 486,094 |
...
Within the reconstruction assembly, 461,650 bytes remain active
C-decompilation, boundary-splitting, or function-merging work. The other 24,444
...
The stricter build-report `byte_reconstruction` milestone is 7,926,958 of
8,388,608 bytes, or 94.50%. It counts exact C, deterministic asset round trips,
and positively retained structural assembly, while treating ordinary
reconstruction assembly as unfinished C work. The remaining 461,650 bytes are
...
| Byte reconstruction | 7,926,958 / 8,388,608 bytes (94.50%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 62,342 / 525,088 identified executable bytes (11.87%) | Active executable work represented as exact C |

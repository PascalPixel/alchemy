...
/*
 * resource_3ca owner at 0x0200003c, 8 bytes: `ldr r0, [pc, #0] / bx lr`
 * plus the one-word literal pool at 0x02000040 holding 0x2009710.
 *
 ...
 *
 * The pool word 0x2009710 is an ADDRESS, loaded and returned WITHOUT being

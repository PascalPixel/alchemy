...
{
    Func_020035d2(12, 3, 9, 16, 12, 21);

    /* movs r0,#0xc2 / lsls r0,#2 builds 0x308. */
    if (Func_02003602((s32)0x308) != 0) {
        Func_020022fc(8, 14, 25);
        Func_020035fc(16, 24, 1, 3, 20, 24);
    } else if (Func_0200362c((s32)0x309) != 0) {
        Func_02002326(8, 17, 25);
        Func_02003626(18, 24, 1, 3, 20, 24);
        Func_02003638(18, 24, 1, 3, 14, 24);
        Func_0200364a(8, 41, 1, 3, 17, 24);
    } else {
        Func_0200236a(8, 20, 25);
        Func_0200366a(16, 24, 1, 3, 14, 24);
    }

    if (Func_02003698((s32)0x30a) != 0) {
        Func_02002392(9, 13, 35);
        Func_02003692(14, 34, 1, 3, 15, 34);
    } else {
        Func_020023b2(9, 15, 35);
        Func_020036b2(14, 34, 1, 3, 13, 34);
    }

    if (Func_020036e0((s32)0x30b) != 0) {
        Func_020023da(10, 15, 22);
        Func_020036da(14, 29, 3, 1, 14, 30);
        Func_020037b8(5, 41, 3, 1, 14, 22);
        /* movs r0,#0xc3 / lsls r0,#2 builds 0x30c. */
    } else if (Func_02003714((s32)0x30c) != 0) {
        Func_0200240e(10, 15, 23);
        Func_0200370e(5, 42, 3, 1, 14, 23);
        Func_02003720(14, 29, 3, 1, 14, 30);
        Func_020037b8(10, 44, 3, 1, 14, 21);
    } else if (Func_02003756((s32)0x30d) != 0) {
        Func_02002450(10, 15, 26);
        Func_02003750(14, 29, 3, 1, 14, 22);
        Func_02003762(5, 43, 3, 1, 14, 26);
        Func_020037b8(14, 29, 3, 1, 14, 30);
    } else if (Func_0200379a((s32)0x30e) != 0) {
        Func_02002494(10, 15, 27);
        Func_02003794(14, 29, 3, 1, 14, 22);
        Func_020037a6(14, 29, 3, 1, 14, 30);
        Func_020037b8(5, 44, 3, 1, 14, 27);
    } else {
    ...
    if (Func_020037f2((s32)0x30f) != 0) {
        ...
        Func_020037ec(14, 29, 3, 1, 14, 31);
        Func_02003896(10, 40, 3, 1, 14, 23);
        /* movs r0,#0xc4 / lsls r0,#2 builds 0x310. */
    } else if (Func_02003826((s32)0x310) != 0) {
        Func_02002520(11, 15, 24);
        Func_02003820(14, 29, 3, 1, 14, 31);
        Func_02003896(10, 41, 3, 1, 14, 24);
    } else if (Func_02003858((s32)0x311) != 0) {
        Func_02002552(11, 15, 27);
        Func_02003852(14, 29, 3, 1, 14, 31);
        Func_02003896(10, 42, 3, 1, 14, 27);
    } else if (Func_0200388a((s32)0x312) != 0) {
        Func_02002584(11, 15, 28);
        Func_02003884(14, 29, 3, 1, 14, 31);
        Func_02003896(10, 43, 3, 1, 14, 28);
    } else {

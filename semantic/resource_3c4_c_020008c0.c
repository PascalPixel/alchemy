...
extern u8 * Func_020039de(s32);
extern void Func_02003a34(s32,s32,s32,s32,s32,s32);
...
s32 Func_020008c0(s32 slot)
{
    ...
    Func_02003a34(tileX, tileZ, width, depth, globalX, globalZ);

 ...
 * `cargo run --release --manifest-path tools/overlay-call-targets/Cargo.toml -- resource_39e 25b8 265c` under the
 ...
 * games/gs1/semantic/overlays/resource_39e_c_0200013c.c rather than guessed.
 *

...
extern u8 * Func_020034f6(s32);
extern void Func_02003574(s32,s32,s32,s32,s32,s32);
...
s32 Func_020008c0(s32 slot)
{
    ...
    u8 *object = Func_020034f6(slot);
    s16 kind = **(s16 **)(*(u8 **)(object + 80) + 40);
    s32 *keys = (s32 *)0x0200ada8, *delta;
    ...
    Func_02003574(tileX, tileZ, width, depth, globalX, globalZ);

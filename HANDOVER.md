...
- Semantic-C lane: **198,680 executable bytes across 445 compiling sources**:
  185,888 main bytes and 12,792 overlay bytes. Combined with exact C,
  **346,294 / 1,339,230 executable bytes** are now expressed as C, with
  992,936 remaining.

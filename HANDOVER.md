...
- Semantic-C lane: **157,270 executable bytes across 375 compiling sources**:
  145,262 main bytes and 12,008 overlay bytes. Combined with exact C,
  **295,238 / 1,338,732 executable bytes** are now expressed as C, with
  1,043,494 remaining.

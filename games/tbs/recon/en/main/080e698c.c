 ...
 *
 * Assigned family template: games/tbs/SRC/BATTLE/EFFECT/MEMBER_ORBIT.C
 ...
 * games/tbs/asm/080072e4.s (0x080072e4 + 4*2).  The retained assembly loads
 * 0x030001D8 -- the same relocated IWRAM square-root routine documented in
 * games/tbs/src/math/fixed_sqrt.c and games/tbs/src/unidentified/main/
 ...
 * (games/tbs/INCLUDE/TYPES.H), sibling of Func_080e3944

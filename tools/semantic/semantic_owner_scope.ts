...
//
//   bun tools/semantic/semantic_owner_scope.ts             # report every open owner
//   bun tools/semantic/semantic_owner_scope.ts 080d77b4    # one owner, with its rows
//   bun tools/semantic/semantic_owner_scope.ts --json      # machine-readable
//   bun tools/semantic/semantic_owner_scope.ts --self-test
//

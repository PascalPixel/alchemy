...
/*
 * Resource 3b3 3-D distance helper at 0x02000314 (56 bytes, 1 call).
 *
 ...
 * overlay's own `call_via` slot (0x2002bc8 here), which is the only thing
 ...
 * `cargo run --release --manifest-path tools/overlay-call-targets/Cargo.toml -- resource_3b3 0314 034c`: one site,

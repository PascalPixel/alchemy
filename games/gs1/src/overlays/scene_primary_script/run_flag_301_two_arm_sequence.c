...
#define FieldScene_RunFlag301TwoArmSequence Func_02000540
...
extern void Func_0200434e_a(s32);
...
void Func_02000540(void)
{
    ...
    Func_020042c2();
    {
        ...
        Func_02004226(37, 7, 1, 4, x, y);
    }
    {
        s32 x = 37;
        s32 y = 7;

        Func_02004238(36, 7, 1, 4, x, y);
    }
    t = Value1(Func_0200429e, 0x301);
    if (t != 0) {
        Func_020042f0();

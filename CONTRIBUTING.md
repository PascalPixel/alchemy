...
- **Unfinished scopes:** 2,130
- **Address spaces scanned:** 97 (87 still contain targets)
- **Target bytes:** 995,932 semantic-C or unresolved-assembly bytes
- **Resolved-only bytes:** 347,662 Exact C or audited permanent assembly bytes
- **Executable bytes accounted for:** 1,347,122

### Main target list

This table contains every scope of at least 1,000 bytes (227 rows). The complete
2,130-row index, including the smallest audited owners, is

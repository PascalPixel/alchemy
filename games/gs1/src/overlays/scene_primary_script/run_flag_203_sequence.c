...
extern s32 Func_02004e78(s32 flagId);
extern void Func_02004e78_a();
...
extern s32 Func_02004e20(s32 callback, s32 delay);
...
static __inline__ void Call6(void (*f)(), s32 a0, s32 a1, s32 a2, s32 a3,
                             s32 a4, s32 a5)
{
    f(a0, a1, a2, a3, a4, a5);
}

void FieldScene_RunFlag203Sequence(void)
{
    s32 rec5 = Value1(Func_02004e78, 0x203);
    ...
    Func_02004ec4(20);
    {
        ...
        Call6(Func_02004e78_a, 73, 10, 60, 10, arg4, arg5);
    }
    Func_02004ede(20);
    Func_02004e20(0x0200a231, 3200);
    Func_02004eee(40);

    if (Value1(Func_02004edc, 0x201) != 0) {
        ...
        *(s32 *)(actor12 + 108) = rec5;
        {
            s32 arg4 = 18;
            s32 arg5 = 13;

            Call6(Func_02004eec, 17, 13, 1, 1, arg4, arg5);
        }
        Func_02004f2a(0x201);
        Func_02004f9a(12, 0);
        Func_02004f6a(12, 1);
    ...
    Func_02004f56(20);
    {
        ...
        Call6(Func_02004f0a, 72, 10, 60, 10, arg4, arg5);
    }
    Func_02004f70(20);
    Func_02004f84();
}

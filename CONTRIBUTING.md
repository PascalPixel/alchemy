...
- **Unfinished scopes:** 2,117
- **Address spaces scanned:** 97 (87 still contain targets)
- **Target bytes:** 994,796 semantic-C or unresolved-assembly bytes
- **Resolved-only bytes:** 348,798 Exact C or audited permanent assembly bytes
- **Executable bytes accounted for:** 1,347,122

### Main target list

This table contains every scope of at least 1,000 bytes (227 rows). The complete
2,117-row index, including the smallest audited owners, is

...
- **Unfinished scopes:** 2,150
- **Address spaces scanned:** 97 (87 still contain targets)
- **Target bytes:** 999,634 semantic-C or unresolved-assembly bytes
- **Resolved-only bytes:** 343,960 Exact C or audited permanent assembly bytes
- **Executable bytes accounted for:** 1,347,122

### Main target list

This table contains every scope of at least 1,000 bytes (227 rows). The complete
2,150-row index, including the smallest audited owners, is

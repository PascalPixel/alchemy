...
void *Func_0200019c(void)
{
    ...
    if (room == 0x6b) {
        if (Func_080770c0(0x93e) != 0) {
            return Data_02009fa0;
        }
        return Data_02009e80;
    }

    if (room == 0x70) {
        /* movs r0,#149 / lsls r0,r0,#4 == 0x950 */
        if (Func_080770c0(0x950) != 0) {
            return Data_0200a120;
        }
        return Data_0200a018;
    }

    if (room == 0x6c) {
        if (Func_080770c0(0x950) != 0) {
            return Data_0200a390;
        }
        if (Func_080770c0(0x93e) != 0) {
            return Data_0200a30c;
        }
        return Data_0200a24c;
    }

    return Data_02009e74;
}

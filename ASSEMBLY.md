...
The current boundary, after the sixth exact-C checkpoint and full IWRAM reconstruction, is:
...
| Likely ordinary compiler output | 1,419 | 462,182 | Convert to exact C |

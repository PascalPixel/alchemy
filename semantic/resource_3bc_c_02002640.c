 ...
 * cover it -- resolved with `bun tools/overlay-show resource_3bc 2640 |
 * cargo run --release --manifest-path tools/overlay-call-targets/Cargo.toml -- resource_3bc 2640 270e --annotate`):

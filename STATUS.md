...
|---|---:|---:|
| Compiled C | 1,227 | 72,600 |
| Reconstruction assembly | 1,947 | 475,836 |
...
Within the reconstruction assembly, 451,074 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,937,534 of
...
| Byte reconstruction | 7,937,534 / 8,388,608 bytes (94.62%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 72,600 / 523,674 identified executable bytes (13.86%) | Active executable work represented as exact C |

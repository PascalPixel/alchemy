/*
 * Resource 39a overlay routine at 0x02000ec0.
 *
 * Complete owner: `push {lr}` at 0x02000ec0 and `pop {r0} / bx r0` at
 * 0x02000ed2, so the owner returns nothing.
 *

...
|---|---:|---:|
| Compiled C | 1,128 | 64,408 |
| Reconstruction assembly | 2,045 | 484,028 |
...
Within the reconstruction assembly, 459,348 bytes remain active
C-decompilation, boundary-splitting, or function-merging work. The other 24,680
...
The stricter build-report `byte_reconstruction` milestone is 7,929,260 of
8,388,608 bytes, or 94.52%. It counts exact C, deterministic asset round trips,
and positively retained structural assembly, while treating ordinary
reconstruction assembly as unfinished C work. The remaining 459,348 bytes are
...
| Byte reconstruction | 7,929,260 / 8,388,608 bytes (94.52%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 64,408 / 525,088 identified executable bytes (12.27%) | Active executable work represented as exact C |

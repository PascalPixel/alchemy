...
The current boundary, after the fifth exact-C checkpoint and full IWRAM reconstruction, is:
...
| Likely ordinary compiler output | 1,422 | 462,258 | Convert to exact C |

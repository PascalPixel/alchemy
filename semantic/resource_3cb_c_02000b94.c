...
s32 Func_02000b94(void)
{
    ...
    Func_020023de();
    Func_02002428(8, *(u32 *)&Data_02000240[500], 0);

    if (Func_02000c3e(0) == 0) {
        Func_020022d0(1);
    }

    if (Func_02000c4e(0) == 0) {
        Func_02000cf4(5);
        Func_02000c0c();

        if (Func_020023e2(0x173) != 0) {
            reply = cue + 3;
            goto emit;
        }
        ...
        if (Func_02002444(0, 0) == 0) {
            Func_0200242c(1000, 0);
            Func_0200241a(0x173);
            Func_0200242a(370);
            Func_02002432(364);
            Func_02002430(0x202);
    ...
    if (Func_02002450(0x173) != 0) {
        Func_02000d76(0);
        Func_020024d8(0x293d);
        Func_020024e8(8, 0);
        Func_0200247e(0x202);
        Func_02002484(0x173);
    }

    if (Func_0200247a(0x202) != 0) {
        reply = cue + 3;
        goto emit;
    }

    if (Func_020024fc(0x201) == 0 && Func_0200250c(768) == 0) {
        Func_02002494(cue);
        Func_020024a0(8, 0);
        Func_02002522(768);
        goto done;
    ...
    if (Func_02002554(0, 0) != 0) {
        Func_02002564(cue);
        Func_02002534(8, 0);
        goto done;
    }

    if (Func_02000d76_b(0) == 0) {
        Func_0200250a(0x205);
        goto done;
    }

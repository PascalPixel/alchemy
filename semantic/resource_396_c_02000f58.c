...
void Func_02000f58(s32 runEncounter)
{
    ...
    if (Func_02002a40(0x844) != 0) {
        Func_02002a20(121, 34, 3, 1, 93, 10);
        Func_02002a34(46, 38, 1, 1, 30, 43);
        Func_02002a4e(0, 0, 1, 2, 30, 9);
        Func_02002a60(26, 3, 1, 2, 10, 8);
        Func_02002a6a(26, 35, 1, 4, 10, 40);
    } else {
        Func_02002a88(11, 8, 1, 2, 10, 8);
    }
}

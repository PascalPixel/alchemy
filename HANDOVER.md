...
- Semantic-C lane: **180,334 executable bytes across 410 compiling sources**:
  168,326 main bytes and 12,008 overlay bytes. Combined with exact C,
  **323,682 / 1,338,892 executable bytes** are now expressed as C, with
  1,015,210 remaining.

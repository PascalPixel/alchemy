 ...
 *
 * The family matcher assigned games/tbs/src/battle/effects/member_orbit/
 ...
 * match the same subsystem already recovered across games/tbs/recon/en/
 ...
 * RNG, and (per games/tbs/recon/en/dossiers.json#main:080e01e4's already-resolved
 * derivation) Func_080072f4 is not a real callee -- it is the r4 slot of
 * the _call_via_rN trampoline at games/tbs/asm/080072e4.s, so every call

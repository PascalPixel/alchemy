...
- Semantic-C lane: **177,742 executable bytes across 400 compiling sources**:
  165,734 main bytes and 12,008 overlay bytes. Combined with exact C,
  **319,342 / 1,338,892 executable bytes** are now expressed as C, with
  1,019,550 remaining.

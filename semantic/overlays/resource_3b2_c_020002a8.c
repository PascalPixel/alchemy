...
/*
 * resource_3b2 owner at 0x020002a8, 164 bytes: probe the square ahead of an
 ...
 *
 * What was changed:
 *  - the packed direction table 0x0200e190 becomes 0x0200b15c (file offset
 *    0x315c under the proven 0x02008000 link base).  Corroborated: this
 *    overlay's 0x020000c4 and 0x02000474 owners load the same address for the
 *    same table.
 *  - the passable-kind list 0x0200e1d0 becomes 0x0200b19c (offset 0x319c),
 ...
 *    resource_3b2 02a8': two sites, 0x0200006c (this overlay's own tile-occupant
...
#define PROBE_DIRECTION_STEPS ((const s32 *)0x0200b15c)

/* Six identifiers whose presence suppresses the motion cancellation. */
#define PROBE_PASSABLE_KINDS ((const s32 *)0x0200b19c)

...
|---|---:|---:|
| Compiled C | 1,056 | 55,992 |
| Reconstruction assembly | 2,115 | 492,444 |
...
Within the reconstruction assembly, 469,096 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,919,368 of
...
reconstruction assembly as unfinished C work. The remaining 469,096 bytes are
...
| Byte reconstruction | 7,919,368 / 8,388,608 bytes (94.41%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 55,992 / 525,088 identified executable bytes (10.66%) | Active executable work represented as exact C |

...
/*
 * resource_3b4 owner at 0x02001ca0, 42 bytes.
 *
 * Repaint one collision cell and clear slot 10's byte at +85.  Same shape as
 * the 0x02001a48 family but a different slot and a different marker byte;
 * 0x02001ccc is its sibling.
 */

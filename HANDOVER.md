...
- Semantic-C lane: **182,702 executable bytes across 416 compiling sources**:
  170,694 main bytes and 12,008 overlay bytes. Combined with exact C,
  **326,824 / 1,338,908 executable bytes** are now expressed as C, with
  1,012,084 remaining.

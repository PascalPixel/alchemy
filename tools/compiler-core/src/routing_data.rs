...
pub static OPTIMIZE_O1_OVERLAY_SOURCES: &[&str] = &["exact/resource_3ab_c_020007f4.c"];
...
pub static NO_THREAD_JUMPS_OVERLAY_SOURCES: &[&str] = &["exact/resource_3c4_c_02001aba.c"];

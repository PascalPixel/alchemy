...
/*
 * Resource 386 approach guard at 0x020003c8 — member 0 of a four-member
 * family (0x0200_0380, 0x0200_03c8, 0x0200_0410, 0x0200_0458).
 *
 * Complete owner: `push {r5, lr}` at 0x020003c8, interworking return
 ...
 * are the literal pool (0xffff5fff, 0x00003ffe, 0x00001ce4) plus one
 ...
 *
 * Link base 0x02008000; 0x0200 803c8 in the overlay's handler pool is
 * `Func_020003c8 + 1`, which named this row as a scene handler in advance.
 *

...
//
//   bun tools/overlay/overlay_twins.ts                    # every twin group
//   bun tools/overlay/overlay_twins.ts resource_383       # groups touching one overlay
//   bun tools/overlay/overlay_twins.ts --unconverted      # only groups with work left
//   bun tools/overlay/overlay_twins.ts --semantic --unconverted
//                                                # reviewed-C templates too
//   bun tools/overlay/overlay_twins.ts --leads            # families with no member solved
//   bun tools/overlay/overlay_twins.ts --self-test
import { existsSync, readFileSync, readdirSync } from "node:fs";
import { dirname, join } from "node:path";
import { assembleOverlay, overlayCSpans } from "../lib/overlay_disasm.ts";

...
- Semantic-C lane: **176,886 executable bytes across 397 compiling sources**:
  164,878 main bytes and 12,008 overlay bytes. Combined with exact C,
  **317,958 / 1,338,820 executable bytes** are now expressed as C, with
  1,020,862 remaining.

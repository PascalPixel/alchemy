...
- Semantic-C lane: **162,290 executable bytes across 378 compiling sources**:
  150,282 main bytes and 12,008 overlay bytes. Combined with exact C,
  **300,258 / 1,338,732 executable bytes** are now expressed as C, with
  1,038,474 remaining.

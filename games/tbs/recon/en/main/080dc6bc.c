 ...
 * games/tbs/SRC/BATTLE/EFFECT/MEMBER_ORBIT.C).  The prologue (cursor-
 ...
 * games/tbs/recon/en/main/080e7404.c, 080d59b0.c, 080d82b0.c, 080dc1ec.c,
 * 080e01e4.c and the already-adopted games/tbs/src/battle/effects/
 ...
 * effect state's member list (games/tbs/asm/080dc6bc.s reads the same
 ...
 * fourteen-slot `_call_via_rN` trampoline bundle at games/tbs/asm/

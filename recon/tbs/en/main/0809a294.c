/* Draft, not exact (2026-09-24): 304 of 304 bytes, 77 differing halfwords.
   ...
   and count-up loops, every declaration order. The twin at main:08098954 is the same
   function with the other item-break spawner. */
#include "TYPES.H"
#include "SYSTEM.H"

#define BattleEffect_RunItemBreakScatterMode1 Func_0809a294
...
void BattleEffect_RunItemBreakScatterMode1(void)
{

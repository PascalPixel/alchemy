 ...
 * in the second.  This one stores the operand as the track field at 0x12 and raises the two low request bits.
 *
...
u8 Func_080f9ab4(struct Track_080f9ba4 *track);

void Func_080f9ba4(void *player, struct Track_080f9ba4 *track)
{
    track->parameter_12 = Func_080f9ab4(track);
    track->status |= 3;
}

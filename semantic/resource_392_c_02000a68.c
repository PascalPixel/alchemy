 ...
 * (bun tools/overlay_driver.ts resource_392), so the loader enters
 ...
 * always run Func_020008c0 on records 8, 9 and 10; unless flag 0x845
 * is set, run Func_02000abc(11); return 0.  Both gates are
 ...
 * Returns a literal 0.
 *
 * Local callees: Func_02000cb4 is already drafted
 * (resource_392_c_02000cb4.c); Func_020008c0 and Func_02000abc are
 * not yet owned and are declared here only.
 *
 * Uncertainty: the flag ids are literal, and the record ids 8/9/10
 * and 11 are passed through unexamined -- what Func_020008c0 and

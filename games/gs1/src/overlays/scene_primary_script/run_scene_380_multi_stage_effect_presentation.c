...
void FieldScene_RunMultiStageEffectPresentation(void)
{
    u32 i;
    s32 rec7;
    s32 record;
    ...
    *(s32 *)((*(u8 **)0x03001ebc + 0x1c0)) = 0x202;
    ...
    record = 0x2c80000;
    Func_020052e8(20);
    rec7 = Value4(Func_02004bc6, 221, record, 0x100000, 0x900000);
    Func_02005302(40);
    Func_0200529a(rec7, 1);
    base5_1076 = (s32)Data_00001076;
    Value2(Func_0200529c, base5_1076, 1);
    ...
    Func_02005430(base5_1076 - 2);
    Func_02004c2c(9, 20);
    Func_020054d4();
    Func_020054e0();
    Call4(Func_020054a8, record, -1, 0x980000, 0);
    Func_020052d4();
    Func_0200526a(1);
    Func_020054ee();
    Func_02005502();

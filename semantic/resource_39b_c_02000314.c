...
/*
 * Resource 39b 3-D distance helper at 0x02000314 (56 bytes, 1 call).
 *
 ...
 * overlay's own `call_via` slot (0x2002628 here), which is the only thing
 ...
 * `cargo run --release --manifest-path tools/overlay-call-targets/Cargo.toml -- resource_39b 0314 034c`: one site,

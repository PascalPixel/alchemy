 ...
 * own table does not cover it -- resolved with `bun tools/overlay-show
 * resource_3bc 4628 | cargo run --release --manifest-path tools/overlay-call-targets/Cargo.toml -- resource_3bc 4628
 * 477e --annotate`):

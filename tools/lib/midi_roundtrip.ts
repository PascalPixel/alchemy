...
//
// 目的: エンジン固有の sequence-JSON (tools/assets/music_sequence.ts のコーデック) を
...
//
// 使い方:  bun tools/assets/midi_roundtrip.ts            # 2曲を往復し結果を out/ に出力
//          bun tools/assets/midi_roundtrip.ts --self-test

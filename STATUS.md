...
|---|---:|---:|
| Compiled C | 1,032 | 53,094 |
| Reconstruction assembly | 2,139 | 495,342 |
...
Within the reconstruction assembly, 471,994 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,916,614 of
8,388,608 bytes, or 94.37%. It counts exact C, deterministic asset round trips,
and positively retained structural assembly, while treating ordinary
reconstruction assembly as unfinished C work. The remaining 471,994 bytes are
...
| Byte reconstruction | 7,916,614 / 8,388,608 bytes (94.37%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 53,094 / 525,088 identified executable bytes (10.11%) | Active executable work represented as exact C |

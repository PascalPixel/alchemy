...
- Semantic-C lane: **221,220 executable bytes across 489 compiling sources**:
  208,428 main bytes and 12,792 overlay bytes. Combined with exact C,
  **368,834 / 1,339,230 executable bytes** are now expressed as C, with
  970,396 remaining.

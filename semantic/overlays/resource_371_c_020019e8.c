 ...
 * 0x927).
 *
 * One of three byte-identical bodies — this one and 0x02001888 and 0x02001938 — that
 * differ only in the single immediate at +0x8a (105 here).  Their `bl`
 ...
 * frame counter at +0x64, then spin on `Func_02005bde(1)` until that counter

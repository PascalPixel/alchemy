...
|---|---:|---:|
| Compiled C | 1,138 | 65,440 |
| Reconstruction assembly | 2,035 | 482,996 |
...
Within the reconstruction assembly, 458,284 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,930,324 of
...
reconstruction assembly as unfinished C work. The remaining 458,284 bytes are
...
| Byte reconstruction | 7,930,324 / 8,388,608 bytes (94.54%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 65,440 / 523,724 identified executable bytes (12.50%) | Active executable work represented as exact C |

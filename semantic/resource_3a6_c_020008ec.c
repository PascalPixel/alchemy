...
/* Complete 696-byte placement owner.  This resource starts with the unusual
 * stack reservation at 08ec before its saved-register prologue;
 * all 31 calls, including the callback, remain explicit and ordered. */
void Func_020008ec(s32 deltaIndex, s32 objectIndex, s32 x, s32 y, s32 z,
                   void (*callback)(void))
{
    const s32 *deltaTable = (const s32 *)0x02009ea0;

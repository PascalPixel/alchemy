#include "TYPES.H"
struct Actor { u8 unk[6]; u16 angle; s32 pos[4]; s32 scale_x; s32 scale_y; };
...
struct Actor *Func_0200c2fc(s32);
...
s32 WorldMap_EnterScene(void)
{
    ...
    if (Data_02000240[225] == 90) {
        Func_0200b9fc(0);
        Func_0200c404(58, 1);
    } else if (Data_02000240[225] == 91) {
        Func_0200b9fc(1);
        Func_0200c404(187, 93);
    } else if (Data_02000240[225] == 78) {
        Func_0200c2dc();
        Func_0200c2cc(242);
        Func_0200c40c(112);
    } else {
        Func_0200c294(0x144);
        Data_03001ebc[112] = 0x400;
        Data_03001ebc[114] = 16;
        Func_0200c184(1);
        ...
        case 33:
            if (Func_0200c28c(0x109)) {
                if (!Func_0200c28c(0x85d) && Func_0200c28c(564)) {
                    ...
                    Func_0200c2fc(Data_0200e79c)->angle=0x3000;

...
void Func_02003788(u8 *object, s32 mode);
void Func_02003860(u8 *object, s32 mode);
void Func_020037a0(u8 *object, s32 mode);

u8 *Func_020009f4(s32 x, s32 y, s32 z, s32 kind)
{
    u8 *result;
    u8 *object = Func_0200373a(kind, x, y, z);
    ...
    if (object != 0) {
        ...
        object[85] = 0;
        object[89] = 8;
        Func_02003788(object, 0);
        Func_02003860(object, 14);
        Func_020037a0(object, 1);
        result = object;
    } else {
        result = 0;
    }

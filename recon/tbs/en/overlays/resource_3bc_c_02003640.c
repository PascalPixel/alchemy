/* NONMATCHING: 476 bytes, candidate 476, 119 differing halfwords, 47
 * halfword edits (2026-09-25). KorosseoMaruta_Func02003640, meant for
 * FIELD/KOROSSEO_MARUTA/F_03640.C as a single-overlay unit binding its names
 * at their runtime addresses (an import veneer's listing offset plus
 * 0x8000). Remaining: ported from 3ba:02002910 twin at matching 476 size;
 * same 47-edit residual (0xf3 vs negs mask, IO-queue count store schedule)
 * WALL: copy_versus_rematerialise: IO-queue count store schedule and
 * 0xf3-vs-negs blend mask; same wall as twin 3ba:02002910 */
#include "TYPES.H"
...
void KorosseoMaruta_Func02003640(s32 id, s32 x, s32 z)
{
    u8 *state;
    u8 *actor;
    u8 *sprite;

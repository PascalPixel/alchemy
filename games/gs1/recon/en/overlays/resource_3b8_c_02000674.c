...
extern u8 Data_00000140[];
extern u8 Data_00001140[];
extern u8 Data_00002280[];
void Func_020049da();
void Func_02004a58();
void Func_02004a62();
s32 Func_02004a84();
...
void FieldScene_RunScene3b8SequenceB(void)
{
    ...
    Func_02004a58();
    Func_02004b16((s32)Data_00002280);
    v5 = 0;
    *(u8 *)(Func_02004a84(0) + 84) = v5;
    *(u8 *)(Func_02004a90(10) + 84) = v5;
    v5 = 128;
    Func_020049da(1);
    *(u16 *)((v5 << 19)) = (s32)Data_00001140;
    Call2(Func_02004b54, -1, 0);
    *(u16 *)((v5 << 19)) = (s32)Data_00000140;
    v5 = 1;
    ...
    *(s32 *)(*(s32 *)base6_3001ebc + 0x1c8) = 60;
    Func_02004c34();
    Func_02004c40();
    Func_02004b26(20);
    *(s32 *)(*(s32 *)base6_3001ebc + 0x1c8) = 24;

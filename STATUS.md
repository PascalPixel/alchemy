...
|---|---:|---:|
| Compiled C | 1,139 | 65,500 |
| Reconstruction assembly | 2,034 | 482,936 |
...
Within the reconstruction assembly, 458,224 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,930,384 of
...
reconstruction assembly as unfinished C work. The remaining 458,224 bytes are
...
| Byte reconstruction | 7,930,384 / 8,388,608 bytes (94.54%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 65,500 / 523,724 identified executable bytes (12.51%) | Active executable work represented as exact C |

...
#define Actor_FaceTowardActorZero Func_02000aa8
u8 *Func_02002ff0();
s32 Func_02002f42();
...
#undef Actor_FaceTowardActorZero

/* overlays/scene/actor/staged_step/actor_position.c */
#define Actor_TrackOriginColumnForSlot Func_0200152c
#define Actor_RunWhenActor9AtTile45x43 Func_02001c28
#define ActorDraw_PlaceActorFourteenOnActorNine Func_02001e94
#define Actor_PassActorNinePositionWithId107 Func_02001ec0
struct Actor {
    s32 f00;
    s32 f04;
    s32 f08;
...
#undef Actor_TrackOriginColumnForSlot
#undef Actor_RunWhenActor9AtTile45x43
#undef ActorDraw_PlaceActorFourteenOnActorNine
#undef Actor_PassActorNinePositionWithId107

/* overlays/scene/actor/staged_step/actor_presentation.c */
#define Actor_SetActor15ModeZero Func_020009dc
#define ActorDraw_SetSceneCell58AndMarkActorEight Func_02001a48
#define ActorDraw_RepaintCellsAtActorsElevenAndTwelve Func_02001df8
#define Actor_PublishMarkerBySlotZeroHeight Func_02001edc
...
#undef Actor_SetActor15ModeZero
#undef ActorDraw_SetSceneCell58AndMarkActorEight
#undef ActorDraw_RepaintCellsAtActorsElevenAndTwelve
#undef Actor_PublishMarkerBySlotZeroHeight

/* overlays/scene/actor/staged_step/display.c */
#define SetBlendAlphaCoefficients Func_020018c0
#define Effect_SetBlendAlpha0607 Func_020018d0
...
#undef SetBlendAlphaCoefficients
#undef Effect_SetBlendAlpha0607

/* overlays/scene/actor/staged_step/facing_target_scene.c */
#define State_BranchOnActorZeroFacing Func_020019cc
#define Actor_BranchOnSlotZeroAtTile38 Func_02001b60
#define Scene_DispatchByActorZeroFacing Func_02001d78
struct Slot {
    u16 f00;
    u16 f02;
    u16 f04;
...
struct Slot *Func_02003f12(s32);
void Func_02003fa4(void);
void Func_02003542(void);
s32 *Func_020040a6();
s32 *Func_020040ae();
void Func_02004174();
void Func_0200417a();
...
void Func_02001c78();
void Func_02003680();
struct Slot *Func_020042be(s32);
void Func_02004322(s32, s32, s32);
void Func_02003afc(void);
...
#undef State_BranchOnActorZeroFacing
#undef Actor_BranchOnSlotZeroAtTile38
#undef Scene_DispatchByActorZeroFacing

/* overlays/scene/actor/staged_step/move_and_redraw.c */
#define Data_0200e1e8 Data_0200a69c
#define Data_0200e190 Data_0200a644
#define Func_02006610 Func_02002b6c
#define Func_0200661c Func_02002b78
#define Func_020066b4 Func_02002c10
#define Func_02006714 Func_02002c50
#define Func_0200668a Func_02002bf6
#define Func_0200672c Func_02002c68
#define Func_020066ea Func_02002c46
#define Func_020066c4 Func_02002c30
#define RefreshStagedActor Func_02002c68_a
#define Func_02006614 Func_02002bc8
#define Func_0200661e Func_02002bd2
#define Func_0200687c Func_02002d30
#define Func_02006658 Func_02002bfc
#define Func_02006776 Func_02002cb2
#define Func_0200678e Func_02002cca
#define Func_02006740 Func_02002c9c
#define Func_020067a4 Func_02002ce0
#define Func_020067bc Func_02002cf8
#define Func_020067d4 Func_02002d10
#define Func_0200677a Func_02002cd6
#define Func_020068f4 Func_02002da8
#define Func_020068fa Func_02002dae
#define Func_020066b8 Func_02002c6c
#define Func_02006752 Func_02002cee
#define Func_020067ae Func_02002d4a
#define Func_020069d0 Func_02002e84
...
#undef SceneData_SelectTableA898ByRuntimeSelector
#undef SceneData_ReturnZero
#undef SceneData_GetTablea970

/* overlays/scene/actor/staged_step/scene_primary_script.c */
#define FieldScene_RunScene3b4_02000ad0 Func_02000ad0
#define FieldScene_RunScene3b4_02000b68 Func_02000b68
#define FieldScene_RunScene3b4_02000ccc Func_02000ccc
#define FieldScene_RunScene3b4_02000fdc Func_02000fdc
#define Scene_RunScene3b4SequenceC Func_02001070
#define Scene_RunSupplementalSequenceOne Func_0200138c
#define Scene_RunScene3b4SequenceA Func_0200149c
#define Scene_RunPrimarySequence Func_020015f0
#define Scene_RunScene3b4SequenceB Func_02001838
#define FieldScene_RunScene3b4_02001bc4 Func_02001bc4
#define FieldScene_RunScene3b4_02002188 Func_02002188
#define FieldScene_RunScene3b4_02002290 Func_02002290
#define FieldScene_RunScene3b4_02002334 Func_02002334
extern u8 Data_03001ebc[];
extern u8 Data_02000240[];

s32 Func_02002fde();
void Func_02002ff0_a();
void Func_0200300c();
void Func_0200303e();
void Func_02003074();
s32 Func_02003078();
...
s32 Func_02003082();
void Func_02003098();
void Func_020030b4_a();
void Func_020030e8();
void Func_0200311e();
s32 Func_02003122();
void Func_02003132_a();
void Func_02003148();
void Func_02003148_a();
void Func_0200314a();
void Func_0200314e();
void Func_02003156();
...
void FieldScene_RunScene3b4_02000b68(void)
{
    ...
    if (Value1(Func_02003076, 0x9c8) == 0) {
        ...
        if (rec8 != 0) {
            ...
            Func_02003160(15, 1);
            Func_0200315c();
            Call3(Func_02003148_a, 15, 0x4000, 20);
            ...
            *(volatile s32 *)(record + 40) = 0xa0000;
            ...
            Func_0200318c(20);
            Call3(Func_02003162_a, -1, -1, 0xe666);
            Func_020031a0(30);
...
void FieldScene_RunScene3b4_02000fdc(s32 a0)
{
    ...
    if ((a0 & 0x100) != 0) {
        Func_020035ee(157);
        Call3_02000fdc(Func_020034e6, 0x20000, 0x20000, 0x10000);
        Call3_02000fdc(Func_020034f4, -1, -1, 0xe666);
...
void Scene_RunPrimarySequence(void)
{
    ...
    if (*(s16 *)((base3_2000240 + 0x24a)) != 10) {
        ...
        Func_02003c1c(188);
        record = Value1_020015f0(Func_02003b62, 0);
        if (record != 0) {
...
void FieldScene_RunScene3b4_02002188(void)
{
    ...
    Func_02004272(9, 244);
    Func_0200427a(8, 244);
    if (Value1_02002188(Func_020046c4, 0xee7) == 0) {
        Call3(Func_02004746, 8, 0xe80000, 0x3680000);
    }
    if (Value1_02002188(Func_020046dc, 0xee8) == 0) {
        Call3(Func_0200475e, 9, 0x1280000, 0x3380000);
    }
    if (Value1_02002188(Func_020046f4, 0xee9) == 0) {
        Call3(Func_02004776, 10, 0x1480000, 0x2f80000);
    }
    if (Value1_02002188(Func_0200470c, 0xeea) == 0) {
        Call3(Func_0200478e, 11, 0x1680000, 0x3680000);
    }
    if (Value1_02002188(Func_02004726, 0x9c0) != 0) {
        Func_02003168_a(0);
    }
    if (Value1_02002188(Func_02004736, 0x9c1) != 0) {
        Func_02003178(1);
    }
    if (Value1_02002188(Func_02004746_a, 0x9c2) != 0) {
        Func_02003188(2);
    }
    if (Value1_02002188(Func_02004756, 0x9c3) != 0) {
        Func_02003198(3);
    }
    if (Value1_02002188(Func_02004766, 0x9c4) != 0) {
        Func_02003244(0);
    }
}
...
void FieldScene_RunScene3b4_02002290(void)
{
    ...
    *(volatile s32 *)(record + 24) = 0xb333;
    record = Value1_02002290(Func_0200480a, 9);
    *(volatile s32 *)(record + 24) = 0xb333;
    record = Value1_02002290(Func_02004812, 10);
    *(volatile s32 *)(record + 24) = 0xb333;
    record = Value1_02002290(Func_0200481a, 11);
    *(volatile s32 *)(record + 24) = 0xb333;
...
void FieldScene_RunScene3b4_02002334(void)
{
    ...
    *(u8 *)(Func_0200487a(14) + 85) = 0;
    ...
    if (Value1_02002334(Func_0200486c, 0xed9) != 0) {
        Func_020048f0(14, 2);
    }
    Func_02003e3c();
    Func_02003fa0();
    ...
    *(u8 *)(Func_020048dc(12) + 85) = 0;
    Func_0200419c();
    if (Value1_02002334(Func_020048b4, 0x200) != 0) {
        Func_02003d38();
        Func_0200493c(13, 5);
    }
    if (Value1_02002334(Func_020048ca, 0x109) == 0) {
        rec7 = Value1_02002334(Func_020048d4, 0x9ca);
        if (rec7 != 0) {
            Call3(Func_02004958, 15, 0x3580000, 0x3380000);
            record = Func_02004926(15);
            *(volatile s32 *)(record + 108) = 0x2008aa9;
        } else {
            if (Value1_02002334(Func_020048fa, 0x9c9) != 0) {
                Call3(Func_0200497c, 15, 0x3780000, 0x2980000);
                record = Value1_02002334(Func_0200494a, 15);
                *(volatile u16 *)(*(volatile s32 *)(record + 80) + 30) = rec7;
                Func_020048c4(record, 16);
            } else {
                if (Value1_02002334(Func_02004924, 0x9c8) != 0) {
...
#undef FieldScene_RunScene3b4_02000ad0
#undef FieldScene_RunScene3b4_02000b68
#undef FieldScene_RunScene3b4_02000ccc
#undef FieldScene_RunScene3b4_02000fdc
#undef Scene_RunScene3b4SequenceC
#undef Scene_RunSupplementalSequenceOne
#undef Scene_RunScene3b4SequenceA
#undef Scene_RunPrimarySequence
#undef Scene_RunScene3b4SequenceB
#undef FieldScene_RunScene3b4_02001bc4
#undef FieldScene_RunScene3b4_02002188
#undef FieldScene_RunScene3b4_02002290
#undef FieldScene_RunScene3b4_02002334

/* overlays/scene/actor/staged_step/scene_setup.c */
#define Scene_RunActor15ZeroStep Func_02000ec8
#define Scene_RunLateIndexedStep0 Func_020015cc
#define Scene_RunLateIndexedStep1 Func_020015d8
#define Scene_RunLateIndexedStep2 Func_020015e4
#define State_ApplyRectAndSetSlotEightByte35 Func_02001a9c
#define Scene_RunTwoStepSequence Func_02001c5c
#define State_ApplyRectAndClearSlotTenByte85 Func_02001ca0
#define Scene_RunThreeCallSequenceB Func_02001d64
#define Scene_RunThreeCallSequence Func_02001e60
#define Scene_RunThreeStepSequence Func_02001e80
...
#undef Scene_RunActor15ZeroStep
#undef Scene_RunLateIndexedStep0
#undef Scene_RunLateIndexedStep1
#undef Scene_RunLateIndexedStep2
#undef State_ApplyRectAndSetSlotEightByte35
#undef Scene_RunTwoStepSequence
#undef State_ApplyRectAndClearSlotTenByte85
#undef Scene_RunThreeCallSequenceB
#undef Scene_RunThreeCallSequence
#undef Scene_RunThreeStepSequence

/* overlays/scene/actor/staged_step/scene_state_interaction.c */
#define Scene_DispatchBySlotZeroFacing Func_020018e0
#define State_ApplyRectAndSetActor8Byte35 Func_02001a70
#define State_ApplyFourRectsAt48_55 Func_02001da0
s32 *Func_02003e28();
s32 Func_02003e00();
void Func_02003de8();
void Func_02003e2e();
...
#undef Scene_DispatchBySlotZeroFacing
#undef State_ApplyRectAndSetActor8Byte35
#undef State_ApplyFourRectsAt48_55

/* overlays/scene/actor/staged_step/scene_wrapper.c */
#define Scene_CallHelper3500 Func_02000f34
#define Scene_CallHelper3c70 Func_02001e74
void Func_02003500(void);
void Func_02003c70(void);

void Scene_CallHelper3500(void)
{
    Func_02003500();
}

void Scene_CallHelper3c70(void)
{
    Func_02003c70();
}
#undef Scene_CallHelper3500
#undef Scene_CallHelper3c70

/* overlays/scene/actor/staged_step/shared.c */
#define Scene_RunSingleStep Func_02001e54
void Func_02003c50(void);
...
#define TestActorPosition Func_02002a3c
#define ActorProbeOffsets Data_0200a69c
#define ActorSearchStep Data_0200a644
#define StagedActor_FindClearPosition Func_02000474
#define Scene_RunIndexedStep0 Func_02001108
#define Scene_RunIndexedStep1 Func_02001114
#define State_ResetCounter412OnHeading4000B Func_02001120
#define State_ResetCounter412OnHeading4000 Func_0200115c
#define State_ApplyRectAndPlaceSlot12 Func_02001198
#define ConfigureAndPlaceActorTwelve Func_020011d8
#define Scene_RunStep8ValueEe7 Func_02001204
#define Scene_RunStep9ValueEe8 Func_02001238
#define Scene_RunStep10ValueEe9 Func_0200126c
#define Scene_RunStep11ValueEea Func_020012a0
#define Scene_RunStep12ValueEeb Func_020012d4


extern u8 *Data_03001ebc;

void Func_020090b8(s32);
u8 *Func_0200a540(s32);
void Func_0200a5c8(void);
void Func_0200a4d0(s32, s32, s32, s32, s32, s32);
s32 Func_0200a508(s32);
void Func_0200a578(s32, s32, s32);
void Func_0200a520(s32);
void Func_0200a4d0_unprototyped();
void Func_0200a578_unprototyped();
void Func_0200a5e0(s32, s32);
void Func_0200a580(s32, s32);
s32 Func_0200a538(s32, s32);
void Func_0200a510(s32);
...
#undef State_ResetCounter412OnHeading4000B
#undef State_ResetCounter412OnHeading4000
#undef State_ApplyRectAndPlaceSlot12
#undef ConfigureAndPlaceActorTwelve
#undef Scene_RunStep8ValueEe7
#undef Scene_RunStep9ValueEe8
#undef Scene_RunStep10ValueEe9
#undef Scene_RunStep11ValueEea
#undef Scene_RunStep12ValueEeb
...
extern s32 Data_0200a644[];
extern s32 Data_0200a684[];

Ent *Func_02000342(Desc *, Ent *);
s32 Func_02002802(Ent *, Desc *);
...
struct StagedActor *Func_02002614(s32 arg0);
...
s32 Func_02002680(struct StagedActor *arg0, s32 *arg1);
void Func_02002660(struct StagedActor *arg0, s32 arg1);
void Func_02002628(s32 arg0);
void Func_020027c6(s32 arg0);
void Func_02002696(struct StagedActor *arg0, s32 arg1, s32 arg2, s32 arg3);
void Func_020026a6(struct StagedActor *arg0, s32 arg1, s32 arg2, s32 arg3);
void Func_020026b4(struct StagedActor *arg0);
void Func_020027e8(void);
void Func_020026cc(struct StagedActor *arg0, s32 arg1);
...
#define State_SetSelectorFlagWhenFacingC000 Func_020010b8
#define Actor_MarkSlot13AndSetFlag200 Func_02001984
#define State_ApplyFourRectsAndSetActor8Byte85 Func_020019e8
#define State_ApplyTwoRectsAtRow56 Func_02001c6c
#define State_ApplyRectAndClearActor10Byte85 Func_02001ccc
...
void Func_02003ef8_a(s32, s32, s32, s32, s32, s32);
...
void State_ApplyFourRectsAndSetActor8Byte85(void)
{
    ...
    Func_02003ef8_a(58, 42, 1, 1, 42, 42);
...
#undef State_SetSelectorFlagWhenFacingC000
#undef Actor_MarkSlot13AndSetFlag200
#undef State_ApplyFourRectsAndSetActor8Byte85
#undef State_ApplyTwoRectsAtRow56
#undef State_ApplyRectAndClearActor10Byte85

 ...
 * games/tbs/src/overlays/scene_primary_script/run_actor_position_sequence.c.
 ...
 * by this overlay's other unit, games/tbs/src/overlays/scene_primary_script/
 ...
 * CANDIDATE_SINGLE_OWNERS variable and units under games/tbs/recon/en/units/,

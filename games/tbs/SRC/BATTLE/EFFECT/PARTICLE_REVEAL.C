 ...
 * documented in games/tbs/SRC/BATTLE/EFFECT/MEMBER_ORBIT.C (owner
 * 080ce85c) and games/tbs/SRC/BATTLE/EFFECT/PUFF_ARC.C (owner
 ...
 * resolver already established in games/tbs/recon/en/main/080e01e4.c.
 *
 ...
 * `_call_via_rN` trampoline bank at games/tbs/asm/080072e4.s (r4 slot at

 ...
 * the +8/+12/+16 position; and Data_0200b36c (file offset 0x3058) is a table
...
extern struct Descriptor *Data_0200b36c[];

/* Returns the party record; only its presentation block at +80 is read. */
struct Effect *Func_02003c16();
struct Effect *Func_02003b94();
void Func_02003b9e();
void Func_02003bb8();
void Func_02003d2a();
s32 Func_02003c3c();
                   ...
                   const struct Options *options)
{
    ...
    if ((flags & 0x100000) != 0 && options != 0) {
        effect = Func_02003b94(options->kind, x, y, z);
    } else {
        effect = Func_02003b94(222, x, y, z);
    }
    if (effect == 0) return;
    ...
    Func_02003b9e(effect, (flags + 1) & 15);
    table_offset = (flags & 15) << 2;
    Func_02003bb8(effect, Data_0200b36c[table_offset >> 2]);
    ...
    if ((flags & 0x10000) != 0) {                   /* 128 << 9 */
        Func_02003d2a(effect, options->mode);
    }
    ...
    if ((flags & 0x40000) != 0) {                   /* 128 << 11 */
        ...
        if ((flags & 0x80000) != 0) {
            ...
            effect->rate30 = Func_02003c3c(first_delta,
                                           descriptor->duration);
            ...
            effect->rate30 = Func_02003c54(first_delta,
                                           descriptor->duration);
            delta = options->target34;
            duration = descriptor->duration;
         ...
         * once. */
        effect->rate34 = Func_02003c62(delta, duration);
    }

    if ((flags & 0x200000) != 0) {                  /* 128 << 14 */
        Func_02003cb8(effect, 1);
        Func_02003cc8(effect, options->callback_arg);
    }

...
/*
 * resource_3be owner at 0x0200013c, 472 bytes: the overlay's general
 * "spawn and fully configure" routine -- the same spawn-then-owner-record
 * shape resource_3be_c_02000048.c/02005158.c/02005388.c already document,
 ...
 * 0x02009778 and `idx = flags & 0xf` -- the low nibble of the `flags`
 ...
 * clear-two-bits-then-copy idiom resource_3be_c_02000048.c's adopted
 * Func_02005a2e pair and resource_3be_c_02005158.c already use on this
...
extern struct Descriptor *Data_02009778[];

struct Effect *Func_02001692();
struct Effect *Func_02001638();
void Func_02001642();
void Func_0200165c();
void Func_0200179e();
s32 Func_02001700();
                   ...
                   const struct Options *options)
{
    ...
    if ((flags & 0x40000) != 0) {
        ...
        if ((flags & 0x80000) != 0) {
            ...
            effect->rate30 = Func_02001700(first_delta,
                                           descriptor->duration);
            ...
            effect->rate30 = Func_02001718(first_delta,
                                           descriptor->duration);
            delta = options->target34;
            duration = descriptor->duration;
        ...
        effect->rate34 = Func_02001726(delta, duration);
    }

...
- Semantic-C lane: **177,146 executable bytes across 398 compiling sources**:
  165,138 main bytes and 12,008 overlay bytes. Combined with exact C,
  **318,218 / 1,338,820 executable bytes** are now expressed as C, with
  1,020,602 remaining.

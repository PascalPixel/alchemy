...
s32 Func_02000a3c(void)
{
    ...
    *(record + 0x22) = 1;
    if (Func_080770c0(0x303) != 0) {
        ...
        *(record + 0x59) = 0;
        *(record + 0x23) = 3;
        { s32 f1 = 47; s32 g1 = 12; Func_080091c0(47, 24, 1, 1,  f1, g1); }
    }
    ...
    *(record + 0x23) = 2;
    ...
    if (Func_080770c0(0x302) != 0) {
        { s32 f2 = 34; s32 g2 = 7; Func_080091c0(37, 7, 1, 4,  f2, g2); }
        { s32 f3 = 37; s32 g3 = 7; Func_080091c0(36, 7, 1, 4,  f3, g3); }
        { s32 f4 = 34; s32 g4 = 38; Func_080091b8(100, 29, 1, 3,  f4, g4); }
    }

    record = Func_0808a080(13);
    if (Func_080770c0(0x301) != 0) {
        { s32 f5 = 41; s32 g5 = 12; Func_080091c0(43, 12, 1, 1,  f5, g5); }
        *(record + 0x55) = 0;
    ...
    *(record + 0x23) = 2;
    ...
    case 1:
        ...
        { s32 f6 = 19; s32 g6 = 2; Func_080091c8(127, 0, 1, 2,  f6, g6); }
        Func_0808a088(19);
        Func_0808a088(20);
        Func_0808a088(21);
        Func_0808a088(22);

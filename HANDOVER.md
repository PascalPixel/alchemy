...
- Semantic-C lane: **206,018 executable bytes across 455 compiling sources**:
  193,226 main bytes and 12,792 overlay bytes. Combined with exact C,
  **353,632 / 1,339,230 executable bytes** are now expressed as C, with
  985,598 remaining.

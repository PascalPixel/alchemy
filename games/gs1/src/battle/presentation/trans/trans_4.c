...
void BattlePres_SetupTransitionScene(s32 x, s32 depth, s32 y, s32 mode)
{
    ...
    Battle_unk2_4(span, result, span * 2);
    Battle_unk3_4();
    Battle_unk4_4(position);
    Battle_unk5_2(*(s16 *)(scene + 0x36));
    Battle_unk6_2(*(s16 *)(scene + 0x34));
    render_bounds[0] = 0;
    render_bounds[1] = 0;
    ...
    Battle_unk2_4(width, result, half * 4);
}

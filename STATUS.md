...
|---|---:|---:|
| Compiled C | 1,027 | 52,282 |
| Reconstruction assembly | 2,144 | 496,154 |
...
Within the reconstruction assembly, 472,806 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,915,802 of
8,388,608 bytes, or 94.36%. It counts exact C, deterministic asset round trips,
and positively retained structural assembly, while treating ordinary
reconstruction assembly as unfinished C work. The remaining 472,806 bytes are
...
| Byte reconstruction | 7,915,802 / 8,388,608 bytes (94.36%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 52,282 / 525,088 identified executable bytes (9.96%) | Active executable work represented as exact C |

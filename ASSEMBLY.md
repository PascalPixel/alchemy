...
The current boundary, after the twelfth exact-C checkpoint and full IWRAM reconstruction, is:
...
| Likely ordinary compiler output | 1,366 | 458,814 | Convert to exact C |

...
lane currently accounts for **284,420 executable bytes across 586 compiling
sources**: 271,628 main-image bytes and 12,792 overlay bytes. Combined with exact
C, **460,994 / 1,339,542 executable bytes** are expressed as C. Build that lane

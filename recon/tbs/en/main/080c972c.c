 ...
 * established by games/THE BROKEN SEAL/SRC/BATTLE/EFFECT/MEMBER_ORBIT.C
 * (main:080ce85c) and games/THE BROKEN SEAL/SRC/BATTLE/EFFECT/PUFF_ARC.C
 ...
 * as in puff_arc/run.c and recon/tbs/en/main/080ccc38.c.
 *

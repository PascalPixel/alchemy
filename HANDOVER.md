...
lane currently accounts for **263,256 executable bytes across 565 compiling
sources**: 250,464 main-image bytes and 12,792 overlay bytes. Combined with exact
C, **439,830 / 1,339,542 executable bytes** are expressed as C. Build that lane

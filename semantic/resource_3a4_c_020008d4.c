...
void Func_020008d4(void)
{
    ...
    Func_0200463c(230);
    Func_02004464(0x20000, 0x20000, 0x10000);   /* 128<<10, 128<<9 */
    Func_0200449a(10);
    ...
    Func_02004410(1, 0, 0x020086a1);            /* Func_020006a0 | 1 */
    ...
    *counter = 0;
    ...
    Func_020044ec(-1, -1, 0xe666);              /* 0.9 in 16.16 */
    Func_02004522(30);

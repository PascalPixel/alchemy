 ...
 * games/THE BROKEN SEAL/SRC/BATTLE/EFFECT/PUFF_ARC.C and member_orbit/run.c.
 *
 ...
 * (games/THE BROKEN SEAL/SRC/SYSTEM/SCHEDULER/CALLBACK_SCHEDULER.C).  The result is

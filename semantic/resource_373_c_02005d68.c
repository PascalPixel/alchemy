...
void Func_0200bcb6();
void Func_0200bcb4();
void Func_0200dd15(void *object);
void Func_0200dcc5(void *object);

void Func_02005d68(u8 *parent)
{
    ...
    for (index = 0; index <= 1; index++) {
        ...
        *(u8 **)(piece + 0x68) = parent;
        ...
        Func_0200bcb6(record, 0);
        record[0x26] = held;
        Func_0200bcb4(record[0x1c]);
    ...
    *(void (**)(void *))(pieces[0] + 0x6c) = Func_0200dd15;
    clear = -13;
    record[9] = (u8)((record[9] & clear) | 4);

    record = *(u8 **)(pieces[1] + 0x50);
    *(void (**)(void *))(pieces[1] + 0x6c) = Func_0200dcc5;
    record[9] = (u8)((record[9] & clear) | 4);
    pieces[1][0x23] = 2;
}

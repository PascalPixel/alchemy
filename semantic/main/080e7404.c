...
void Func_080072f4(void *, const void *, s32, s32, u32, s32);
...
s32 Func_080e7404(s32 arg0, s32 arg1) {
    ...
    if (sp4C == 1) {
        Func_080072f0((void *)0x05000000, Func_08002f40(0xC4), 0x80, (void *)0x03001388);
    }
    sp118 = 0x01010101;
    ...
    Func_080072f0((void *)0x06008000, (void *)0x02010000, 0x7800, (void *)0x03001388);
    Func_080030f8(1U);
    ...
    Func_080072f0((void *)0x06004000, sp48, 0x4000, (void *)0x03001388);
...
loop_80:
        ...
        do {
            ...
            Func_080072f4((void *)0x02010000, state + 0x1F40, temp_r2_5 + 0x7C, temp_r3_6 + 0x38, 8U, 8);
            var_r8_8 += 1;
            var_r7_2 += 6;
        } while (var_r8_8 != 7);
        if (sp40 == 1) {
        ...
        do {
            ...
            if (temp_r3_7 <= 0x5D) {
                Func_080072f4((void *)0x02010000, state + 0x1C80, (M2C_FIELD(var_r5_5, s16 *, 0) + var_r7_3) - 0xC, temp_r3_7 - 0xC, 0x18U, 0x18);
        ...
        do {
            ...
            if (temp_r1_6 >= 0) {
                Func_080072f4((void *)0x02010000, temp_r2_6 + (temp_r1_6 << 0xA), M2C_FIELD(temp_r5_4, s16 *, 2) - 0x10, M2C_FIELD(temp_r5_4, s16 *, 6) - 0x10, 0x20U, 0x20);
...
loop_117:
    ...
    do {
        if ((s32) M2C_FIELD(var_r7_4, s32 *, 4) >= 0) {
            ...
            Func_080072f4(sp48, state + M2C_FIELD((void *)0x080EDE48, u16 *, temp_r5_7 - 2) + ((var_r8_14 & 1) * 0x302) + 0x3200, projected[0] - ((s32) (temp_r0_3 + (temp_r0_3 >> 0x1F)) >> 1), projected[1] - temp_r0_3, temp_r0_3, temp_r5_7);
    ...
    do {
        ...
        Func_080072f4(sp48, temp_r1_8 + M2C_FIELD((void *)0x080EDE48, u16 *, temp_r6_3 - 2) + ((var_r8_15 & 1) * 0x302) + 0x3200, M2C_FIELD(temp_r3_10, s32 *, 0x7080) - (temp_r4_2 >> 1), M2C_FIELD(temp_r7, s32 *, 4) - temp_r4_2, temp_r4_2, temp_r6_3);
    ...
    do {
        if ((Func_080022ec(var_r8_16, 3) < sp24) && ((s32) M2C_FIELD(var_r7_5, s32 *, 4) >= 0)) {
            ...
            if (temp_r2_10 <= 0xDU) {
                ...
                Func_080072f4(sp48, state + M2C_FIELD((void *)0x080EEEBC, u16 *, temp_r3_12), temp_r6_4 - temp_r0_4, projected[1] - temp_r0_4, (u32) temp_r4_3, (s32) temp_r4_3);
            }

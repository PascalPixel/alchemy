...
- **Unfinished scopes:** 2,200
- **Address spaces scanned:** 97 (89 still contain targets)
- **Target bytes:** 1,004,536 semantic-C or unresolved-assembly bytes
- **Resolved-only bytes:** 339,058 Exact C or audited permanent assembly bytes
...
and links. Current project state is in [STATUS.md](STATUS.md); the historical
handover record is [docs/history/2026-08-02-handover-audit.md](docs/history/2026-08-02-handover-audit.md).
...
[`AGENTS.md`](../../AGENTS.md). Everything here except this file is

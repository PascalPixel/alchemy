...
#define Scene_RunScene374SequenceA Func_02000bbc
...
void Scene_RunScene374SequenceA(void)
{
    u32 i;
    s32 record;
    s32 base5_200aef0;
    ...
    if (Value1(Func_02003238, 0x834) == 0) {
        ...
        if (Value1(Func_02003246, 0x840) != 0) {
            ...
            Value2(Func_02003402_a, 0, 0x200af50);
            ...
            Call3(Func_020037a2, 19, 0x10000, 0x200ac00);

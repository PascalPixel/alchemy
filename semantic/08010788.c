...
/*
 * Move a tile-map rectangle while retaining the destination's attribute bits,
 * then expose covered tiles on the active objects' three display layers.
 */
void Func_08010788(
    s32 source_x,
    s32 source_y,
    ...
    s32 destination_y)
{
    ...
    struct RasterObject_08010788 *object =
        (struct RasterObject_08010788 *)
        (*(u8 **)0x03001E70 + 0x104);

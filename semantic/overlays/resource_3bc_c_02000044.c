...
/*
 * resource_3bc owner at 0x02000044, 8 bytes: `ldr r0, [pc, #0] / bx lr`
 * plus the one-word literal pool at 0x02000048 holding 0x200d0a8.
 *
 ...
 *
 * The pool word 0x200d0a8 is an ADDRESS, loaded and returned WITHOUT being

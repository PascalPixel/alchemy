...
/*
 * Resource 386 approach guard at 0x02000410 — member 0 of a four-member
 * family (0x0200_0380, 0x0200_03c8, 0x0200_0410, 0x0200_0458).
 *
 * Complete owner: `push {r5, lr}` at 0x02000410, interworking return
 ...
 * are the literal pool (0xffff5fff, 0x00003ffe, 0x00001ce6) plus one
 ...
 *
 * Link base 0x02008000; 0x0200 80410 in the overlay's handler pool is
 * `Func_02000410 + 1`, which named this row as a scene handler in advance.
 *
...
void Func_080b0008();  /* veneer 0x6cc */

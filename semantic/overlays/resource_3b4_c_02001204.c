...
/*
 * resource_3b4 owner at 0x02001204, 52 bytes: code 0x02001204-0x02001231, two
 * bytes of alignment, and the pool word 0x00000ee7 at 0x02001234.
 *
 * One entry of a five-way family (0x02001204, 0x02001238, 0x0200126c,
 * 0x020012a0, 0x020012d4) that differ only in the slot number given to
 * Func_0808a0f0 and in the message id in the pool word; the last of them also
 * uses 243 rather than 244 in the first two calls.
 */

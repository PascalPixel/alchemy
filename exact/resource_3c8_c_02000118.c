...
void Func_02000118(s32 x, s32 y,
                   ...
                   const struct Options *options)
{
    ...
    Func_02004f68(effect, Data_0200d1d4[table_offset >> 2]);
    ...
    if ((flags & 0x40000) != 0) {                   /* 128 << 11 */
        ...
        if ((flags & 0x80000) != 0) {
            ...
            effect->rate30 = Func_02004ff4(first_delta,
                                           descriptor->duration);
            ...
            effect->rate30 = Func_0200500c(first_delta,
                                           descriptor->duration);
            delta = options->target34;
            duration = descriptor->duration;
         ...
         * once. */
        effect->rate34 = Func_0200501a(delta, duration);
    }

...
void Func_020037e4(u8 *object, s32 mode);
void Func_020038bc(u8 *object, s32 mode);

u8 *Func_02000a4c(s32 x, s32 y, s32 z, s32 kind)
{
    u8 *result;
    u8 *object = Func_02003792(kind, x, y, z);
    ...
    if (object != 0) {
        ...
        object[85] = 0;
        object[89] = 8;
        Func_020037e4(object, 0);
        Func_020038bc(object, 15);
        low = 0xfe;
        low = low & object[35];
        object[35] = (u8)(low | 2);
        result = object;

 ...
 * already use.  Old-style declarations are required: 0x02005c88, 0x02005d94,
 * 0x02005dec, 0x02005e32, 0x02005ed4, 0x02005ee0, 0x02005f14, 0x02005f84,
 * 0x02005fca, 0x02005fd8, 0x02006004, 0x02006180, 0x020061ac, 0x02006350,
 * 0x02006386 and 0x020063c8 are each reached with two different argument
...
void Func_020017e8(void)
{
    ...
    Func_02005c5a(0, 31);
    /* r0 is carried from 0x02005c00's return into 0x02005b7e's first
     * argument; whether 0x02005c00 returns a value is unverified. */
    ...
    *(u32 *)(record + 64) += 0xfffd0000;
    ...
    Func_020063c2(1, 2);
    follow_record(Func_02006368(0), 1, Func_020063a2);
    Func_020063d0(1);
    Func_020063e2(1, 0, 0);

    Func_020063f2(3, 2);
    follow_record(Func_02006398(0), 3, Func_020063d2);
    Func_02006400(3);
    Func_02006412(3, 0, 0);

    Func_02006422(2, 2);
    follow_record(Func_020063c8(0), 2, Func_02006402);
    Func_02006430(2);
    Func_02006442(2, 0, 0);

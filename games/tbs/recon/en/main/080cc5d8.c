 ...
 * games/tbs/SRC/BATTLE/EFFECT/MEMBER_ORBIT.C (owner 080ce85c) at
 ...
 * see games/tbs/src/battle/effects/objects/start_effect_22.c for the
 * Func_080048b0(asset_id, size) signature.
 *
 * Data_03001e50[kind] is that same heap-allocation cache (see the comment
 * in games/tbs/recon/en/main/080e7404.c and games/tbs/src/battle/effects/
 ...
 * games/tbs/SRC/BATTLE/EFFECT/MEMBER_ORBIT.C and
 * games/tbs/recon/en/main/080d59b0.c.  The fixed 0x02010000 "star" array and
 * its 28-byte, {f0,f4,f8,f24}-field record shape is the same one used by
 * games/tbs/recon/en/main/080d59b0.c; this owner also keeps a second,
 ...
 * games/tbs/SRC/BATTLE/EFFECT/MEMBER_ORBIT.C's Value_000000af comment):
 ...
 * tables already catalogued in games/tbs/SRC/BATTLE/DATA/SENTOU_KOUKA_HYOU_A.JSON
 * (hyou_a_030/031/032 and hyou_a_001 respectively); Data_080ede48 in
 * games/tbs/recon/en/main/080dc1ec.c documents the extern-array convention

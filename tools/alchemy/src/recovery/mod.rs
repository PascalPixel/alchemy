...
mod tests {
    ...
    fn live_arm_owner_fails_closed() {
        let source = include_str!("../../../../games/tbs/asm/08002d5c.s");
        assert!(matches!(
    ...
    fn live_pool_fill_matches_align_spelling() {
        let source = include_str!("../../../../games/tbs/asm/080908e0.s");
    ...
    fn live_multi_entry_reference_is_owner_scoped() {
        let source = include_str!("../../../../games/tbs/asm/08002dd8.s");
    ...
    fn live_named_reference_matches_legacy_candidate_entry() {
        let reference = include_str!("../../../../games/tbs/asm/080a24d0.s");
    ...
    fn live_0800307c_pool_island_skip_is_not_a_cfg_edge() {
        let reference = include_str!("../../../../games/tbs/asm/0800307c.s");

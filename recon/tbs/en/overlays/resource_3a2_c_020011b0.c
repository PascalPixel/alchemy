...
/* NONMATCHING: 744 of 744 bytes, 2 halfword edits (2026-09-24). sched1
 * hoists the game-state base load (r5) above the event-work store; the
 * reference loads it after. Local-pointer, volatile and typed-store spellings
 * did not move it. */

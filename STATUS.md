...
|---|---:|---:|
| Compiled C | 1,137 | 65,272 |
| Reconstruction assembly | 2,036 | 483,164 |
...
Within the reconstruction assembly, 458,452 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,930,156 of
8,388,608 bytes, or 94.53%. It counts exact C, deterministic asset round trips,
and positively retained structural assembly, while treating ordinary
reconstruction assembly as unfinished C work. The remaining 458,452 bytes are
...
| Byte reconstruction | 7,930,156 / 8,388,608 bytes (94.53%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 65,272 / 523,724 identified executable bytes (12.46%) | Active executable work represented as exact C |

...
- Semantic-C lane: **163,846 executable bytes across 379 compiling sources**:
  151,838 main bytes and 12,008 overlay bytes. Combined with exact C,
  **301,814 / 1,338,732 executable bytes** are now expressed as C, with
  1,036,918 remaining.

...
|---|---:|---:|
| Compiled C | 1,020 | 51,192 |
| Reconstruction assembly | 2,151 | 497,244 |
...
Within the reconstruction assembly, 473,896 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,914,712 of
...
reconstruction assembly as unfinished C work. The remaining 473,896 bytes are
...
| Byte reconstruction | 7,914,712 / 8,388,608 bytes (94.35%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 51,192 / 525,088 identified executable bytes (9.75%) | Active executable work represented as exact C |

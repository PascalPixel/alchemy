...
/*
 * Resource 3c7 examine handler at 0x020001c8.
 *
 * Complete owner: `push {r5, lr}` at 0x020001c8 through the interworking return
 * `pop {r5} / pop {r0} / bx r0` at 0x02000220.  r0 receives the popped return
 ...
 * 0x020001f2-0x020001f7 (alignment halfword plus the 0xffffc000 mask) and
 * 0x02000226-0x02000233 (the flag id and the two message ids).  Neither is code.
 *
...
extern u16 * Func_020013e4();
extern void Func_020014e2();
extern s32 Func_020013d8();
extern void Func_02001482();
extern void Func_0200149a();
extern void Func_02001492();
extern void Func_020014aa();
void Func_020001c8(s32 actor)
{
    u16 *scene = Func_020013e4(0);

    if ((((s32)scene[3] + 0x2000) & 0xc000) == 0xc000) {
        Func_020014e2(0x22, actor);
    } else if (Func_020013d8(0x9a7) != 0) {
        Func_02001482(0x28f4);
        Func_0200149a(actor, 0);
    } else {
        Func_02001492(0x26e9);
        Func_020014aa(actor, 0);
    }
}

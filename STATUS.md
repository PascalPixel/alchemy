...
| Reconstruction assembly | 2,191 | 501,802 |
...
Within the reconstruction assembly, 478,454 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,910,154 of
8,388,608 bytes, or 94.30%. It counts exact C, deterministic asset round trips,
and positively retained structural assembly, while treating ordinary
reconstruction assembly as unfinished C work. The remaining 478,454 bytes are
...
| Byte reconstruction | 7,910,154 / 8,388,608 bytes (94.30%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 46,634 / 525,088 identified executable bytes (8.88%) | Active executable work represented as exact C |

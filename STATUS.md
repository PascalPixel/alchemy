...
|---|---:|---:|
| Compiled C | 1,019 | 51,024 |
| Reconstruction assembly | 2,152 | 497,412 |
...
Within the reconstruction assembly, 474,064 bytes remain active
...
The stricter build-report `byte_reconstruction` milestone is 7,914,544 of
8,388,608 bytes, or 94.35%. It counts exact C, deterministic asset round trips,
and positively retained structural assembly, while treating ordinary
reconstruction assembly as unfinished C work. The remaining 474,064 bytes are
...
| Byte reconstruction | 7,914,544 / 8,388,608 bytes (94.35%) | Exact C, round-tripping assets, or retained structural assembly |
| Code decompilation | 51,024 / 525,088 identified executable bytes (9.72%) | Active executable work represented as exact C |

...
- **Target bytes:** 737,848 tracked-C or unresolved-assembly bytes
...
| 33 | 3,738 | 2,660 | `main:0x080b6cd0` |
...
| 50 | 3,046 | 3,046 | `resource_395:0x02000470` |
| 51 | 3,046 | 3,046 | `resource_39d:0x02001adc` |
| 52 | 2,946 | 2,426 | `main:0x080167e0` |
| 53 | 2,918 | 824 | `main:0x080b6148` |
| 54 | 2,908 | 2,908 | `resource_381:0x020003cc` |
| 55 | 2,854 | 2,854 | `resource_374:0x0200155c` |
| 56 | 2,778 | 904 | `main:0x08020bd8` |
| 57 | 2,772 | 260 | `main:0x0808f52c` |
| 58 | 2,734 | 2,734 | `resource_3a8:0x020026a8` |
| 59 | 2,706 | 1,588 | `main:0x080a345c` |
| 60 | 2,698 | 2,256 | `main:0x080a8914` |
| 61 | 2,678 | 1,324 | `main:0x08095160` |
| 62 | 2,672 | 2,672 | `resource_3a8:0x02000aac` |
| 63 | 2,658 | 2,264 | `main:0x080c1fa8` |
| 64 | 2,650 | 2,376 | `main:0x080999f0` |
| 65 | 2,630 | 1,586 | `main:0x080a7a34` |
| 66 | 2,596 | 200 | `main:0x080c0000` |
| 67 | 2,574 | 2,574 | `resource_39e:0x02002ec8` |
| 68 | 2,568 | 748 | `main:0x08012518` |
| 69 | 2,530 | 1,312 | `main:0x080b8574` |
| 70 | 2,508 | 460 | `main:0x08020000` |
| 71 | 2,476 | 2,476 | `resource_3af:0x0200252c` |
| 72 | 2,440 | 2,368 | `main:0x080bf678` |
| 73 | 2,430 | 2,244 | `main:0x080a6a00` |
| 74 | 2,426 | 2,426 | `resource_3b8:0x0200338c` |
| 75 | 2,418 | 2,418 | `resource_38d:0x02000894` |
| 76 | 2,382 | 2,382 | `resource_383:0x02003c6c` |
| 77 | 2,360 | 1,328 | `main:0x080dd9c0` |
| 78 | 2,310 | 2,310 | `resource_3b8:0x02002a84` |
| 79 | 2,310 | 388 | `main:0x080113e4` |
| 80 | 2,298 | 2,298 | `resource_380:0x02000a98` |
| 81 | 2,294 | 1,912 | `main:0x0808e0b0` |
| 82 | 2,290 | 1,876 | `main:0x080bd898` |
| 83 | 2,236 | 2,236 | `resource_39e:0x02001494` |
...
| 91 | 2,172 | 1,336 | `main:0x0808a5f8` |
| 92 | 2,170 | 2,170 | `resource_3ca:0x02000430` |
| 93 | 2,168 | 2,168 | `resource_3bd:0x02002c44` |
| 94 | 2,158 | 2,158 | `resource_373:0x02001a14` |
| 95 | 2,118 | 2,118 | `resource_371:0x020028e8` |
| 96 | 2,070 | 2,070 | `resource_3b1:0x02001b34` |
| 97 | 2,068 | 2,068 | `resource_3c2:0x02000240` |
| 98 | 2,056 | 1,048 | `main:0x080f0254` |
| 99 | 2,046 | 124 | `main:0x0800300c` |
| 100 | 2,026 | 242 | `main:0x0800a97c` |
| 101 | 2,018 | 2,018 | `resource_3a5:0x020004e4` |
| 102 | 2,014 | 2,014 | `resource_3c9:0x02000a6c` |
| 103 | 2,006 | 2,006 | `resource_3a4:0x02001830` |
| 104 | 2,002 | 2,002 | `resource_38d:0x020019b0` |
| 105 | 2,002 | 2,002 | `resource_3af:0x02003a0c` |
| 106 | 1,978 | 1,978 | `resource_3ad:0x02000808` |
| 107 | 1,928 | 904 | `main:0x08097b54` |
| 108 | 1,906 | 1,906 | `resource_378:0x0200290c` |
| 109 | 1,902 | 1,292 | `main:0x080983a0` |
...
| 154 | 1,366 | 1,366 | `resource_3aa:0x0200077c` |
| 155 | 1,354 | 676 | `main:0x08017364` |
| 156 | 1,346 | 324 | `main:0x080b04dc` |
| 157 | 1,318 | 1,024 | `main:0x08092b94` |
| 158 | 1,310 | 1,310 | `resource_373:0x020034c8` |
| 159 | 1,310 | 656 | `main:0x080994d0` |
| 160 | 1,308 | 1,308 | `resource_37a:0x02002094` |
| 161 | 1,306 | 1,306 | `resource_3a8:0x02000590` |
| 162 | 1,298 | 1,298 | `resource_39c:0x02004a08` |
| 163 | 1,290 | 1,290 | `resource_3af:0x02000c94` |
| 164 | 1,270 | 1,270 | `resource_371:0x02001064` |
| 165 | 1,270 | 1,270 | `resource_3b1:0x020037d8` |
| 166 | 1,262 | 1,262 | `resource_38d:0x020012a0` |
| 167 | 1,238 | 1,238 | `resource_373:0x02004b24` |
| 168 | 1,234 | 1,234 | `resource_39d:0x02001608` |
| 169 | 1,234 | 1,234 | `resource_3af:0x02001db0` |
| 170 | 1,230 | 1,230 | `resource_371:0x02001f6c` |
| 171 | 1,230 | 1,230 | `resource_374:0x02000b8c` |
| 172 | 1,230 | 226 | `main:0x080a7380` |
| 173 | 1,222 | 1,222 | `resource_37a:0x0200155c` |
| 174 | 1,222 | 930 | `main:0x080ba978` |
| 175 | 1,218 | 1,218 | `resource_37b:0x02000554` |
| 176 | 1,218 | 996 | `main:0x0801c46c` |
| 177 | 1,208 | 1,208 | `resource_3b8:0x02000b40` |
| 178 | 1,198 | 1,198 | `resource_3b1:0x020057ec` |
| 179 | 1,194 | 964 | `main:0x080a1090` |
| 180 | 1,182 | 1,182 | `resource_3c9:0x02004738` |
| 181 | 1,180 | 1,180 | `resource_37b:0x0200101c` |
| 182 | 1,176 | 1,176 | `resource_37b:0x02000a18` |
| 183 | 1,170 | 1,170 | `resource_3b3:0x0200174c` |
| 184 | 1,162 | 392 | `main:0x08094730` |
| 185 | 1,160 | 908 | `main:0x080a847c` |
| 186 | 1,158 | 344 | `main:0x0808ec50` |
| 187 | 1,154 | 1,154 | `resource_37f:0x02001604` |
| 188 | 1,150 | 1,150 | `resource_375:0x020014f4` |
| 189 | 1,142 | 1,142 | `resource_373:0x02004ffc` |
| 190 | 1,136 | 908 | `main:0x080d0ee0` |
| 191 | 1,130 | 460 | `main:0x080b0070` |
| 192 | 1,126 | 1,126 | `resource_37f:0x02000f6c` |
| 193 | 1,126 | 456 | `main:0x080798b4` |
| 194 | 1,114 | 1,114 | `resource_3c7:0x02000880` |
| 195 | 1,106 | 1,106 | `resource_39e:0x02001dbc` |
| 196 | 1,102 | 1,102 | `resource_3bb:0x020010dc` |
| 197 | 1,102 | 124 | `main:0x08003c80` |
| 198 | 1,098 | 1,098 | `main:0x080a5b94` |
| 199 | 1,096 | 1,096 | `resource_3b9:0x020011c4` |
| 200 | 1,094 | 1,094 | `resource_371:0x02000c1c` |
| 201 | 1,094 | 1,094 | `resource_3bc:0x02001474` |
| 202 | 1,094 | 378 | `main:0x0800b684` |
| 203 | 1,090 | 1,090 | `resource_39e:0x0200064c` |
| 204 | 1,082 | 148 | `main:0x080216b4` |
| 205 | 1,078 | 1,078 | `resource_373:0x020015dc` |
| 206 | 1,078 | 1,078 | `resource_373:0x020046ec` |
| 207 | 1,078 | 1,078 | `resource_399:0x020019bc` |
| 208 | 1,078 | 568 | `main:0x08078aa0` |
| 209 | 1,074 | 1,074 | `resource_3ba:0x02000db8` |
| 210 | 1,068 | 896 | `main:0x080bd424` |
| 211 | 1,066 | 780 | `main:0x08091814` |
| 212 | 1,054 | 1,054 | `resource_39d:0x020011e8` |
| 213 | 1,052 | 1,052 | `resource_3b1:0x02004254` |
| 214 | 1,052 | 1,052 | `resource_3c8:0x020026f8` |
| 215 | 1,050 | 1,050 | `resource_372:0x020028a4` |
| 216 | 1,050 | 1,050 | `resource_3aa:0x02000360` |
| 217 | 1,050 | 1,050 | `resource_3aa:0x02000cd4` |
| 218 | 1,046 | 1,046 | `resource_380:0x020027f8` |
| 219 | 1,046 | 1,046 | `resource_381:0x02001b34` |
| 220 | 1,042 | 1,042 | `resource_377:0x02000f90` |
| 221 | 1,042 | 1,042 | `resource_3a5:0x02001490` |
| 222 | 1,038 | 1,038 | `resource_379:0x02000074` |
| 223 | 1,036 | 956 | `main:0x08029504` |
| 224 | 1,034 | 1,034 | `resource_39d:0x02000ddc` |
| 225 | 1,034 | 652 | `main:0x080b9724` |
| 226 | 1,028 | 724 | `main:0x08090658` |
| 227 | 1,026 | 1,026 | `resource_37b:0x02000150` |
| 228 | 1,024 | 856 | `main:0x080a5fe0` |
| 229 | 1,022 | 1,022 | `resource_3b8:0x020006dc` |
| 230 | 1,022 | 1,022 | `resource_3b8:0x02000ff8` |
| 231 | 1,022 | 464 | `main:0x08016018` |
| 232 | 1,020 | 1,020 | `resource_3b9:0x02000db0` |
| 233 | 1,014 | 1,014 | `resource_39e:0x02002ad0` |
| 234 | 1,010 | 1,010 | `resource_37a:0x02001ca0` |
